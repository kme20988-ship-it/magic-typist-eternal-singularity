...
function xh() {
  ...
  function pe(m, k, B) {
    this.props = m, this.context = k, this.refs = X, this.updater = B || Z;
  }
  pe.prototype.isReactComponent = {}, pe.prototype.setState = function(m, k) {
  ...
  function Le(m, k, B) {
    var L = B.ref;
    return { $$typeof: o, type: m, key: k, ref: L !== void 0 ? L : null, props: B };
  }
  function ot(m, k) {
    return Le(m.type, k, m.props);
  }
  function Ne(m) {
  ...
  var Pe = /\/+/g;
  function Xe(m, k) {
    return typeof m == "object" && m !== null && m.key != null ? Ee("" + m.key) : k.toString(36);
  }
  function Se(m) {
    switch (m.status) {
      case "fulfilled":
      ...
      case "rejected":
        throw m.reason;
      default:
        switch (typeof m.status == "string" ? m.then(se, se) : (m.status = "pending", m.then(function(k) {
      ...
      case "object":
        switch (m.$$typeof) {
          ...
          case p:
            ...
            break;
          case U:
            return ce = m._init, S(ce(m._payload), k, B, L, P);
        }
    }
    if (ce) return P = P(m), ce = L === "" ? "." + Xe(m, 0) : L, he(P) ? (B = "", ce != null && (B = ce.replace(Pe, "$&/") + "/"), S(P, k, B, "", function(bl) {
      return bl;
    })) : P != null && (Ne(P) && (P = ot(P, B + (P.key == null || m && m.key === P.key ? "" : ("" + P.key).replace(Pe, "$&/") + "/") + ce)), k.push(P)), 1;
    ce = 0;
    var Ze = L === "" ? "." : L + ":";
    if (he(m)) for (var De = 0; De < m.length; De++) L = m[De], ee = Ze + Xe(L, De), ce += S(L, k, B, ee, P);
    else if (De = J(m), typeof De == "function") for (m = De.call(m), De = 0; !(L = m.next()).done; ) L = L.value, ee = Ze + Xe(L, De++), ce += S(L, k, B, ee, P);
    else if (ee === "object") {
      if (typeof m.then == "function") return S(Se(m), k, B, L, P);
  ...
  var ve = typeof reportError == "function" ? reportError : function(m) {
    ...
    console.error(m);
  }, we = { map: H, forEach: function(m, k, B) {
    H(m, function() {
  ...
  return te.Activity = A, te.Children = we, te.Component = pe, te.Fragment = h, te.Profiler = g, te.PureComponent = xe, te.StrictMode = r, te.Suspense = z, te.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE = W, te.__COMPILER_RUNTIME = { __proto__: null, c: function(m) {
    ...
    return null;
  }, te.cloneElement = function(m, k, B) {
    if (m == null) throw Error("The argument must be a React element, but you passed " + m + ".");
    var L = ae({}, m.props), P = m.key;
    if (k != null) for (ee in k.key !== void 0 && (P = "" + k.key), k) !le.call(k, ee) || ee === "key" || ee === "__self" || ee === "__source" || ee === "ref" && k.ref === void 0 || (L[ee] = k[ee]);
  ...
  }, te.createElement = function(m, k, B) {
    var L, P = {}, ee = null;
    if (k != null) for (L in k.key !== void 0 && (ee = "" + k.key), k) le.call(k, L) && L !== "key" && L !== "__self" && L !== "__source" && (P[L] = k[L]);
  ...
  }, te.memo = function(m, k) {
    return { $$typeof: v, type: m, compare: k === void 0 ? null : k };
    ...
    try {
      ...
      k !== null && B.types !== null && (k.types = B.types), W.T = k;
    }
  }, te.unstable_useCacheRefresh = function() {
    return W.H.useCacheRefresh();
  }, te.use = function(m) {
    return W.H.use(m);
  }, te.useActionState = function(m, k, B) {
    return W.H.useActionState(m, k, B);
  }, te.useCallback = function(m, k) {
    return W.H.useCallback(m, k);
  }, te.useContext = function(m) {
    return W.H.useContext(m);
  }, te.useDebugValue = function() {
  }, te.useDeferredValue = function(m, k) {
    return W.H.useDeferredValue(m, k);
  }, te.useEffect = function(m, k) {
    return W.H.useEffect(m, k);
  }, te.useEffectEvent = function(m) {
    return W.H.useEffectEvent(m);
  }, te.useId = function() {
    return W.H.useId();
  }, te.useImperativeHandle = function(m, k, B) {
    return W.H.useImperativeHandle(m, k, B);
  }, te.useInsertionEffect = function(m, k) {
    return W.H.useInsertionEffect(m, k);
  }, te.useLayoutEffect = function(m, k) {
    return W.H.useLayoutEffect(m, k);
  }, te.useMemo = function(m, k) {
    return W.H.useMemo(m, k);
  }, te.useOptimistic = function(m, k) {
    return W.H.useOptimistic(m, k);
  }, te.useReducer = function(m, k, B) {
    return W.H.useReducer(m, k, B);
  }, te.useRef = function(m) {
    return W.H.useRef(m);
  }, te.useState = function(m) {
    return W.H.useState(m);
  }, te.useSyncExternalStore = function(m, k, B) {
    return W.H.useSyncExternalStore(m, k, B);
...
function gh() {
  return Bf || (Bf = 1, (function(o) {
    ...
    function r(S) {
      ...
      if (Q !== H) {
        ...
        e: for (var ve = 0, we = S.length, m = we >>> 1; ve < m; ) {
          var k = 2 * (ve + 1) - 1, B = S[k], L = k + 1, P = S[L];
          if (0 > g(B, Q)) L < we && 0 > g(P, B) ? (S[ve] = P, S[L] = Q, ve = L) : (S[ve] = B, S[k] = Q, ve = k);
    ...
    var z = [], v = [], U = 1, A = null, $ = 3, J = false, Z = false, ae = false, X = false, pe = typeof setTimeout == "function" ? setTimeout : null, ke = typeof clearTimeout == "function" ? clearTimeout : null, xe = typeof setImmediate < "u" ? setImmediate : null;
    function fe(S) {
      for (var H = h(v); H !== null; ) {
        if (H.callback === null) r(v);
        else if (H.startTime <= S) r(v), H.sortIndex = H.expirationTime, p(z, H);
        else break;
        H = h(v);
      }
    }
      ...
      if (X = false, se) {
        ...
        try {
          e: {
            ...
            try {
              t: {
                for (fe(S), A = h(z); A !== null && !(A.expirationTime > S && ot()); ) {
                  var ve = A.callback;
    ...
    o.unstable_IdlePriority = 5, o.unstable_ImmediatePriority = 1, o.unstable_LowPriority = 4, o.unstable_NormalPriority = 3, o.unstable_Profiling = null, o.unstable_UserBlockingPriority = 2, o.unstable_cancelCallback = function(S) {
      ...
      return we = Q + we, S = { id: U++, callback: H, priorityLevel: S, startTime: Q, expirationTime: we, sortIndex: -1 }, Q > ve ? (S.sortIndex = Q, p(v, S), h(z) === null && S === h(v) && (ae ? (ke(W), W = -1) : ae = true, Se(he, Q - ve))) : (S.sortIndex = we, p(z, S), Z || J || (Z = true, se || (se = true, Ee()))), S;
...
function yh() {
  ...
  var o = ko();
  function p(z) {
    var v = "https://react.dev/errors/" + z;
    if (1 < arguments.length) {
      v += "?args[]=" + encodeURIComponent(arguments[1]);
      for (var U = 2; U < arguments.length; U++) v += "&args[]=" + encodeURIComponent(arguments[U]);
    }
    return "Minified React error #" + z + "; visit " + v + " for the full message or use the non-minified dev environment for full errors and additional helpful warnings.";
  }
  function h() {
  }
  ...
  function N(z, v, U) {
    ...
    return { $$typeof: g, key: A == null ? null : "" + A, children: z, containerInfo: v, implementation: U };
  }
  ...
  return gt.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE = r, gt.createPortal = function(z, v) {
  ...
  }, gt.preconnect = function(z, v) {
    typeof z == "string" && (v ? (v = v.crossOrigin, v = typeof v == "string" ? v === "use-credentials" ? v : "" : void 0) : v = null, r.d.C(z, v));
  }, gt.prefetchDNS = function(z) {
    typeof z == "string" && r.d.D(z);
  }, gt.preinit = function(z, v) {
    if (typeof z == "string" && v && typeof v.as == "string") {
      ...
      U === "style" ? r.d.S(z, typeof v.precedence == "string" ? v.precedence : void 0, { crossOrigin: A, integrity: $, fetchPriority: J }) : U === "script" && r.d.X(z, { crossOrigin: A, integrity: $, fetchPriority: J, nonce: typeof v.nonce == "string" ? v.nonce : void 0 });
    }
  }, gt.preinitModule = function(z, v) {
    if (typeof z == "string") if (typeof v == "object" && v !== null) {
      if (v.as == null || v.as === "script") {
        var U = C(v.as, v.crossOrigin);
        r.d.M(z, { crossOrigin: U, integrity: typeof v.integrity == "string" ? v.integrity : void 0, nonce: typeof v.nonce == "string" ? v.nonce : void 0 });
      }
    } else v == null && r.d.M(z);
  }, gt.preload = function(z, v) {
    if (typeof z == "string" && typeof v == "object" && v !== null && typeof v.as == "string") {
      var U = v.as, A = C(U, v.crossOrigin);
      r.d.L(z, U, { crossOrigin: A, integrity: typeof v.integrity == "string" ? v.integrity : void 0, nonce: typeof v.nonce == "string" ? v.nonce : void 0, type: typeof v.type == "string" ? v.type : void 0, fetchPriority: typeof v.fetchPriority == "string" ? v.fetchPriority : void 0, referrerPolicy: typeof v.referrerPolicy == "string" ? v.referrerPolicy : void 0, imageSrcSet: typeof v.imageSrcSet == "string" ? v.imageSrcSet : void 0, imageSizes: typeof v.imageSizes == "string" ? v.imageSizes : void 0, media: typeof v.media == "string" ? v.media : void 0 });
    }
  }, gt.preloadModule = function(z, v) {
    if (typeof z == "string") if (v) {
      var U = C(v.as, v.crossOrigin);
      r.d.m(z, { as: typeof v.as == "string" && v.as !== "script" ? v.as : void 0, crossOrigin: U, integrity: typeof v.integrity == "string" ? v.integrity : void 0 });
    } else r.d.m(z);
  }, gt.requestFormReset = function(z) {
    r.d.r(z);
  }, gt.unstable_batchedUpdates = function(z, v) {
    return z(v);
  }, gt.useFormState = function(z, v, U) {
    return R.H.useFormState(z, v, U);
...
function _h() {
  ...
  function yl(e) {
    P.current === e && (k(L), k(P)), ce.current === e && (k(ce), Ei._currentValue = Q);
  }
  var On, Cn;
  function ya(e) {
    if (On === void 0) try {
...
` + l.stack;
  ...
  }, defaultPrevented: 0, isTrusted: 0 }, as = At(kl), Vn = A({}, kl, { view: 0, detail: 0 }), dm = At(Vn), wc, jc, Jn, ls = A({}, Vn, { screenX: 0, screenY: 0, clientX: 0, clientY: 0, pageX: 0, pageY: 0, ctrlKey: 0, shiftKey: 0, altKey: 0, metaKey: 0, getModifierState: Ec, button: 0, buttons: 0, relatedTarget: function(e) {
  ...
  } }), ir = At(ls), fm = A({}, ls, { dataTransfer: 0 }), mm = At(fm), hm = A({}, Vn, { relatedTarget: 0 }), Ac = At(hm), pm = A({}, kl, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }), xm = At(pm), gm = A({}, kl, { clipboardData: function(e) {
    return "clipboardData" in e ? e.clipboardData : window.clipboardData;
  } }), bm = At(gm), ym = A({}, kl, { data: 0 }), sr = At(ym), vm = { Esc: "Escape", Spacebar: " ", Left: "ArrowLeft", Up: "ArrowUp", Right: "ArrowRight", Down: "ArrowDown", Del: "Delete", Win: "OS", Menu: "ContextMenu", Apps: "ContextMenu", Scroll: "ScrollLock", MozPrintableKey: "Unidentified" }, _m = { 8: "Backspace", 9: "Tab", 12: "Clear", 13: "Enter", 16: "Shift", 17: "Control", 18: "Alt", 19: "Pause", 20: "CapsLock", 27: "Escape", 32: " ", 33: "PageUp", 34: "PageDown", 35: "End", 36: "Home", 37: "ArrowLeft", 38: "ArrowUp", 39: "ArrowRight", 40: "ArrowDown", 45: "Insert", 46: "Delete", 112: "F1", 113: "F2", 114: "F3", 115: "F4", 116: "F5", 117: "F6", 118: "F7", 119: "F8", 120: "F9", 121: "F10", 122: "F11", 123: "F12", 144: "NumLock", 145: "ScrollLock", 224: "Meta" }, Nm = { Alt: "altKey", Control: "ctrlKey", Meta: "metaKey", Shift: "shiftKey" };
  function Sm(e) {
  ...
  } }), jm = At(wm), Am = A({}, ls, { pointerId: 0, width: 0, height: 0, pressure: 0, tangentialPressure: 0, tiltX: 0, tiltY: 0, twist: 0, pointerType: 0, isPrimary: 0 }), cr = At(Am), Em = A({}, Vn, { touches: 0, targetTouches: 0, changedTouches: 0, altKey: 0, metaKey: 0, ctrlKey: 0, shiftKey: 0, getModifierState: Ec }), Mm = At(Em), zm = A({}, kl, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }), Tm = At(zm), km = A({}, ls, { deltaX: function(e) {
    return "deltaX" in e ? e.deltaX : "wheelDeltaX" in e ? -e.wheelDeltaX : 0;
  }, deltaY: function(e) {
    return "deltaY" in e ? e.deltaY : "wheelDeltaY" in e ? -e.wheelDeltaY : "wheelDelta" in e ? -e.wheelDelta : 0;
  }, deltaZ: 0, deltaMode: 0 }), Rm = At(km), Om = A({}, kl, { newState: 0, oldState: 0 }), Cm = At(Om), Dm = [9, 13, 27, 32], Mc = _t && "CompositionEvent" in window, Kn = null;
  ...
  if (_t) {
    ...
    if (_t) {
      ...
      if (!Tc) {
        ...
        gr.setAttribute("oninput", "return;"), Tc = typeof gr.oninput == "function";
      }
      zc = Tc;
    } else zc = false;
    xr = zc && (!document.documentMode || 9 < document.documentMode);
  }
  function br() {
  ...
  var mt = null, Ue = null, me = false, Ia = null, Kt = false, Xc = Error(r(519));
  function Fa(e) {
  ...
  function Zc() {
    var e = Ia;
    return e !== null && (Tt === null ? Tt = e : Tt.push.apply(Tt, e), Ia = null), e;
  }
  function ei(e) {
    Ia === null ? Ia = [e] : Ia.push(e);
  }
  var Qc = m(null), Hl = null, Ta = null;
  function Pa(e, t, a) {
  ...
  function Bl(e) {
    Hl = e, Ta = null, e = e.dependencies, e !== null && (e.firstContext = null);
  }
  function ht(e) {
    return Yr(Hl, e);
  }
  ...
  }, Fm = o.unstable_scheduleCallback, Pm = o.unstable_NormalPriority, $e = { $$typeof: xe, Consumer: null, Provider: null, _currentValue: null, _currentValue2: null, _threadCount: 0 };
  function Kc() {
  ...
  var mn = Error(r(460)), Ic = Error(r(474)), hs = Error(r(542)), ps = { then: function() {
  } };
  function Xr(e) {
  ...
  function Jr(e) {
    ...
    function T(x, f, b) {
      ...
      if (typeof f == "object" && f !== null) {
        switch (f.$$typeof) {
          ...
          case le:
            return f = Ll(f), T(x, f, b);
        }
        if (Se(f) || Ee(f)) return f = Dl(f, x.mode, b, null), f.return = x, f;
        if (typeof f.then == "function") return T(x, xs(f), b);
        if (f.$$typeof === xe) return T(x, fs(x, f), b);
        gs(x, f);
      }
      return null;
    }
    ...
    function G(x, f, b, M) {
      ...
      if (ie === b.length) return a(x, q), me && za(x, ie), V;
      if (q === null) {
        for (; ie < b.length; ie++) q = T(x, b[ie], M), q !== null && (f = i(q, f, ie), ge === null ? V = q : ge.sibling = q, ge = q);
        return me && za(x, ie), V;
      }
    ...
    function K(x, f, b, M) {
      ...
      if (be.done) return a(x, q), me && za(x, ie), V;
      if (q === null) {
        for (; !be.done; ie++, be = b.next()) be = T(x, be.value, M), be !== null && (f = i(be, f, ie), ge === null ? V = be : ge.sibling = be, ge = be);
        return me && za(x, ie), V;
      }
    ...
    function Te(x, f, b, M) {
      if (typeof b == "object" && b !== null && b.type === ae && b.key === null && (b = b.props.children), typeof b == "object" && b !== null) {
        ...
        if (typeof b.then == "function") return Te(x, f, xs(b), M);
        if (b.$$typeof === xe) return Te(x, f, fs(x, b), M);
        gs(x, b);
      }
  ...
  function ci(e, t, a, l) {
    ...
    if (i !== null) {
      ...
      do {
        ...
        if (j ? (re & _) === _ : (l & _) === _) {
          ...
          e: {
            ...
            switch (K.tag) {
              ...
              case 0:
                if (G = K.payload, _ = typeof G == "function" ? G.call(Te, T, _) : G, _ == null) break e;
                T = A({}, T, _);
                break e;
              case 2:
                el = true;
        ...
        } else j = { lane: _, tag: u.tag, payload: u.payload, callback: u.callback, next: null }, E === null ? (y = E = j, d = T) : E = E.next = j, c |= _;
        if (u = u.next, u === null) {
          if (u = n.shared.pending, u === null) break;
          j = u, u = j.next, j.next = null, n.lastBaseUpdate = j, n.shared.pending = null;
        }
      } while (true);
      E === null && (d = T), n.baseState = d, n.firstBaseUpdate = y, n.lastBaseUpdate = E, i === null && (n.shared.lanes = 0), cl |= c, e.lanes = c, e.memoizedState = T;
    }
  }
  function $r(e, t) {
  ...
  function du(e, t, a) {
    ...
    if (i = e.baseState, n === null) e.memoizedState = i;
      ...
      do {
        ...
        if (T !== y.lane ? (re & T) === T : (Ra & T) === T) {
          var _ = y.revertLane;
          if (_ === 0) d !== null && (d = d.next = { lane: 0, revertLane: 0, gesture: null, action: y.action, hasEagerState: y.hasEagerState, eagerState: y.eagerState, next: null }), T === dn && (E = true);
          else if ((Ra & _) === _) {
            y = y.next, _ === dn && (E = true);
            continue;
          } else T = { lane: 0, revertLane: y.revertLane, gesture: null, action: y.action, hasEagerState: y.hasEagerState, eagerState: y.eagerState, next: null }, d === null ? (u = d = T, c = i) : d = d.next = T, ne.lanes |= _, cl |= _;
          T = y.action, Xl && a(i, T), i = y.hasEagerState ? y.eagerState : a(i, T);
        } else _ = { lane: T, revertLane: y.revertLane, gesture: y.gesture, action: y.action, hasEagerState: y.hasEagerState, eagerState: y.eagerState, next: null }, d === null ? (u = d = _, c = i) : d = d.next = _, ne.lanes |= T, cl |= T;
        y = y.next;
      } while (y !== null && y !== t);
  ...
  function Ad(e, t, a, l) {
    return Ot(a, t) ? a : pn.current !== null ? (e = gu(e, a, l), Ot(e, t) || (Ie = true), e) : (Ra & 42) === 0 || (Ra & 1073741824) !== 0 && (re & 261930) === 0 ? (Ie = true, e.memoizedState = a) : (e = A0(), ne.lanes |= e, cl |= e, t);
  }
  ...
  }, useSyncExternalStore: td, useId: Td, useHostTransitionStatus: yu, useFormState: hd, useActionState: hd, useOptimistic: function(e, t) {
    var a = Je();
    return cd(a, Me, e, t);
  ...
  var Ud = { readContext: ht, use: Ss, useCallback: wd, useContext: ht, useEffect: pu, useImperativeHandle: Sd, useInsertionEffect: vd, useLayoutEffect: _d, useMemo: jd, useReducer: fu, useRef: gd, useState: function() {
    ...
    return [typeof e == "boolean" ? e : oi(e), t];
  }, useSyncExternalStore: td, useId: Td, useHostTransitionStatus: yu, useFormState: xd, useActionState: xd, useOptimistic: function(e, t) {
    var a = Je();
  ...
  function Wd(e, t, a) {
    return ql(t, e.child, null, a), e = zs(t, t.pendingProps), e.flags |= 2, Ut(t), t.memoizedState = null, e;
  }
  function d1(e, t, a) {
    var l = t.pendingProps, n = (t.flags & 128) !== 0;
    if (t.flags &= -129, e === null) {
      if (me) {
        if (l.mode === "hidden") return e = zs(t, l), t.lanes = 536870912, fi(null, e);
    ...
    if (i !== null) {
      ...
      if (nu(t), n) if (t.flags & 256) t.flags &= -257, t = Wd(e, t, a);
        ...
        if (l = Re, l !== null && (c = wl(l, a), c !== 0 && c !== i.retryLane)) throw i.retryLane = c, Cl(e, c), kt(l, e, c), ju;
        Ls(), t = Wd(e, t, a);
      } else e = i.treeContext, Ue = Wt(c.nextSibling), mt = t, me = true, Ia = null, Kt = false, e !== null && Ur(t, e), t = zs(t, l), t.flags |= 4096;
      return t;
    }
  ...
  function Fd(e, t, a, l, n) {
    if (Bl(t), t.stateNode === null) {
      ...
      E = typeof T == "function" || typeof i.getSnapshotBeforeUpdate == "function", u = t.pendingProps !== u, E || typeof i.UNSAFE_componentWillReceiveProps != "function" && typeof i.componentWillReceiveProps != "function" || (u || y !== c) && Bd(t, i, l, c), el = false;
      var _ = t.memoizedState;
      i.state = _, ci(t, l, i, n), si(), y = t.memoizedState, u || _ !== y || el ? (typeof T == "function" && (Nu(t, a, T, l), y = t.memoizedState), (d = el || Hd(t, a, d, l, _, y, c)) ? (E || typeof i.UNSAFE_componentWillMount != "function" && typeof i.componentWillMount != "function" || (typeof i.componentWillMount == "function" && i.componentWillMount(), typeof i.UNSAFE_componentWillMount == "function" && i.UNSAFE_componentWillMount()), typeof i.componentDidMount == "function" && (t.flags |= 4194308)) : (typeof i.componentDidMount == "function" && (t.flags |= 4194308), t.memoizedProps = l, t.memoizedState = y), i.props = l, i.state = y, i.context = c, l = d) : (typeof i.componentDidMount == "function" && (t.flags |= 4194308), l = false);
    } else {
      i = t.stateNode, Pc(e, t), c = t.memoizedProps, E = Zl(a, c), i.props = E, T = t.pendingProps, _ = i.context, y = a.contextType, d = sn, typeof y == "object" && y !== null && (d = ht(y)), u = a.getDerivedStateFromProps, (y = typeof u == "function" || typeof i.getSnapshotBeforeUpdate == "function") || typeof i.UNSAFE_componentWillReceiveProps != "function" && typeof i.componentWillReceiveProps != "function" || (c !== T || _ !== d) && Bd(t, i, l, d), el = false, _ = t.memoizedState, i.state = _, ci(t, l, i, n), si();
      var j = t.memoizedState;
      c !== T || _ !== j || el || e !== null && e.dependencies !== null && ds(e.dependencies) ? (typeof u == "function" && (Nu(t, a, u, l), j = t.memoizedState), (E = el || Hd(t, a, E, l, _, j, d) || e !== null && e.dependencies !== null && ds(e.dependencies)) ? (y || typeof i.UNSAFE_componentWillUpdate != "function" && typeof i.componentWillUpdate != "function" || (typeof i.componentWillUpdate == "function" && i.componentWillUpdate(l, j, d), typeof i.UNSAFE_componentWillUpdate == "function" && i.UNSAFE_componentWillUpdate(l, j, d)), typeof i.componentDidUpdate == "function" && (t.flags |= 4), typeof i.getSnapshotBeforeUpdate == "function" && (t.flags |= 1024)) : (typeof i.componentDidUpdate != "function" || c === e.memoizedProps && _ === e.memoizedState || (t.flags |= 4), typeof i.getSnapshotBeforeUpdate != "function" || c === e.memoizedProps && _ === e.memoizedState || (t.flags |= 1024), t.memoizedProps = l, t.memoizedState = j), i.props = l, i.state = j, i.context = d, l = E) : (typeof i.componentDidUpdate != "function" || c === e.memoizedProps && _ === e.memoizedState || (t.flags |= 4), typeof i.getSnapshotBeforeUpdate != "function" || c === e.memoizedProps && _ === e.memoizedState || (t.flags |= 1024), l = false);
    }
    return i = l, Ts(e, t), l = (t.flags & 128) !== 0, i || l ? (i = t.stateNode, a = l && typeof a.getDerivedStateFromError != "function" ? null : i.render(), t.flags |= 1, e !== null && l ? (t.child = ql(t, e.child, null, n), t.child = ql(t, null, a, n)) : pt(e, t, a, n), t.memoizedState = i.state, e = t.child) : e = Ca(e, t, n), e;
  }
  function Pd(e, t, a, l) {
  ...
  function ku(e, t, a) {
    return ql(t, e.child, null, a), e = Tu(t, t.pendingProps.children), e.flags |= 2, t.memoizedState = null, e;
  }
  function t0(e, t, a) {
    e.lanes |= t;
    var l = e.alternate;
    ...
    switch (t.lanes = 0, t.tag) {
      case 16:
        e: {
          ...
          if (e = Ll(t.elementType), t.type = e, typeof e == "function") Bc(e) ? (l = Zl(e, l), t.tag = 1, t = Fd(null, t, e, l, a)) : (t.tag = 0, t = Au(null, t, e, l, a));
          else {
            if (e != null) {
              var n = e.$$typeof;
              if (n === fe) {
      ...
      case 3:
        ...
        return t;
      case 26:
        return Ts(e, t), e === null ? (a = pf(t.type, null, t.pendingProps, null)) ? t.memoizedState = a : me || (a = t.type, e = t.pendingProps, l = Js(ee.current).createElement(a), l[Oe] = t, l[dt] = e, xt(l, a, e), Qe(l), t.stateNode = l) : t.memoizedState = pf(t.type, e.memoizedProps, t.pendingProps, e.memoizedState), null;
      case 27:
        return bl(t), e === null && me && (l = t.stateNode = ff(t.type, t.pendingProps, ee.current), mt = t, Kt = true, n = Ue, fl(t.type) ? (mo = n, Ue = Wt(l.firstChild)) : Ue = n), pt(e, t, t.pendingProps.children, a), Ts(e, t), e === null && (t.flags |= 4194304), t.child;
      case 5:
        return e === null && me && ((n = l = Ue) && (l = q1(l, t.type, t.pendingProps, Kt), l !== null ? (t.stateNode = l, mt = t, Ue = Wt(l.firstChild), Kt = false, n = true) : n = false), n || Fa(t)), bl(t), n = t.type, i = t.pendingProps, c = e !== null ? e.memoizedProps : null, l = i.children, co(n, i) ? l = null : c !== null && co(n, c) && (t.flags |= 32), t.memoizedState !== null && (n = su(e, t, l1, null, null, a), Ei._currentValue = n), Ts(e, t), pt(e, t, l, a), t.child;
      case 6:
  ...
  function n0(e, t) {
    ...
    else if (e.flags |= 16777216, !vf(t)) if (T0()) e.flags |= 8192;
    else throw Gl = ps, Ic;
  }
  function Rs(e, t) {
  ...
  function m1(e, t, a) {
    ...
    switch (qc(t), t.tag) {
      ...
      case 19:
        if (k(Ve), l = t.memoizedState, l === null) return He(t), null;
        if (n = (t.flags & 128) !== 0, i = l.rendering, i === null) if (n) mi(l, false);
          ...
          if (qe !== 0 || e !== null && (e.flags & 128) !== 0) for (e = t.child; e !== null; ) {
            if (i = ys(e), i !== null) {
              ...
              return B(Ve, Ve.current & 1 | 2), me && za(t, l.treeForkCount), t.child;
            }
            e = e.sibling;
          }
        ...
        return l.tail !== null ? (e = l.tail, l.rendering = e, l.tail = e.sibling, l.renderingStartTime = bt(), e.sibling = null, a = Ve.current, B(Ve, n ? a & 1 | 2 : a & 1), me && za(t, l.treeForkCount), e) : (He(t), null);
      case 22:
      case 23:
        return Ut(t), lu(), l = t.memoizedState !== null, e !== null ? e.memoizedState !== null !== l && (t.flags |= 8192) : l && (t.flags |= 8192), l ? (a & 536870912) !== 0 && (t.flags & 128) === 0 && (He(t), t.subtreeFlags & 6 && (t.flags |= 8192)) : He(t), a = t.updateQueue, a !== null && Rs(t, a.retryQueue), a = null, e !== null && e.memoizedState !== null && e.memoizedState.cachePool !== null && (a = e.memoizedState.cachePool.pool), l = null, t.memoizedState !== null && t.memoizedState.cachePool !== null && (l = t.memoizedState.cachePool.pool), l !== a && (t.flags |= 2048), e !== null && k(Yl), null;
      case 24:
  ...
  function h1(e, t) {
    switch (qc(t), t.tag) {
      ...
      case 22:
      case 23:
        return Ut(t), lu(), e !== null && k(Yl), e = t.flags, e & 65536 ? (t.flags = e & -65537 | 128, t) : null;
      case 24:
        return ka($e), null;
      case 25:
        return null;
    ...
    if (e = e.containerInfo, io = ec, e = Sr(e), kc(e)) {
      if ("selectionStart" in e) var a = { start: e.selectionStart, end: e.selectionEnd };
        ...
        if (l && l.rangeCount !== 0) {
          ...
          var c = 0, u = -1, d = -1, y = 0, E = 0, T = e, _ = null;
          t: for (; ; ) {
            for (var j; T !== a || n !== 0 && T.nodeType !== 3 || (u = c + n), T !== i || l !== 0 && T.nodeType !== 3 || (d = c + l), T.nodeType === 3 && (c += T.nodeValue.length), (j = T.firstChild) !== null; ) _ = T, T = j;
            for (; ; ) {
              if (T === e) break t;
              if (_ === a && ++y === n && (u = c), _ === i && ++E === l && (d = c), (j = T.nextSibling) !== null) break;
              T = _, _ = T.parentNode;
            }
            T = j;
          }
  ...
  function h0(e, t, a) {
    ...
    switch (a.tag) {
      ...
      case 6:
        ...
        break;
      case 18:
        Ye !== null && (Et ? (e = Ye, cf(e.nodeType === 9 ? e.body : e.nodeName === "HTML" ? e.ownerDocument.body : e, a.stateNode), Tn(e)) : cf(Ye, a.stateNode));
        break;
      case 4:
  ...
  function g0(e, t) {
    ...
    switch (e.tag) {
      ...
      case 14:
      case 15:
        Mt(t, e), zt(e), l & 4 && (il(3, e, e.return), hi(3, e), il(5, e, e.return));
        break;
      case 1:
        Mt(t, e), zt(e), l & 512 && (Fe || a === null || ga(a, a.return)), l & 64 && Ua && (e = e.updateQueue, e !== null && (l = e.callbacks, l !== null && (a = e.shared.hiddenCallbacks, e.shared.hiddenCallbacks = a === null ? l : a.concat(l))));
        break;
      case 26:
        var n = ca;
        if (Mt(t, e), zt(e), l & 512 && (Fe || a === null || ga(a, a.return)), l & 4) {
        ...
        break;
      case 27:
        Mt(t, e), zt(e), l & 512 && (Fe || a === null || ga(a, a.return)), a !== null && l & 4 && Du(e, e.memoizedProps, a.memoizedProps);
        break;
      case 5:
        if (Mt(t, e), zt(e), l & 512 && (Fe || a === null || ga(a, a.return)), e.flags & 32) {
          n = e.stateNode;
          try {
            Xt(n, "");
          } catch (G) {
      ...
      case 6:
        ...
        break;
      case 3:
        if (Ws = null, n = ca, ca = Ks(t.containerInfo), Mt(t, e), ca = n, zt(e), l & 4 && a !== null && a.memoizedState.isDehydrated) try {
          Tn(t.containerInfo);
        } catch (G) {
          Ae(e, e.return, G);
        }
        ...
        break;
      case 4:
        l = ca, ca = Ks(e.stateNode.containerInfo), Mt(t, e), zt(e), ca = l;
        break;
      case 12:
        Mt(t, e), zt(e);
        break;
      case 31:
        Mt(t, e), zt(e), l & 4 && (l = e.updateQueue, l !== null && (e.updateQueue = null, Cs(e, l)));
        break;
      case 13:
        Mt(t, e), zt(e), e.child.flags & 8192 && e.memoizedState !== null != (a !== null && a.memoizedState !== null) && (Us = bt()), l & 4 && (l = e.updateQueue, l !== null && (e.updateQueue = null, Cs(e, l)));
        break;
      case 22:
        n = e.memoizedState !== null;
        var d = a !== null && a.memoizedState !== null, y = Ua, E = Fe;
        if (Ua = y || n, Fe = E || d, Mt(t, e), Fe = E, Ua = y, zt(e), l & 8192) e: for (t = e.stateNode, t._visibility = n ? t._visibility & -2 : t._visibility | 1, n && (a === null || d || Ua || Fe || Ql(e)), a = null, t = e; ; ) {
          if (t.tag === 5 || t.tag === 26) {
            if (a === null) {
              d = a = t;
              try {
  ...
  } }, b1 = typeof WeakMap == "function" ? WeakMap : Map, _e = 0, Re = null, ue = null, re = 0, je = 0, Ht = null, sl = false, _n = false, Gu = false, La = 0, qe = 0, cl = 0, Vl = 0, qu = 0, Bt = 0, Nn = 0, yi = null, Tt = null, Xu = false, Us = 0, w0 = 0, Hs = 1 / 0, Bs = null, ul = null, at = 0, ol = null, Sn = null, Ga = 0, Zu = 0, Qu = null, j0 = null, vi = 0, Vu = null;
  function Yt() {
      ...
      if (n === 0) {
          ...
          if (c !== 0) {
            ...
            e: {
              ...
              if (d && (wn(u, c).flags |= 256), c = Ku(u, c, false), c !== 2) {
                ...
                i = Tt, Tt = n, i !== null && (Tt === null ? Tt = i : Tt.push.apply(Tt, i));
              }
              n = c;
            }
        ...
        e: {
          ...
          if ((t & 62914560) === t && (n = Us + 300 - bt(), 10 < n)) {
            ...
            Ga = t, l.timeoutHandle = nf(M0.bind(null, l, a, Tt, Bs, Xu, t, Bt, Vl, Nn, sl, i, "Throttled", -0, 0), n);
            break e;
          }
          M0(l, a, Tt, Bs, Xu, t, Bt, Vl, Nn, sl, i, null, -0, 0);
        }
      }
      break;
    } while (true);
  ...
  function M0(e, t, a, l, n, i, c, u, d, y, E, T, _, j) {
    if (e.timeoutHandle = -1, T = t.subtreeFlags, T & 8192 || (T & 16785408) === 16785408) {
      T = { stylesheets: null, count: 0, imgCount: 0, imgBytes: 0, suspenseyImages: [], waitingForImages: true, waitingForViewTransition: false, unsuspend: tt }, v0(t, i, T);
      var G = (i & 62914560) === i ? Us - bt() : (i & 4194048) === i ? w0 - bt() : 0;
      if (G = lh(T, G), G !== null) {
        Ga = i, e.cancelPendingCommit = G(U0.bind(null, e, t, i, a, l, n, c, u, d, E, T, null, _, j)), rl(e, i, c, !y);
        return;
      }
    }
  ...
  function Ju() {
    if (ue !== null) {
      ...
      else e = ue, Ta = Hl = null, ou(e), hn = null, li = 0, e = ue;
  ...
  function wn(e, t) {
    ...
    a !== -1 && (e.timeoutHandle = -1, Y1(a)), a = e.cancelPendingCommit, a !== null && (e.cancelPendingCommit = null, a()), Ga = 0, Ju(), Re = e, ue = a = Ma(e.current, null), re = t, je = 0, Ht = null, sl = false, _n = da(e, t), Gu = false, Nn = Bt = qu = Vl = cl = qe = 0, Tt = yi = null, Xu = false, (t & 8) !== 0 && (t |= t & 32);
  ...
  function z0(e, t) {
    ne = null, S.H = di, t === mn || t === hs ? (t = Qr(), je = 3) : t === Ic ? (t = Qr(), je = 4) : je = t === ju ? 8 : t !== null && typeof t == "object" && typeof t.then == "function" ? 6 : 1, Ht = t, ue === null && (qe = 1, Ms(e, Qt(t, e.current)));
  }
  function T0() {
    var e = Dt.current;
  ...
  function Ku(e, t, a) {
    ...
    while (true);
    return t && e.shellSuspendCounter++, Ta = Hl = null, _e = l, S.H = n, S.A = i, ue === null && (Re = null, re = 0, ss()), c;
  }
  function v1() {
    for (; ue !== null; ) O0(ue);
  }
  function _1(e, t) {
    ...
    while (true);
    return Ta = Hl = null, S.H = l, S.A = n, _e = a, ue !== null ? 0 : (Re = null, re = 0, ss(), qe);
  }
  function N1() {
          ...
          if (c !== u && u && u.ownerDocument && Nr(u.ownerDocument.documentElement, u)) {
            if (d !== null && kc(u)) {
              ...
              if (E === void 0 && (E = y), "selectionStart" in u) u.selectionStart = y, u.selectionEnd = Math.min(E, u.value.length);
                ...
                var T = u.ownerDocument || document, _ = T && T.defaultView || window;
                if (_.getSelection) {
                  var j = _.getSelection(), G = u.textContent.length, K = Math.min(d.start, G), Te = d.end === void 0 ? K : Math.min(d.end, G);
                  !j.extend && K > Te && (c = Te, Te = K, K = c);
                  var x = _r(u, K), f = _r(u, Te);
                  if (x && f && (j.rangeCount !== 1 || j.anchorNode !== x.node || j.anchorOffset !== x.offset || j.focusNode !== f.node || j.focusOffset !== f.offset)) {
                    var b = T.createRange();
                    b.setStart(x.node, x.offset), j.removeAllRanges(), K > Te ? (j.addRange(b), j.extend(f.node, f.offset)) : (b.setEnd(f.node, f.offset), j.addRange(b));
                  }
                }
              }
            }
            for (T = [], j = u; j = j.parentNode; ) j.nodeType === 1 && T.push({ element: j, left: j.scrollLeft, top: j.scrollTop });
  ...
  var Xs = null, An = null, Wu = false, Zs = false, Iu = false, dl = 0;
  function ba(e) {
  ...
  for (var Pu = 0; Pu < Dc.length; Pu++) {
    var eo = Dc[Pu], T1 = eo.toLowerCase(), k1 = eo[0].toUpperCase() + eo.slice(1);
    sa(T1, "on" + k1);
  }
  sa(Ar, "onAnimationEnd"), sa(Er, "onAnimationIteration"), sa(Mr, "onAnimationStart"), sa("dblclick", "onDoubleClick"), sa("focusin", "onFocus"), sa("focusout", "onBlur"), sa(Jm, "onTransitionRun"), sa(Km, "onTransitionStart"), sa($m, "onTransitionCancel"), sa(zr, "onTransitionEnd"), la("onMouseEnter", ["mouseout", "mouseover"]), la("onMouseLeave", ["mouseout", "mouseover"]), la("onPointerEnter", ["pointerout", "pointerover"]), la("onPointerLeave", ["pointerout", "pointerover"]), aa("onChange", "change click focusin focusout input keydown keyup selectionchange".split(" ")), aa("onSelect", "focusout contextmenu dragend focusin keydown keyup mousedown mouseup selectionchange".split(" ")), aa("onBeforeInput", ["compositionend", "keypress", "textInput", "paste"]), aa("onCompositionEnd", "compositionend focusout keydown keypress keyup mousedown".split(" ")), aa("onCompositionStart", "compositionstart focusout keydown keypress keyup mousedown".split(" ")), aa("onCompositionUpdate", "compositionupdate focusout keydown keypress keyup mousedown".split(" "));
    ...
    Tl(function() {
      ...
      e: {
        ...
        if (_ !== void 0) {
          ...
          var K = (t & 4) !== 0, Te = !K && (e === "scroll" || e === "scrollend"), x = K ? _ !== null ? _ + "Capture" : null : _;
          K = [];
          for (var f = y, b; f !== null; ) {
            var M = f;
            if (b = M.stateNode, M = M.tag, M !== 5 && M !== 26 && M !== 27 || b === null || x === null || (M = ja(f, x), M != null && K.push(Si(f, M, b))), Te) break;
            f = f.return;
          }
          0 < K.length && (_ = new j(_, G, null, a, E), T.push({ event: _, listeners: K }));
        }
      }
      if ((t & 7) === 0) {
        e: {
          if (_ = e === "mouseover" || e === "pointerover", j = e === "mouseout" || e === "pointerout", _ && a !== vt && (G = a.relatedTarget || a.fromElement) && (qt(G) || G[fa])) break e;
          if ((j || _) && (_ = E.window === E ? E : (_ = E.ownerDocument) ? _.defaultView || _.parentWindow : window, j ? (G = a.relatedTarget || a.toElement, j = y, G = G ? qt(G) : null, G !== null && (Te = N(G), K = G.tag, G !== Te || K !== 5 && K !== 27 && K !== 6) && (G = null)) : (j = null, G = y), j !== G)) {
            if (K = ir, M = "onMouseLeave", x = "onMouseEnter", f = "mouse", (e === "pointerout" || e === "pointerover") && (K = cr, M = "onPointerLeave", x = "onPointerEnter", f = "pointer"), Te = j == null ? _ : ta(j), b = G == null ? _ : ta(G), _ = new K(M, f + "leave", j, a, E), _.target = Te, _.relatedTarget = b, M = null, qt(E) === y && (K = new K(x, f + "enter", G, a, E), K.target = b, K.relatedTarget = Te, M = K), Te = M, j && G) t: {
            ...
            j !== null && F0(T, _, j, K, false), G !== null && Te !== null && F0(T, Te, G, K, true);
          }
        }
        e: {
        ...
        de && (ur && a.locale !== "ko" && (tn || de !== "onCompositionStart" ? de === "onCompositionEnd" && tn && (ie = lr()) : (ha = E, Sc = "value" in ha ? ha.value : ha.textContent, tn = true)), q = Vs(y, de), 0 < q.length && (de = new sr(de, e, null, a, E), T.push({ event: de, listeners: q }), ie ? de.data = ie : (ie = fr(a), ie !== null && (de.data = ie)))), (ie = Um ? Hm(e, a) : Bm(e, a)) && (de = Vs(y, "onBeforeInput"), 0 < de.length && (q = new sr("onBeforeInput", "beforeinput", null, a, E), T.push({ event: q, listeners: de }), q.data = ie)), z1(T, e, y, a, E);
      }
      W0(T, t);
    });
  }
...
`).replace(D1, "");
    ...
    switch (a) {
      ...
      case "formAction":
        if (typeof l == "function") {
          ...
          break;
        } else typeof i == "function" && (a === "formAction" ? (t !== "input" && ze(e, t, "name", n.name, n, null), ze(e, t, "formEncType", n.formEncType, n, null), ze(e, t, "formMethod", n.formMethod, n, null), ze(e, t, "formTarget", n.formTarget, n, null)) : (ze(e, t, "encType", n.encType, n, null), ze(e, t, "method", n.method, n, null), ze(e, t, "target", n.target, n, null)));
  ...
  function xt(e, t, a) {
    switch (t) {
      ...
      case "textarea":
        ...
        return;
      case "option":
        for (d in a) a.hasOwnProperty(d) && (l = a[d], l != null) && (d === "selected" ? e.selected = l && typeof l != "function" && typeof l != "symbol" : ze(e, t, d, l, a, null));
        return;
      case "dialog":
    ...
    for (u in a) a.hasOwnProperty(u) && (l = a[u], l != null && ze(e, t, u, l, a, null));
  }
  function U1(e, t, a, l) {
    switch (t) {
      case "div":
      ...
      case "input":
        ...
        for (j in a) {
          var T = a[j];
          if (a.hasOwnProperty(j) && T != null) switch (j) {
            case "checked":
              break;
            case "value":
              break;
            case "defaultValue":
              d = T;
            default:
              l.hasOwnProperty(j) || ze(e, t, j, null, l, T);
          }
        }
        for (var _ in l) {
          var j = l[_];
          if (T = a[_], l.hasOwnProperty(_) && (j != null || T != null)) switch (_) {
            case "type":
              i = j;
              break;
            case "name":
      ...
      case "select":
        ...
        for (i in a) if (d = a[i], a.hasOwnProperty(i) && d != null) switch (i) {
          ...
          case "multiple":
            j = d;
          default:
            l.hasOwnProperty(i) || ze(e, t, i, null, l, d);
        }
      ...
      case "textarea":
        ...
        return;
      case "option":
        for (var G in a) _ = a[G], a.hasOwnProperty(G) && _ != null && !l.hasOwnProperty(G) && (G === "selected" ? e.selected = false : ze(e, t, G, null, l, _));
        for (d in l) _ = l[d], j = a[d], l.hasOwnProperty(d) && _ !== j && (_ != null || j != null) && (d === "selected" ? e.selected = _ && typeof _ != "function" && typeof _ != "symbol" : ze(e, t, d, _, l, j));
        return;
      case "img":
      case "link":
      case "area":
      ...
      case "wbr":
      case "menuitem":
        for (var K in a) _ = a[K], a.hasOwnProperty(K) && _ != null && !l.hasOwnProperty(K) && ze(e, t, K, null, l, _);
      ...
      default:
        if (Zn(t)) {
          for (var Te in a) _ = a[Te], a.hasOwnProperty(Te) && _ !== void 0 && !l.hasOwnProperty(Te) && no(e, t, Te, void 0, l, _);
          for (E in l) _ = l[E], j = a[E], !l.hasOwnProperty(E) || _ === j || _ === void 0 && j === void 0 || no(e, t, E, _, l, j);
          return;
        }
    }
    for (var x in a) _ = a[x], a.hasOwnProperty(x) && _ != null && !l.hasOwnProperty(x) && ze(e, t, x, null, l, _);
    for (T in l) _ = l[T], j = a[T], !l.hasOwnProperty(T) || _ === j || _ == null && j == null || ze(e, t, T, _, l, j);
  }
  function tf(e) {
    switch (e) {
      case "css":
      ...
      for (var e = 0, t = 0, a = performance.getEntriesByType("resource"), l = 0; l < a.length; l++) {
        ...
        if (i && u && tf(c)) {
          for (c = 0, u = n.responseEnd, l += 1; l < a.length; l++) {
            ...
            if (y > u) break;
            var E = d.transferSize, T = d.initiatorType;
            E && tf(T) && (d = d.responseEnd, c += E * (d < u ? 1 : (u - y) / (d - y)));
          }
  ...
  function V1(e) {
    var t = ea(e);
    t !== null && t.tag === 5 && t.type === "form" ? zd(t) : qa.r(e);
  }
  ...
  function $1(e, t, a) {
    ...
    if (l && e && t) {
      ...
      It.has(i) || (e = A({ rel: "preload", href: t === "image" && a && a.imageSrcSet ? void 0 : e, as: t }, a), It.set(i, e), l.querySelector(n) !== null || t === "style" && l.querySelector(ji(i)) || t === "script" && l.querySelector(Ai(i)) || (t = l.createElement("link"), xt(t, "link", e), Qe(t), l.head.appendChild(t)));
    }
  }
  function W1(e, t) {
    qa.m(e, t);
    ...
    if (a && e) {
      ...
      if (!It.has(i) && (e = A({ rel: "modulepreload", href: e }, t), It.set(i, e), a.querySelector(n) === null)) {
        switch (l) {
          case "audioworklet":
          case "paintworklet":
          case "serviceworker":
    ...
    if (l && e) {
      ...
      if (!c) {
        ...
        if (c = l.querySelector(ji(i))) u.loading = 5;
          ...
          e = A({ rel: "stylesheet", href: e, "data-precedence": t }, a), (a = It.get(i)) && ho(e, a);
  ...
  function F1(e, t) {
    ...
    var a = En;
    if (a && e) {
      var l = jl(a).hoistableScripts, n = zn(e), i = l.get(n);
      i || (i = a.querySelector(Ai(n)), i || (e = A({ src: e, async: true }, t), (t = It.get(n)) && po(e, t), i = a.createElement("script"), Qe(i), xt(i, "link", e), a.head.appendChild(i)), i = { type: "script", instance: i, count: 1, state: null }, l.set(n, i));
    }
  }
  function P1(e, t) {
    qa.M(e, t);
    ...
    if (a && e) {
      var l = jl(a).hoistableScripts, n = zn(e), i = l.get(n);
      i || (i = a.querySelector(Ai(n)), i || (e = A({ src: e, async: true, type: "module" }, t), (t = It.get(n)) && po(e, t), i = a.createElement("script"), Qe(i), xt(i, "link", e), a.head.appendChild(i)), i = { type: "script", instance: i, count: 1, state: null }, l.set(n, i));
    }
  }
  function pf(e, t, a, l) {
    ...
    switch (e) {
      ...
      case "link":
        if (a.rel === "stylesheet" && typeof a.href == "string" && typeof a.precedence == "string") {
          ...
          if (c || (n = n.ownerDocument || n, c = { type: "stylesheet", instance: null, count: 0, state: { loading: 0, preload: null } }, i.set(e, c), (i = n.querySelector(ji(e))) && !i._p && (c.instance = i, c.state.loading = 5), It.has(e) || (a = { rel: "preload", as: "style", href: a.href, crossOrigin: a.crossOrigin, integrity: a.integrity, media: a.media, hrefLang: a.hrefLang, referrerPolicy: a.referrerPolicy }, It.set(e, a), i || eh(n, e, a, c.state))), t && l === null) throw Error(r(528, ""));
          return c;
        }
        if (t && l !== null) throw Error(r(529, ""));
        return null;
      case "script":
        return t = a.async, a = a.src, typeof a == "string" && t && typeof t != "function" && typeof t != "symbol" ? (t = zn(a), a = jl(n).hoistableScripts, l = a.get(t), l || (l = { type: "script", instance: null, count: 0, state: null }, a.set(t, l)), l) : { type: "void", instance: null, count: 0, state: null };
      default:
        throw Error(r(444, e));
    }
  }
  ...
  function gf(e, t, a) {
    if (t.count++, t.instance === null) switch (t.type) {
      ...
      case "script":
        return i = zn(a.src), (n = e.querySelector(Ai(i))) ? (t.instance = n, Qe(n), n) : (l = a, (n = It.get(i)) && (l = A({}, a), po(l, n)), e = e.ownerDocument || e, n = e.createElement("script"), Qe(n), xt(n, "link", l), e.head.appendChild(n), t.instance = n);
      case "void":
        return null;
      default:
  ...
  function _f(e, t, a, l, n, i, c, u, d, y, E, T) {
    return e = new ih(e, t, a, c, d, y, E, T, u), t = 1, i === true && (t |= 24), i = Ct(3, null, null, t), e.current = i, i.stateNode = e, t = Kc(), t.refCount++, e.pooledCache = t, t.refCount++, i.memoizedState = { element: l, isDehydrated: a, cache: t }, Fc(i), e;
  }
  function Nf(e) {
    return e ? (e = sn, e) : sn;
  }
  ...
  var _o = false, ml = null, hl = null, pl = null, Mi = /* @__PURE__ */ new Map(), zi = /* @__PURE__ */ new Map(), xl = [], uh = "mousedown mouseup touchcancel touchend touchstart auxclick dblclick pointercancel pointerdown pointerup dragend dragstart drop compositionend compositionstart keydown keypress keyup input textInput copy cut paste click change contextmenu reset".split(" ");
  function Mf(e, t) {
    switch (e) {
      case "focusin":
      case "focusout":
  ...
  function oh(e, t, a, l, n) {
    switch (t) {
      case "focusin":
        return ml = Ti(ml, e, t, a, l, n), true;
      case "dragenter":
        return hl = Ti(hl, e, t, a, l, n), true;
      case "mouseover":
        return pl = Ti(pl, e, t, a, l, n), true;
      case "pointerover":
        var i = n.pointerId;
        return Mi.set(i, Ti(Mi.get(i) || null, e, t, a, l, n)), true;
      case "gotpointercapture":
        return i = n.pointerId, zi.set(i, Ti(zi.get(i) || null, e, t, a, l, n)), true;
    }
    return false;
  }
  function zf(e) {
  ...
  function rh() {
    _o = false, ml !== null && ac(ml) && (ml = null), hl !== null && ac(hl) && (hl = null), pl !== null && ac(pl) && (pl = null), Mi.forEach(Tf), zi.forEach(Tf);
  }
  function lc(e, t) {
  ...
  function Tn(e) {
    ...
    ml !== null && lc(ml, e), hl !== null && lc(hl, e), pl !== null && lc(pl, e), Mi.forEach(t), zi.forEach(t);
    for (var a = 0; a < xl.length; a++) {
      var l = xl[a];
      l.blockedOn === e && (l.blockedOn = null);
    }
    for (; 0 < xl.length && (a = xl[0], a.blockedOn === null); ) zf(a), a.blockedOn === null && xl.shift();
...
const Mh = w.forwardRef(({ color: o = "currentColor", size: p = 24, strokeWidth: h = 2, absoluteStrokeWidth: r, className: g = "", children: N, iconNode: R, ...C }, z) => w.createElement("svg", { ref: z, ...Eh, width: p, height: p, stroke: o, strokeWidth: r ? Number(h) * 24 / Number(p) : h, className: lm("lucide", g), ...!N && !Ah(C) && { "aria-hidden": "true" }, ...C }, [...R.map(([v, U]) => w.createElement(v, U)), ...Array.isArray(N) ? N : [N]]));
const Y = (o, p) => {
...
const zh = [["path", { d: "M22 12h-2.48a2 2 0 0 0-1.93 1.46l-2.35 8.36a.25.25 0 0 1-.48 0L9.24 2.18a.25.25 0 0 0-.48 0l-2.35 8.36A2 2 0 0 1 4.49 12H2", key: "169zse" }]], Ro = Y("activity", zh);
const Th = [["path", { d: "M12 5v14", key: "s699le" }], ["path", { d: "m19 12-7 7-7-7", key: "1idqje" }]], kh = Y("arrow-down", Th);
...
const zp = [["rect", { width: "18", height: "18", x: "3", y: "3", rx: "2", key: "afitv7" }], ["path", { d: "M3 9h18", key: "1pudct" }], ["path", { d: "M9 21V9", key: "1oto5p" }]], Tp = Y("panels-top-left", zp);
...
const _x = [["path", { d: "M4 14a1 1 0 0 1-.78-1.63l9.9-10.2a.5.5 0 0 1 .86.46l-1.92 6.02A1 1 0 0 0 13 10h7a1 1 0 0 1 .78 1.63l-9.9 10.2a.5.5 0 0 1-.86-.46l1.92-6.02A1 1 0 0 0 11 14z", key: "1xq2db" }]], oa = Y("zap", _x), ye = { baseTypingReward: 20, comboMultiplier: 0.5, moneyMilestones: [100, 500, 1e3, 5e3, 1e4, 5e4, 1e5], attributes: [{ id: "FIRE", name: "\u706B", color: "from-orange-500 to-red-600", glow: "shadow-orange-500/50", icon: "Flame", stats: { atk: 5, spd: 3, crit: 1 } }, { id: "WATER", name: "\u6C34", color: "from-blue-400 to-blue-600", glow: "shadow-blue-500/50", icon: "Droplets", stats: { atk: 3, spd: 5, crit: 1 } }, { id: "THUNDER", name: "\u96F7", color: "from-yellow-300 to-yellow-500", glow: "shadow-yellow-400/50", icon: "Zap", stats: { atk: 4, spd: 6, crit: 2 } }, { id: "WIND", name: "\u98A8", color: "from-green-400 to-emerald-600", glow: "shadow-emerald-500/50", icon: "Wind", stats: { atk: 2, spd: 8, crit: 1 } }, { id: "LIGHT", name: "\u5149", color: "from-amber-300 to-yellow-500 text-amber-950", glow: "shadow-yellow-500/50", icon: "Sun", stats: { atk: 7, spd: 4, crit: 3 } }, { id: "DARK", name: "\u95C7", color: "from-purple-800 to-black", glow: "shadow-purple-900/50", icon: "Moon", stats: { atk: 8, spd: 2, crit: 4 } }, { id: "ICE", name: "\u6C37", color: "from-cyan-200 to-blue-400 text-blue-900", glow: "shadow-cyan-400/50", icon: "Snowflake", stats: { atk: 4, spd: 4, crit: 2 } }, { id: "EARTH", name: "\u571F", color: "from-yellow-700 to-amber-900", glow: "shadow-amber-900/50", icon: "Mountain", stats: { atk: 6, spd: 2, crit: 1 } }, { id: "TOXIC", name: "\u6BD2", color: "from-lime-400 to-purple-600", glow: "shadow-lime-500/50", icon: "Skull", stats: { atk: 3, spd: 3, crit: 5 } }, { id: "GRAVITY", name: "\u91CD", color: "from-indigo-900 to-black", glow: "shadow-indigo-500/50", icon: "Orbit", stats: { atk: 10, spd: 1, crit: 2 } }, { id: "SOUL", name: "\u9B42", color: "from-teal-300 to-emerald-500", glow: "shadow-teal-400/50", icon: "Ghost", stats: { atk: 5, spd: 5, crit: 5 } }, { id: "METAL", name: "\u91D1", color: "from-slate-300 to-slate-500 text-slate-900", glow: "shadow-slate-400/50", icon: "Shield", stats: { atk: 7, spd: 2, crit: 2 } }, { id: "BLOOD", name: "\u8840", color: "from-red-600 to-red-900", glow: "shadow-red-700/50", icon: "HeartPulse", stats: { atk: 8, spd: 5, crit: 6 } }, { id: "TIME", name: "\u6642", color: "from-amber-200 to-yellow-500", glow: "shadow-yellow-500/50", icon: "Hourglass", stats: { atk: 2, spd: 12, crit: 3 } }, { id: "SPACE", name: "\u7A7A", color: "from-indigo-900 to-purple-900", glow: "shadow-purple-700/50", icon: "Rocket", stats: { atk: 12, spd: 3, crit: 8 } }, { id: "NATURE", name: "\u68EE", color: "from-green-500 to-emerald-800", glow: "shadow-green-600/50", icon: "Leaf", stats: { atk: 4, spd: 9, crit: 2 } }, { id: "STORM", name: "\u5D50", color: "from-slate-400 to-blue-900", glow: "shadow-blue-900/50", icon: "CloudLightning", stats: { atk: 8, spd: 8, crit: 4 } }, { id: "STAR", name: "\u661F", color: "from-yellow-100 to-white text-yellow-900", glow: "shadow-white/50", icon: "Star", stats: { atk: 10, spd: 10, crit: 10 } }, { id: "HOLY", name: "\u8056", color: "from-pink-100 to-white text-pink-900", glow: "shadow-pink-300/50", icon: "Sparkles", stats: { atk: 15, spd: 5, crit: 5 } }, { id: "CHAOS", name: "\u6DF7", color: "from-fuchsia-900 to-black", glow: "shadow-fuchsia-900/50", icon: "Dna", stats: { atk: 20, spd: 15, crit: 15 } }, { id: "MAGMA", name: "\u6EB6", color: "from-orange-600 to-red-900", glow: "shadow-red-600/50", icon: "Flame", stats: { atk: 12, spd: 2, crit: 3 } }, { id: "STEAM", name: "\u84B8", color: "from-slate-200 to-blue-300 text-slate-900", glow: "shadow-blue-300/50", icon: "Cloud", stats: { atk: 5, spd: 7, crit: 2 } }, { id: "PLASMA", name: "\u96FB", color: "from-purple-400 to-blue-600", glow: "shadow-blue-500/50", icon: "Zap", stats: { atk: 14, spd: 6, crit: 4 } }, { id: "QUAKE", name: "\u9707", color: "from-stone-600 to-black", glow: "shadow-stone-700/50", icon: "Mountain", stats: { atk: 18, spd: 1, crit: 2 } }, { id: "ZERO", name: "\u96F6", color: "from-white to-sky-100 text-sky-900", glow: "shadow-white/70", icon: "Thermometer", stats: { atk: 12, spd: 4, crit: 8 } }, { id: "AURA", name: "\u6C17", color: "from-emerald-300 to-teal-500 text-emerald-950", glow: "shadow-teal-400/50", icon: "Waves", stats: { atk: 6, spd: 12, crit: 3 } }, { id: "MIRROR", name: "\u93E1", color: "from-gray-100 to-gray-400 text-gray-900", glow: "shadow-gray-300/50", icon: "Layers", stats: { atk: 8, spd: 8, crit: 8 } }, { id: "ECHO", name: "\u53CD", color: "from-indigo-300 to-indigo-600", glow: "shadow-indigo-500/50", icon: "Volume2", stats: { atk: 4, spd: 18, crit: 2 } }, { id: "ABYSS", name: "\u6DF5", color: "from-black to-purple-950", glow: "shadow-purple-950/50", icon: "Moon", stats: { atk: 25, spd: 1, crit: 5 } }, { id: "ZENITH", name: "\u9802", color: "from-yellow-400 to-orange-500 text-white", glow: "shadow-orange-400/50", icon: "Sunrise", stats: { atk: 18, spd: 5, crit: 10 } }, { id: "PULSE", name: "\u8108", color: "from-lime-400 to-green-600", glow: "shadow-lime-500/50", icon: "Activity", stats: { atk: 5, spd: 22, crit: 3 } }, { id: "DRAGON", name: "\u9F8D", color: "from-red-700 to-amber-600", glow: "shadow-red-800/50", icon: "Crown", stats: { atk: 22, spd: 8, crit: 8 } }, { id: "FEATHER", name: "\u7FBD", color: "from-cyan-100 to-white text-cyan-900", glow: "shadow-cyan-100/50", icon: "Feather", stats: { atk: 3, spd: 25, crit: 2 } }, { id: "PETAL", name: "\u82B1", color: "from-pink-300 to-rose-500", glow: "shadow-rose-400/50", icon: "Flower", stats: { atk: 6, spd: 15, crit: 5 } }, { id: "BONE", name: "\u9AA8", color: "from-slate-100 to-slate-300 text-slate-900", glow: "shadow-slate-300/50", icon: "Bone", stats: { atk: 12, spd: 4, crit: 12 } }, { id: "GEAR", name: "\u6B6F", color: "from-orange-800 to-stone-900 text-orange-200", glow: "shadow-orange-900/50", icon: "Settings", stats: { atk: 10, spd: 12, crit: 4 } }, { id: "NEON", name: "\u96FB", color: "from-fuchsia-500 to-cyan-500", glow: "shadow-fuchsia-500/50", icon: "Tv", stats: { atk: 15, spd: 15, crit: 15 } }, { id: "PIXEL", name: "\u753B", color: "from-yellow-400 via-red-500 to-blue-500 text-white", glow: "shadow-yellow-400/50", icon: "Box", stats: { atk: 10, spd: 10, crit: 10 } }, { id: "VIRUS", name: "\u611F", color: "from-purple-600 via-green-600 to-black", glow: "shadow-green-600/50", icon: "Bug", stats: { atk: 8, spd: 30, crit: 5 } }, { id: "CORE", name: "\u6838", color: "from-white via-red-500 to-black text-white", glow: "shadow-red-600/50", icon: "Target", stats: { atk: 50, spd: 1, crit: 1 } }], feverTriggerCombo: 30, feverMultiplier: 3, upgrades: [{ id: "apprentice", name: "\u30C9\u30B8\u3063\u5B50\u898B\u7FD2\u3044", description: "1\u79D2\u3054\u3068\u306B\u9B54\u529B\u3092\u62FE\u3063\u3066\u304F\u308B", lore: "\u30AD\u30FC\u30DC\u30FC\u30C9\u306E\u300CA\u300D\u3068\u300CS\u300D\u3057\u304B\u62BC\u305B\u306A\u3044\u6B8B\u5FF5\u306A\u5B50\u3002\u3088\u304F\u8EE2\u3093\u3067\u30B3\u30F3\u30BB\u30F3\u30C8\u3092\u629C\u3044\u3066\u3057\u307E\u3046\u3002\u597D\u7269\u306F\u30B3\u30FC\u30E9\u3002", baseIncome: 1, baseCost: 50, costMultiplier: 1.15, icon: "Cpu", image: "/assets/apprentice_icon.png" }, { id: "pot", name: "\u8B0E\u306E\u3084\u304B\u3093", description: "\u6CB8\u9A30\u3057\u305F\u9B54\u529B\u3092\u6CE8\u3044\u3067\u304F\u308B", lore: "\u305F\u3060\u306E\u3084\u304B\u3093\u306B\u898B\u3048\u308B\u304C\u3001\u4E2D\u8EAB\u306F\u7121\u9650\u306E\u30AB\u30C3\u30D7\u9EBA\u30B9\u30FC\u30D7\u3089\u3057\u3044\u3002\u591C\u4E2D\u306B\u52DD\u624B\u306B\u6CB8\u304F\u97F3\u304C\u3059\u308B\u3002", baseIncome: 5, baseCost: 250, costMultiplier: 1.2, icon: "Bot", image: "/assets/upgrades/pot.png" }, { id: "array", name: "\u5730\u4E0B\u306E\u30D2\u30DF\u30C4\u57FA\u5730", description: "\u5730\u9762\u304B\u3089\u8B0E\u30D1\u30EF\u30FC\u3092\u96C6\u3081\u308B", lore: "\u56E3\u5730\u306E\u5730\u4E0B\u306B\u52DD\u624B\u306B\u4F5C\u3063\u305F\u79D8\u5BC6\u57FA\u5730\u3002\u30DE\u30F3\u30AC\u672C\u304C3000\u518A\u7F6E\u3044\u3066\u3042\u308B\u3002\u305F\u307E\u306B\u304A\u6BCD\u3055\u3093\u306B\u6012\u3089\u308C\u308B\u3002", baseIncome: 25, baseCost: 1e3, costMultiplier: 1.25, icon: "Zap", image: "/assets/upgrades/base.png" }, { id: "homunculus", name: "\u30D5\u30E9\u30B9\u30B3\u4EBA\u9593", description: "\u4E3B\u306B\u4EE3\u308F\u3063\u3066\u5BBF\u984C\u3092\u3084\u3063\u3066\u304F\u308C\u308B", lore: "\u7406\u79D1\u306E\u5B9F\u9A13\u3067\u751F\u307E\u308C\u305F\u7DD1\u8272\u306E\u30B9\u30E9\u30A4\u30E0\u4EBA\u9593\u3002\u300C\u30DC\u30AF\u30CF\u3001\u30EF\u30EB\u30E1\u30CA\u30E9\u3001\u30CA\u30A4\u300D\u3068\u7247\u8A00\u3067\u558B\u308B\u3002\u610F\u5916\u3068\u3044\u3044\u3084\u3064\u3002", baseIncome: 120, baseCost: 5500, costMultiplier: 1.3, icon: "Server", image: "/assets/homunculus_icon.png" }, { id: "philosopher", name: "\u30D4\u30AB\u30D4\u30AB\u306E\u77F3", description: "\u6301\u3063\u3066\u3044\u308B\u3060\u3051\u3067\u306A\u3093\u304B\u30B9\u30B4\u30A4", lore: "\u5DDD\u539F\u3067\u62FE\u3063\u305F\u5909\u306A\u77F3\u3002\u6CB9\u6027\u30DA\u30F3\u3067\u9854\u304C\u63CF\u3044\u3066\u3042\u308B\u3002\u6697\u95C7\u3067\u5149\u308B\u306E\u3067\u3001\u30C8\u30A4\u30EC\u306B\u884C\u304F\u3068\u304D\u306B\u4FBF\u5229\u3002", baseIncome: 500, baseCost: 25e3, costMultiplier: 1.4, icon: "Brain", image: "/assets/upgrades/stone.png" }], loreLogs: [{ id: "log-001", title: "\u30D2\u30DF\u30C4\u65E5\u8A18\uFF1A\u305D\u306E\uFF11", content: "\u4ECA\u65E5\u306F\u5909\u306A\u30C9\u30E9\u30B4\u30F3\u3092\u62FE\u3063\u305F\u3002\u30D1\u30BD\u30B3\u30F3\u306E\u753B\u9762\u304B\u3089\u51FA\u3066\u304D\u3066\u3001\u30AA\u30EC\u306E\u30DD\u30C6\u30C1\u3092\u52DD\u624B\u306B\u98DF\u3079\u305F\uFF01\u8A31\u3055\u3093\uFF01\u3067\u3082\u3001\u30AD\u30FC\u30DC\u30FC\u30C9\u3092\u53E9\u304F\u3068\u559C\u3076\u307F\u305F\u3044\u3060\u3002", unlockThreshold: 1e3 }, { id: "log-002", title: "\u6575\u306E\u6B63\u4F53", content: "\u6575\u306E\u300C\u30D0\u30B0\u8ECD\u56E3\u300D\u306F\u3001\u5B9F\u306F\u66F8\u304D\u304B\u3051\u306E\u5BBF\u984C\u3084\u3001\u30C6\u30B9\u30C8\u306E0\u70B9\u306E\u7B54\u6848\u304C\u30E2\u30F3\u30B9\u30BF\u30FC\u306B\u306A\u3063\u305F\u59FF\u3089\u3057\u3044\u3002\u3060\u304B\u3089\u5012\u3059\u3068\u30B9\u30C3\u30AD\u30EA\u3059\u308B\u306E\u304B\uFF01", unlockThreshold: 5e3 }, { id: "log-003", title: "\u30C9\u30E9\u30B4\u30F3\u306E\u9032\u5316", content: "\u3053\u3044\u3064\u3001\u3060\u3093\u3060\u3093\u5927\u304D\u304F\u306A\u3063\u3066\u304D\u305F\u3002\u6628\u65E5\u306F\u30AD\u30FC\u30DC\u30FC\u30C9\u306E\u4E0A\u3067\u5BDD\u3066\u305F\u306E\u306B\u3001\u4ECA\u65E5\u306F\u51B7\u8535\u5EAB\u3092\u958B\u3051\u3066\u725B\u4E73\u3092\u98F2\u3093\u3067\u305F\u3002\u6700\u7D42\u7684\u306B\u3069\u3046\u306A\u3063\u3061\u3083\u3046\u306E\uFF01\uFF1F", unlockThreshold: 2e4 }], worlds: [{ id: "GENESIS", name: "\u59CB\u307E\u308A\u306E\u8349\u539F", description: "\u65C5\u306E\u59CB\u307E\u308A\u3060\u3002\u307E\u305A\u306F\u3053\u3053\u3092\u5236\u8987\u305B\u3088\u3002", theme: "Nature/Green", hpScale: 1, rewardScale: 1, mechanic: "NORMAL", bg: "/assets/worlds/genesis.png" }, { id: "CYBERIA", name: "\u9B54\u529B\u306E\u7802\u6F20", description: "\u9B54\u529B\u304C\u6E26\u5DFB\u304F\u4E7E\u71E5\u5730\u5E2F\u3002\u30D0\u30EA\u30A2\u3092\u6301\u3064\u6575\u304C\u7ACB\u3061\u3075\u3055\u304C\u308B\u3060\u308D\u3046\u3002", theme: "Desert/Sand", hpScale: 2.5, rewardScale: 2, mechanic: "BARRIER", bg: "/assets/worlds/cyberia.png" }, { id: "ETERNITY", name: "\u5929\u7A7A\u306E\u9B54\u5BAE", description: "\u96F2\u306E\u4E0A\u306B\u305D\u3073\u3048\u7ACB\u3064\u5BAE\u6BBF\u3002\u91CD\u529B\u304C\u541B\u306E\u9B54\u529B\u3092\u8A66\u3059\u306F\u305A\u3060\u3002", theme: "Sky/Ancient", hpScale: 6, rewardScale: 4, mechanic: "GRAVITY", bg: "/assets/worlds/eternity.png" }, { id: "LEGEND", name: "\u4F1D\u8AAC\u306E\u8056\u6226", description: "\u8A9E\u308A\u7D99\u304C\u308C\u308B\u7A76\u6975\u306E\u6226\u5834\u3002\u899A\u609F\u3057\u3066\u6311\u3080\u304C\u826F\u3044\u3002", theme: "Holy/Epic", hpScale: 12, rewardScale: 10, mechanic: "LEGENDAY", bg: "/assets/worlds/legend.png" }] }, Jf = (o, p) => Math.floor(o.baseCost * Math.pow(o.costMultiplier, p)), Kf = [{ name: "\u9759\u304B\u306A\u307B\u3068\u308A", bg: "/assets/deep_web_arena_bg.png", element: "WATER", prefix: "River" }, { name: "\u3055\u3055\u3084\u304D\u306E\u68EE", bg: "/assets/snack_world_battle_bg.png", element: "WIND", prefix: "Forest" }, { name: "\u71C3\u3048\u308B\u6D1E\u7A9F", bg: "/assets/deep_web_arena_bg.png", element: "FIRE", prefix: "Cave" }, { name: "\u3044\u306B\u3057\u3048\u306E\u907A\u8DE1", bg: "/assets/deep_web_arena_bg.png", element: "EARTH", prefix: "Ruin" }, { name: "\u88C1\u304D\u306E\u96F7", bg: "/assets/deep_web_arena_bg.png", element: "THUNDER", prefix: "Thunder" }, { name: "\u5F71\u306E\u8C37", bg: "/assets/deep_web_arena_bg.png", element: "DARK", prefix: "Shadow" }], $f = ["\u30B9\u30E9\u30A4\u30E0", "\u30B4\u30D6\u30EA\u30F3", "\u30AA\u30FC\u30AF", "\u30B9\u30B1\u30EB\u30C8\u30F3", "\u30A6\u30EB\u30D5", "\u30B3\u30A6\u30E2\u30EA", "\u30B4\u30FC\u30EC\u30E0", "\u6B7B\u795E", "\u30AD\u30DE\u30A4\u30E9", "\u30C9\u30E9\u30B4\u30F3"], Wf = ["/assets/custom_units/magi_unit_192221.png", "/assets/custom_units/magi_unit_213515.png", "/assets/custom_units/magi_unit_213510.png", "/assets/custom_units/magi_unit_190839.png", "/assets/custom_units/magi_unit_190851.png"], cc = (o, p) => {
  ...
  for (let g = 1; g <= p; g++) {
    ...
    for (let R = 1; R <= 10; R++) {
      const C = R === 10, z = `${r.name} ${g}-${R} ${N.name}`, v = C ? `\u3010\u30DC\u30B9\u3011 ${N.prefix} \u30ED\u30FC\u30C9` : $f[Math.floor(Math.random() * $f.length)];
      h.push({ chapter: g, stage: R, name: z, enemy: v, element: N.element, bg: r.bg || N.bg, image: Wf[(g + R) % Wf.length], isBoss: C });
    }
  }
  return h;
};
...
const uc = (o, p = ["FIRE", "WATER"]) => {
  ...
  const [g, N] = w.useState(0), [R, C] = w.useState(""), [z, v] = w.useState(false), [U, A] = w.useState([]);
  w.useEffect(() => {
    const X = setInterval(() => {
      N((pe) => (pe + 1) % 4);
    }, 200);
...
}, If = { FIRE: Di, WATER: Yo, THUNDER: oa, WIND: tr, LIGHT: Wo, DARK: rc, ICE: Ko, EARTH: dc, TOXIC: gc, GRAVITY: Vo, SOUL: hc, METAL: Hi, BLOOD: qo, TIME: Xo, SPACE: Jo, NATURE: Qo, STORM: Do, STAR: $o, HOLY: Lt, CHAOS: Bo, MAGMA: Di, STEAM: Uo, PLASMA: oa, QUAKE: dc, ZERO: Fo, AURA: er, MIRROR: Zo, ECHO: bc, ABYSS: rc, ZENITH: Io, PULSE: Ro, DRAGON: Ho, FEATHER: Lo, PETAL: Go, BONE: Oo, GEAR: xc, NEON: Po, PIXEL: Co, VIRUS: mc, CORE: Jl }, Ff = (o) => {
...
}, Sx = ({ currentSpell: o, currentProgress: p, monsterHealth: h = 0, monsterMaxHealth: r = 100, combo: g, isFever: N, dragonLevel: R = 1, chantBreakGauge: C = 0, isSpellComplete: z = false, monsterElement: v = "FIRE", bossName: U = null, stageData: A = {}, stageIndex: $ = 1, lastDamage: J = 0, familiarDialogue: Z = "", isVictorious: ae = false, keyMapping: X = [], equippedElements: pe = [] }) => {
  var _a;
  ...
  const le = w.useMemo(() => A.image || "/assets/glitch_phantom.jpg", [A]), Le = w.useMemo(() => r > 0 ? h / r * 100 : 0, [h, r]), ot = w.useMemo(() => s.jsxs("div", { className: `
        ...
        `, children: [s.jsx("img", { src: le, alt: "Monster", className: `w-full h-full object-cover rounded-full border-4 ${A.isBoss ? "border-red-600 shadow-[0_0_50px_rgba(255,0,0,0.8)]" : "border-neon-purple shadow-[0_0_30px_rgba(168,85,247,0.6)]"}` }), A.isBoss && s.jsx("div", { className: "absolute -top-4 -right-4 bg-red-600 text-white font-black px-2 py-1 rounded text-xs animate-pulse", children: "WARNING" }), s.jsx("div", { className: "absolute inset-0 rounded-full bg-gradient-to-t from-black/40 to-transparent pointer-events-none" }), fe.map((Ne) => s.jsx("div", { className: "absolute inset-0 flex items-center justify-center pointer-events-none", style: { transform: `translate(${Ne.x}px, ${Ne.y}px)` }, children: s.jsx("span", { className: "text-4xl font-black text-white italic drop-shadow-[0_0_10px_rgba(255,255,255,0.8)] animate-float-up", children: Math.floor(Ne.damage) }) }, Ne.id))] }), [le, A.isBoss, fe, z, ke, ae]);
  return s.jsxs("div", { className: `
      relative w-full h-full flex flex-col items-center justify-between p-4 overflow-hidden
      ${N ? "animate-fever-bg" : ""}
      ${se}
      transition-colors duration-500
    `, children: [s.jsx("div", { className: "absolute inset-0 z-0 opacity-40 mix-blend-overlay bg-center bg-cover pointer-events-none transition-all duration-1000", style: { backgroundImage: `url(${A.bg || "/assets/deep_web_arena_bg.png"})` } }), s.jsx("div", { className: "absolute inset-0 z-0 bg-gradient-to-t from-black via-transparent to-black pointer-events-none" }), s.jsxs("div", { className: "flex-1 flex flex-col items-center justify-center relative z-10 w-full", children: [s.jsx("div", { className: "absolute top-4 w-full flex items-center justify-between px-6", children: s.jsxs("div", { className: "flex flex-col", children: [s.jsxs("span", { className: "text-[8px] md:text-[10px] font-black text-neon-cyan tracking-widest uppercase", children: ["STAGE : ", String($).padStart(2, "0")] }), s.jsx("div", { className: "flex items-center gap-2", children: s.jsx("span", { className: "text-xl md:text-2xl font-black text-white italic tracking-tighter drop-shadow-lg", children: U || A.name || "\u6DF1\u6DF5\u306E\u30C7\u30B8\u30BF\u30EB\u30B0\u30EA\u30C3\u30C1" }) })] }) }), s.jsx("div", { className: "absolute bottom-1/4 left-10 transform scale-150", children: s.jsx(cm, { level: R, isAttacking: z, dialogue: Z }) }), s.jsxs("div", { className: `
                  relative p-4 transform transition-transform duration-300
                  ${N ? "animate-pulse" : ""}
                  ${z ? "scale-90" : "scale-100"}
                `, children: [ot, s.jsx("div", { className: "absolute -bottom-10 left-1/2 -translate-x-1/2 w-48 max-w-md space-y-2", children: s.jsxs("div", { className: "h-6 w-full bg-black/40 rounded-full border border-white/10 overflow-hidden relative shadow-inner", children: [s.jsx("div", { className: "h-full bg-gradient-to-r from-red-600 to-red-400 transition-all duration-300 relative", style: { width: `${Le}%` }, children: s.jsx("div", { className: "absolute inset-0 bg-white/20 animate-pulse" }) }), s.jsx("div", { className: "absolute inset-0 flex items-center justify-center pointer-events-none", children: s.jsxs("span", { className: "text-[10px] font-black text-white drop-shadow-[0_1px_2px_rgba(0,0,0,0.8)] tracking-widest uppercase", children: [Ff(h), " / ", Ff(r), " HP"] }) })] }) }), s.jsxs("div", { className: "absolute top-0 right-0 z-20 transform translate-x-1/2 -translate-y-1/2 flex flex-col items-center gap-1 group", children: [s.jsx("div", { className: `
                            ...
                            animate-bounce
                        `, children: (() => {
    const Ne = ye.attributes.find((Pe) => Pe.id === v), Ee = If[Ne == null ? void 0 : Ne.id] || Di;
...
}, wx = { Flame: Di, Droplets: Yo, Zap: oa, Wind: tr, Sun: Wo, Moon: rc, Snowflake: Ko, Mountain: dc, Skull: gc, Orbit: Vo, Ghost: hc, Shield: Hi, HeartPulse: qo, Hourglass: Xo, Rocket: Jo, Leaf: Qo, CloudLightning: Do, Star: $o, Sparkles: Lt, Dna: Bo, Cloud: Uo, Thermometer: Fo, Waves: er, Layers: Zo, Volume2: bc, Sunrise: Io, Activity: Ro, Crown: Ho, Feather: Lo, Flower: Go, Bone: Oo, Settings: xc, Tv: Po, Box: Co, Bug: mc, Target: Jl }, jx = ({ onInput: o, disabled: p, activeElements: h = [], keyMapping: r = [] }) => {
  ...
  return s.jsx("div", { "data-tutorial-id": "magic-keyboard", className: "grid grid-cols-3 gap-3 w-full max-w-sm mx-auto p-4 select-none pb-12", "data-tutorial-target": "magic-keyboard", children: ye.attributes.map((N) => {
    ...
    return s.jsxs("button", { onClick: () => g(N.id), disabled: p, "data-tutorial-id": "magic-button", "data-tutorial-target": `magic-button-${N.id}`, className: `
                            ...
                            touch-none
                        `, children: [s.jsx("div", { className: "w-12 h-12 rounded-xl bg-black/20 flex items-center justify-center border-2 border-white/20", children: s.jsx(R, { size: 28, strokeWidth: 3 }) }), s.jsxs("div", { className: "flex flex-col items-start translate-y-[-1px]", children: [s.jsxs("span", { className: "font-black text-[10px] uppercase tracking-widest opacity-60", children: ["CAST [", (_a = r[h.indexOf(N.id)]) == null ? void 0 : _a.toUpperCase(), "]"] }), s.jsx("span", { className: "font-black text-xl italic tracking-tighter", children: N.name })] }), s.jsx("div", { className: "absolute bottom-2 right-4 flex gap-1 opacity-40", children: [...Array(Math.floor(N.stats.atk / 2))].map((C, z) => s.jsx("div", { className: "w-1 h-3 bg-white/60 rounded-full" }, z)) }), s.jsx("div", { className: "absolute top-0 right-0 w-8 h-8 bg-white/20 rounded-bl-[100%] pointer-events-none" })] }, N.id);
  }) });
}, Ax = ({ money: o, idleIncome: p }) => {
  const h = w.useRef(o), [r, g] = w.useState(false), [N, R] = w.useState(false);
  w.useEffect(() => {
    const z = h.current;
    ye.moneyMilestones.find((A) => z < A && o >= A) && setTimeout(() => {
...
const lt = new Mx(), zx = ({ onComplete: o }) => {
...
\u8EE2\u751F\uFF08\u30EA\u30D0\u30FC\u30B9\u30C8\uFF09\u3067\u5F97\u308B\u300C\u9B42\u306E\u6B20\u7247\u300D\u3067\u3001\u3053\u308C\u3092\u9855\u73FE\u3055\u305B\u3088\u3002`, target: "artifact-btn", position: "center", action: "auto" }] }, kx = ({ type: o = "INTRO", onComplete: p, onSkip: h, currentSpell: r, currentProgress: g }) => {
  const [N, R] = w.useState(o === "INTRO"), [C, z] = w.useState(0), [v, U] = w.useState(false), A = w.useMemo(() => Pf[o] || Pf.INTRO, [o]), $ = w.useMemo(() => {
...
\u79C1\u304C\u5C0E\u3044\u3066\u3084\u308D\u3046\u3001\u6E96\u5099\u306F\u3088\u3044\u304B\uFF1F` }), s.jsxs("div", { className: "space-y-3", children: [s.jsx("button", { onClick: X, className: "w-full py-4 rounded-xl font-black text-xl italic bg-white text-black hover:scale-[1.02] active:scale-95 transition-all shadow-[0_4px_0_#ccc]", children: "\u30AC\u30A4\u30C9\u3092\u898B\u308B" }), s.jsx("button", { onClick: pe, className: "w-full py-3 rounded-xl font-bold text-xs text-white/30 hover:text-white transition-colors", children: "\u9589\u3058\u308B" })] })] })] });
  ...
  const [r, g] = w.useState(null), [N, R] = w.useState([]), C = w.useRef({}), z = w.useRef([]);
  w.useEffect(() => () => {
  ...
  const v = (A) => {
    ...
    if (o >= J) {
      ...
      if (Z) {
        ...
        R((fe) => [...fe.slice(-36), ...ke]);
        const xe = setTimeout(() => {
          g(null), R((fe) => fe.filter((he) => !ke.find((se) => se.id === he.id))), z.current = z.current.filter((fe) => fe !== xe);
        }, 800);
        z.current.push(xe);
      }
    }
...
}) }), s.jsx("div", { className: "p-6 text-center text-[10px] text-white/20 font-bold uppercase tracking-[0.2em] border-t border-white/5", children: "\u53E4\u306E\u9B54\u9053\u3002\u305D\u306E\u5230\u9054\u8005\u3002" })] }) }), kn = { UR: 0.05, SR: 0.15, R: 0.3 }, To = 500, Lx = { cost: To }, Gx = (o) => {
  if (o < To) return { success: false, error: "MP\u304C\u8DB3\u308A\u307E\u305B\u3093\uFF01" };
  const p = Math.random();
  let h = "N";
  p < kn.UR ? h = "UR" : p < kn.UR + kn.SR ? h = "SR" : p < kn.UR + kn.SR + kn.R && (h = "R");
  const r = fc.filter((N) => N.rarity === h);
  return { success: true, unit: r[Math.floor(Math.random() * r.length)], cost: To };
}, qx = ({ money: o, onPullGacha: p, onSpentMoney: h }) => {
  const [r, g] = w.useState(false), [N, R] = w.useState(null), [C, z] = w.useState(null), v = () => {
    if (r) return;
    z(null), R(null);
    const A = Gx(o);
    if (!A.success) {
...
let Ft;
function Ix(o, p, h, r, g, N) {
  return Ft.calculate_damage(o, p, h, r, g, N);
}
function tm(o, p) {
  return Ft.calculate_idle_income(o, p);
}
function Oi(o, p, h, r) {
  return Ft.calculate_monster_hp(o, p, h, r);
}
function zo(o, p, h) {
  return Ft.calculate_rebirth_orbs(o, p, h);
}
function Fx(o, p, h, r) {
  return Ft.calculate_reward(o, p, h, r);
}
function am(o, p, h) {
  return Ft.calculate_upgrade_cost(o, p, h);
}
...
function a2(o, p) {
  return Ft = o.exports, rm.__wbindgen_wasm_module = p, Ft.__wbindgen_start(), Ft;
}
async function rm(o) {
...
const l2 = ({ settings: o, onUpdate: p, onClose: h, onRebirth: r, canRebirth: g, nextRebirthOrbs: N, totalMoney: R, version: C = "v2.5.1" }) => {
  const [z, v] = w.useState(0), [U, A] = w.useState(false), [$, J] = w.useState(false), Z = () => {
    const ae = z + 1;
  ...
  return w.useEffect(() => {
    if (h) {
      ...
      const C = h.content, z = setInterval(() => {
        N(C.slice(0, R + 1)), R++, R >= C.length && clearInterval(z);
      }, 15);
  ...
  return s.jsxs("div", { className: `dragon-glass-card p-4 relative group ${z ? "border-yellow-400/50 bg-yellow-400/5" : "border-white/10 bg-white/5"}`, children: [s.jsxs("div", { className: "flex items-start justify-between mb-4", children: [s.jsx("div", { className: `p-3 rounded-xl bg-black/40 border border-white/10 ${g.color}`, children: s.jsx(v, { size: 24 }) }), s.jsxs("div", { className: "flex flex-col items-end", children: [s.jsx("span", { className: "text-[10px] uppercase font-black tracking-widest text-white/40", children: "\u9B54\u5C0E\u30EC\u30D9\u30EB" }), s.jsxs("span", { className: `text-2xl font-black ${z ? "text-yellow-400" : "text-white"}`, children: [N, s.jsxs("span", { className: "text-sm text-white/40", children: ["/", g.maxLevel] })] })] })] }), s.jsx("h3", { className: "text-lg font-black text-white italic mb-1", children: g.name }), s.jsx("p", { className: "text-xs font-bold text-white/60 mb-2 min-h-[2.5em]", children: g.description }), s.jsx("div", { className: "text-[10px] font-bold text-neon-cyan mb-4", children: g.effectDescription }), s.jsx("button", { onClick: () => h(g.id, R), disabled: !C || z, className: `
                                        ...
                                        `, children: z ? s.jsx("span", { children: "\u9650\u754C\u5230\u9054" }) : s.jsxs(s.Fragment, { children: [s.jsx("span", { children: "\u9B54\u529B\u6CE8\u5165" }), s.jsxs("div", { className: "px-2 py-0.5 bg-black/40 rounded-lg text-xs flex items-center gap-1", children: [s.jsx("span", { children: "\u{1F52E}" }), s.jsx("span", { children: R.toLocaleString() })] })] }) })] }, g.id);
}) }) })] }) }), c2 = { Flame: Di, Droplets: Yo, Zap: oa, Wind: tr, Sun: Wo, Moon: rc, Snowflake: Ko, Mountain: dc, Skull: gc, Orbit: Vo, Ghost: hc, Shield: Hi, HeartPulse: qo, Hourglass: Xo, Rocket: Jo, Leaf: Qo, CloudLightning: Do, Star: $o, Sparkles: Lt, Dna: Bo, Cloud: Uo, Thermometer: Fo, Waves: er, Layers: Zo, Volume2: bc, Sunrise: Io, Activity: Ro, Crown: Ho, Feather: Lo, Flower: Go, Bone: Oo, Settings: xc, Tv: Po, Box: Co, Bug: mc, Target: Jl }, u2 = ({ unlockedElements: o, equippedElements: p, onSave: h, onClose: r }) => {
  const [g, N] = w.useState([...p]), R = (v) => {
    let U;
    g.includes(v) ? g.length > 1 ? U = g.filter((A) => A !== v) : U = g : g.length < 6 ? U = [...g, v] : U = g, N(U);
  }, C = g.length === Math.min(o.length, 6), z = w.useMemo(() => ye.attributes.filter((v) => o.includes(v.id)), [o]);
  return s.jsx("div", { className: "fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-in fade-in duration-300", children: s.jsxs("div", { className: "bg-[#1a1a1a] w-full max-w-2xl rounded-[2.5rem] border border-white/10 shadow-2xl overflow-hidden flex flex-col max-h-[90vh]", children: [s.jsxs("div", { className: "p-8 flex items-center justify-between border-b border-white/5", children: [s.jsxs("div", { children: [s.jsx("h2", { className: "text-3xl font-black italic tracking-tighter text-white uppercase", children: "Magic Equipment" }), s.jsxs("p", { className: "text-white/40 text-sm font-bold tracking-widest uppercase", children: ["Select ", Math.min(o.length, 6), " Elements for Battle (", g.length, "/6)"] })] }), s.jsx("button", { onClick: r, className: "p-3 rounded-2xl bg-white/5 hover:bg-white/10 transition-all", children: s.jsx(Xa, { size: 24, className: "text-white/60" }) })] }), s.jsxs("div", { className: "flex-1 overflow-y-auto p-4 sm:p-8 custom-scrollbar bg-black/40", children: [s.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-5 gap-3", children: z.map((v) => {
  ...
  return s.jsxs("div", { onClick: () => R && h(g.id), className: `
                                ...
                                `, children: [s.jsxs("div", { className: "p-6 flex items-center gap-6 relative z-10", children: [s.jsxs("div", { className: `
                                    ...
                                    `, children: [g.id === "GENESIS" && s.jsx(op, { size: 32 }), g.id === "CYBERIA" && s.jsx(oa, { size: 32 }), g.id === "ETERNITY" && s.jsx(pp, { size: 32 }), g.id === "LEGEND" && s.jsx(Swords, { size: 32, className: "text-red-500" })] }), s.jsxs("div", { className: "flex-1", children: [s.jsxs("div", { className: "flex items-center gap-2 mb-1", children: [s.jsx("h3", { className: "text-xl font-black italic text-white uppercase tracking-tighter", children: g.name }), !R && s.jsx(pc, { size: 14, className: "text-white/40" }), g.id === "LEGEND" && s.jsx("span", { className: "bg-red-600 text-[8px] px-1.5 py-0.5 rounded font-black text-white animate-pulse", children: "HARD" })] }), s.jsx("p", { className: "text-xs font-bold text-white/40 uppercase tracking-widest mb-3", children: g.description }), s.jsxs("div", { className: "flex items-center gap-3", children: [s.jsx("div", { className: "flex-1 h-1.5 bg-black/40 rounded-full overflow-hidden", children: s.jsx("div", { className: `h-full transition-all duration-1000 ${C ? "bg-white" : "bg-white/40"}`, style: { width: `${v}%` } }) }), s.jsxs("span", { className: "text-[10px] font-black text-white/60 tracking-widest whitespace-nowrap", children: ["STAGE ", z + 1] })] })] }), s.jsx(Rn, { size: 24, className: `transition-transform group-hover:translate-x-1 ${C ? "text-white" : "text-white/20"}` })] }), s.jsx("div", { className: "absolute top-4 right-8 font-black text-4xl italic opacity-[0.03] select-none pointer-events-none group-hover:opacity-[0.05] transition-opacity", children: g.id })] }, g.id);
}) })] }) });
function r2() {
  var _a2;
  ...
  const [h, r] = w.useState(0), [g, N] = w.useState(0), [R, C] = w.useState(0), [z, v] = w.useState(0), [U, A] = w.useState("home"), [$, J] = w.useState(ye.upgrades.map((O) => ({ ...O, level: 0 }))), [Z, ae] = w.useState({ haptic: true, particle: true, music: 50, sfx: 50 }), [X, pe] = w.useState(["n_egg"]), [ke, xe] = w.useState({ n_egg: 1 }), [fe, he] = w.useState(0), [se, W] = w.useState([]), [le, Le] = w.useState([]), [ot, Ne] = w.useState(false), [Ee, Pe] = w.useState(false), [Xe, Se] = w.useState(false), [S, H] = w.useState(true), [Q, ve] = w.useState([]), [we, m] = w.useState(null), [k, B] = w.useState(false), [L, P] = w.useState(false);
  w.useEffect(() => {
  ...
  w.useEffect(() => {
    Rt > Fl.current && ($a(true), lt.playSFX("levelup"), ft("\u529B\u304C...\u9032\u5316\u3057\u305F\u305E\uFF01"), setTimeout(() => $a(false), 2e3), Fl.current = Rt);
  }, [Rt, ft]), w.useEffect(() => {
    if (!o) return;
  ...
  const Al = w.useMemo(() => {
    ...
    if (zo(g, 1e6, 1e6) >= 10 && U === "home") return { text: "\u79D8\u3081\u305F\u308B\u9B42\u3092\u89E3\u653E\u3057\u3001\u65B0\u305F\u306A\u9AD8\u307F\u3078\u8EE2\u751F\u305B\u3088\u3002", type: "REBIRTH", actionId: "rebirth-button" };
    ...
    if (Math.random() < 0.02 && !L && (P(true), ft("\u30EA\u30DF\u30C3\u30C8\u30D6\u30EC\u30A4\u30AB\u30FC\u59CB\u52D5...\u30AF\u30EA\u30C6\u30A3\u30AB\u30EB\u30FB\u30CF\u30C3\u30AF\uFF01")), O === Gt[rt]) {
      ...
      if (va || Hn((Xt) => {
        ...
        const Nc = ye.worlds.find((tt) => tt.id === St), Ml = Fx(ye.baseTypingReward * Nc.rewardScale, R, ye.comboMultiplier, yt);
        r((tt) => tt + Ml), N((tt) => {
          const vt = tt + Ml;
          return Bn(Math.floor(vt / 1e3) + 1), vt;
        }), C((tt) => {
          const vt = tt + 1;
          return vt > z && v(vt), vt % 10 === 0 && ft(`${vt} \u30B3\u30F3\u30DC\uFF01\u5B9F\u306B\u898B\u4E8B\u3060\u3002`), vt;
        }), Qa((tt) => {
          const vt = Ix(20, ea.attack, et, Be, ta.damageMult, yt);
          Qi(vt), lt.playSFX("hit");
          let zl = vt;
          St === "ETERNITY" && (zl *= 0.5), St === "LEGEND" && (zl *= 0.3);
          const Sa = tt - zl;
          return Sa <= 0 && !_l ? (Li(true), lt.playSFX("defeat"), setTimeout(() => {
            ...
            if (Qn) {
              ...
              Tl = Ea.health * (1 + ma * 0.1), ja = Ea.name, ft(`\u8B66\u544A: ${Ea.name} \u304C\u51FA\u73FE\uFF01`);
            } else {
              const _t = ye.worlds.find((Aa) => Aa.id === St);
              Tl = Oi(100 * _t.hpScale, 1.8, ma, false), ja = null;
            }
            yc(ja), ra(Tl), Qa(Tl), Li(false);
          }, 1200), 0) : Sa;
  ...
  }, [Gt, rt, R, z, va, ea, ta, Ln, Z.haptic, le, ft, it, st, qt, St, _l]), la = w.useMemo(() => ["q", "w", "e", "r", "t", "y"], []);
  w.useEffect(() => {
    const O = (D) => {
  ...
  const Pl = w.useCallback(() => {
    const O = zo(g, 1e6, 1e6);
    if (O > 0) {
      he((I) => I + O), r(0), N(0), C(0), v(0), Le([]), Bn(1);
      const D = Oi(100, 1.8, 0, false);
      ra(D), Qa(D), Va("FIRE"), Gn(0), Nl(0), _a(["FIRE", "WATER"]), Ka(["FIRE", "WATER"]), J(ye.upgrades.map((I) => ({ ...I, level: 0 }))), A("home");
    }
