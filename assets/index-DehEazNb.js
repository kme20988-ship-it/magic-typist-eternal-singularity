(function() {
  ...
  new MutationObserver((g) => {
    for (const v of g) if (v.type === "childList") for (const M of v.addedNodes) M.tagName === "LINK" && M.rel === "modulepreload" && o(M);
...
function hh() {
  ...
  function h(o, g, v) {
    var M = null;
    if (v !== void 0 && (M = "" + v), g.key !== void 0 && (M = "" + g.key), "key" in g) {
      v = {};
      for (var C in g) C !== "key" && (v[C] = g[C]);
    } else v = g;
    return g = v.ref, { $$typeof: r, type: o, key: M, ref: g !== void 0 ? g : null, props: v };
  }
  return ki.Fragment = p, ki.jsx = h, ki.jsxs = h, ki;
}
var Df;
function ph() {
...
function xh() {
  if (Uf) return te;
  Uf = 1;
  var r = /* @__PURE__ */ Symbol.for("react.transitional.element"), p = /* @__PURE__ */ Symbol.for("react.portal"), h = /* @__PURE__ */ Symbol.for("react.fragment"), o = /* @__PURE__ */ Symbol.for("react.strict_mode"), g = /* @__PURE__ */ Symbol.for("react.profiler"), v = /* @__PURE__ */ Symbol.for("react.consumer"), M = /* @__PURE__ */ Symbol.for("react.context"), C = /* @__PURE__ */ Symbol.for("react.forward_ref"), z = /* @__PURE__ */ Symbol.for("react.suspense"), _ = /* @__PURE__ */ Symbol.for("react.memo"), U = /* @__PURE__ */ Symbol.for("react.lazy"), j = /* @__PURE__ */ Symbol.for("react.activity"), $ = Symbol.iterator;
  function J(m) {
  ...
  function pe(m, R, B) {
    this.props = m, this.context = R, this.refs = X, this.updater = B || Z;
  }
  pe.prototype.isReactComponent = {}, pe.prototype.setState = function(m, R) {
  ...
  function Le(m, R, B) {
    var L = B.ref;
    return { $$typeof: r, type: m, key: R, ref: L !== void 0 ? L : null, props: B };
  }
  function ot(m, R) {
    return Le(m.type, R, m.props);
  }
  function Ne(m) {
  ...
  var Pe = /\/+/g;
  function Xe(m, R) {
    return typeof m == "object" && m !== null && m.key != null ? Ee("" + m.key) : R.toString(36);
  }
  function Se(m) {
    switch (m.status) {
      case "fulfilled":
      ...
      case "rejected":
        throw m.reason;
      default:
        switch (typeof m.status == "string" ? m.then(se, se) : (m.status = "pending", m.then(function(R) {
          m.status === "pending" && (m.status = "fulfilled", m.value = R);
        }, function(R) {
          m.status === "pending" && (m.status = "rejected", m.reason = R);
        })), m.status) {
          case "fulfilled":
            return m.value;
          case "rejected":
      ...
      case "object":
        switch (m.$$typeof) {
          ...
          case p:
            ...
            break;
          case U:
            return ce = m._init, S(ce(m._payload), R, B, L, P);
        }
    }
    if (ce) return P = P(m), ce = L === "" ? "." + Xe(m, 0) : L, he(P) ? (B = "", ce != null && (B = ce.replace(Pe, "$&/") + "/"), S(P, R, B, "", function(bl) {
      return bl;
    })) : P != null && (Ne(P) && (P = ot(P, B + (P.key == null || m && m.key === P.key ? "" : ("" + P.key).replace(Pe, "$&/") + "/") + ce)), R.push(P)), 1;
    ce = 0;
    var Ze = L === "" ? "." : L + ":";
    if (he(m)) for (var De = 0; De < m.length; De++) L = m[De], ee = Ze + Xe(L, De), ce += S(L, R, B, ee, P);
    else if (De = J(m), typeof De == "function") for (m = De.call(m), De = 0; !(L = m.next()).done; ) L = L.value, ee = Ze + Xe(L, De++), ce += S(L, R, B, ee, P);
    else if (ee === "object") {
      if (typeof m.then == "function") return S(Se(m), R, B, L, P);
  ...
  var ve = typeof reportError == "function" ? reportError : function(m) {
    if (typeof window == "object" && typeof window.ErrorEvent == "function") {
      var R = new window.ErrorEvent("error", { bubbles: true, cancelable: true, message: typeof m == "object" && m !== null && typeof m.message == "string" ? String(m.message) : String(m), error: m });
    ...
    console.error(m);
  }, we = { map: H, forEach: function(m, R, B) {
    H(m, function() {
  ...
  return te.Activity = j, te.Children = we, te.Component = pe, te.Fragment = h, te.Profiler = g, te.PureComponent = xe, te.StrictMode = o, te.Suspense = z, te.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE = W, te.__COMPILER_RUNTIME = { __proto__: null, c: function(m) {
    ...
    return null;
  }, te.cloneElement = function(m, R, B) {
    if (m == null) throw Error("The argument must be a React element, but you passed " + m + ".");
    var L = ae({}, m.props), P = m.key;
    if (R != null) for (ee in R.key !== void 0 && (P = "" + R.key), R) !le.call(R, ee) || ee === "key" || ee === "__self" || ee === "__source" || ee === "ref" && R.ref === void 0 || (L[ee] = R[ee]);
    ...
    return m = { $$typeof: M, _currentValue: m, _currentValue2: m, _threadCount: 0, Provider: null, Consumer: null }, m.Provider = m, m.Consumer = { $$typeof: v, _context: m }, m;
  }, te.createElement = function(m, R, B) {
    var L, P = {}, ee = null;
    if (R != null) for (L in R.key !== void 0 && (ee = "" + R.key), R) le.call(R, L) && L !== "key" && L !== "__self" && L !== "__source" && (P[L] = R[L]);
  ...
  }, te.memo = function(m, R) {
    return { $$typeof: _, type: m, compare: R === void 0 ? null : R };
    ...
    try {
      ...
      R !== null && B.types !== null && (R.types = B.types), W.T = R;
    }
  }, te.unstable_useCacheRefresh = function() {
    return W.H.useCacheRefresh();
  }, te.use = function(m) {
    return W.H.use(m);
  }, te.useActionState = function(m, R, B) {
    return W.H.useActionState(m, R, B);
  }, te.useCallback = function(m, R) {
    return W.H.useCallback(m, R);
  }, te.useContext = function(m) {
    return W.H.useContext(m);
  }, te.useDebugValue = function() {
  }, te.useDeferredValue = function(m, R) {
    return W.H.useDeferredValue(m, R);
  }, te.useEffect = function(m, R) {
    return W.H.useEffect(m, R);
  }, te.useEffectEvent = function(m) {
    return W.H.useEffectEvent(m);
  }, te.useId = function() {
    return W.H.useId();
  }, te.useImperativeHandle = function(m, R, B) {
    return W.H.useImperativeHandle(m, R, B);
  }, te.useInsertionEffect = function(m, R) {
    return W.H.useInsertionEffect(m, R);
  }, te.useLayoutEffect = function(m, R) {
    return W.H.useLayoutEffect(m, R);
  }, te.useMemo = function(m, R) {
    return W.H.useMemo(m, R);
  }, te.useOptimistic = function(m, R) {
    return W.H.useOptimistic(m, R);
  }, te.useReducer = function(m, R, B) {
    return W.H.useReducer(m, R, B);
  }, te.useRef = function(m) {
    return W.H.useRef(m);
  }, te.useState = function(m) {
    return W.H.useState(m);
  }, te.useSyncExternalStore = function(m, R, B) {
    return W.H.useSyncExternalStore(m, R, B);
...
var w = ko();
const Ci = mh(w);
var Ao = { exports: {} }, Ri = {}, jo = { exports: {} }, Eo = {};
var Bf;
function gh() {
  return Bf || (Bf = 1, (function(r) {
    function p(S, H) {
      var Q = S.length;
      S.push(H);
      e: for (; 0 < Q; ) {
    ...
    function o(S) {
      ...
      if (Q !== H) {
        ...
        e: for (var ve = 0, we = S.length, m = we >>> 1; ve < m; ) {
          var R = 2 * (ve + 1) - 1, B = S[R], L = R + 1, P = S[L];
          if (0 > g(B, Q)) L < we && 0 > g(P, B) ? (S[ve] = P, S[L] = Q, ve = L) : (S[ve] = B, S[R] = Q, ve = R);
    ...
    var z = [], _ = [], U = 1, j = null, $ = 3, J = false, Z = false, ae = false, X = false, pe = typeof setTimeout == "function" ? setTimeout : null, ke = typeof clearTimeout == "function" ? clearTimeout : null, xe = typeof setImmediate < "u" ? setImmediate : null;
    function fe(S) {
      for (var H = h(_); H !== null; ) {
        if (H.callback === null) o(_);
        else if (H.startTime <= S) o(_), H.sortIndex = H.expirationTime, p(z, H);
        else break;
        H = h(_);
      }
    }
    function he(S) {
      if (ae = false, fe(S), !Z) if (h(z) !== null) Z = true, se || (se = true, Ee());
      else {
        var H = h(_);
    ...
    function ot() {
      return X ? true : !(r.unstable_now() - Le < le);
    }
    function Ne() {
      if (X = false, se) {
        ...
        try {
          e: {
            Z = false, ae && (ae = false, ke(W), W = -1), J = true;
            var Q = $;
            try {
              t: {
                for (fe(S), j = h(z); j !== null && !(j.expirationTime > S && ot()); ) {
                  var ve = j.callback;
                  if (typeof ve == "function") {
                    j.callback = null, $ = j.priorityLevel;
                    var we = ve(j.expirationTime <= S);
                    if (S = r.unstable_now(), typeof we == "function") {
                      j.callback = we, fe(S), H = true;
                      break t;
                    }
                    j === h(z) && o(z), fe(S);
                  } else o(z);
    ...
    r.unstable_IdlePriority = 5, r.unstable_ImmediatePriority = 1, r.unstable_LowPriority = 4, r.unstable_NormalPriority = 3, r.unstable_Profiling = null, r.unstable_UserBlockingPriority = 2, r.unstable_cancelCallback = function(S) {
      ...
      X = true;
    }, r.unstable_runWithPriority = function(S, H) {
      switch (S) {
        case 1:
        case 2:
        case 3:
    ...
    }, r.unstable_scheduleCallback = function(S, H, Q) {
      ...
      return we = Q + we, S = { id: U++, callback: H, priorityLevel: S, startTime: Q, expirationTime: we, sortIndex: -1 }, Q > ve ? (S.sortIndex = Q, p(_, S), h(z) === null && S === h(_) && (ae ? (ke(W), W = -1) : ae = true, Se(he, Q - ve))) : (S.sortIndex = we, p(z, S), Z || J || (Z = true, se || (se = true, Ee()))), S;
    }, r.unstable_shouldYield = ot, r.unstable_wrapCallback = function(S) {
      var H = $;
      return function() {
        var Q = $;
        $ = H;
...
var Yf;
function bh() {
  return Yf || (Yf = 1, jo.exports = gh()), jo.exports;
}
var Mo = { exports: {} }, gt = {};
var Lf;
function yh() {
  ...
  function p(z) {
    ...
    if (1 < arguments.length) {
      ...
      for (var U = 2; U < arguments.length; U++) _ += "&args[]=" + encodeURIComponent(arguments[U]);
    }
    return "Minified React error #" + z + "; visit " + _ + " for the full message or use the non-minified dev environment for full errors and additional helpful warnings.";
  }
  function h() {
  }
  var o = { d: { f: h, r: function() {
    throw Error(p(522));
  ...
  function v(z, _, U) {
    ...
    return { $$typeof: g, key: j == null ? null : "" + j, children: z, containerInfo: _, implementation: U };
  }
  ...
  return gt.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE = o, gt.createPortal = function(z, _) {
    var U = 2 < arguments.length && arguments[2] !== void 0 ? arguments[2] : null;
    if (!_ || _.nodeType !== 1 && _.nodeType !== 9 && _.nodeType !== 11) throw Error(p(299));
    return v(z, _, null, U);
  }, gt.flushSync = function(z) {
    var _ = M.T, U = o.p;
    try {
      if (M.T = null, o.p = 2, z) return z();
    } finally {
      M.T = _, o.p = U, o.d.f();
    }
  }, gt.preconnect = function(z, _) {
    typeof z == "string" && (_ ? (_ = _.crossOrigin, _ = typeof _ == "string" ? _ === "use-credentials" ? _ : "" : void 0) : _ = null, o.d.C(z, _));
  }, gt.prefetchDNS = function(z) {
    typeof z == "string" && o.d.D(z);
  }, gt.preinit = function(z, _) {
    if (typeof z == "string" && _ && typeof _.as == "string") {
      var U = _.as, j = C(U, _.crossOrigin), $ = typeof _.integrity == "string" ? _.integrity : void 0, J = typeof _.fetchPriority == "string" ? _.fetchPriority : void 0;
      U === "style" ? o.d.S(z, typeof _.precedence == "string" ? _.precedence : void 0, { crossOrigin: j, integrity: $, fetchPriority: J }) : U === "script" && o.d.X(z, { crossOrigin: j, integrity: $, fetchPriority: J, nonce: typeof _.nonce == "string" ? _.nonce : void 0 });
    }
  }, gt.preinitModule = function(z, _) {
    if (typeof z == "string") if (typeof _ == "object" && _ !== null) {
      if (_.as == null || _.as === "script") {
        var U = C(_.as, _.crossOrigin);
        o.d.M(z, { crossOrigin: U, integrity: typeof _.integrity == "string" ? _.integrity : void 0, nonce: typeof _.nonce == "string" ? _.nonce : void 0 });
      }
    } else _ == null && o.d.M(z);
  }, gt.preload = function(z, _) {
    if (typeof z == "string" && typeof _ == "object" && _ !== null && typeof _.as == "string") {
      var U = _.as, j = C(U, _.crossOrigin);
      o.d.L(z, U, { crossOrigin: j, integrity: typeof _.integrity == "string" ? _.integrity : void 0, nonce: typeof _.nonce == "string" ? _.nonce : void 0, type: typeof _.type == "string" ? _.type : void 0, fetchPriority: typeof _.fetchPriority == "string" ? _.fetchPriority : void 0, referrerPolicy: typeof _.referrerPolicy == "string" ? _.referrerPolicy : void 0, imageSrcSet: typeof _.imageSrcSet == "string" ? _.imageSrcSet : void 0, imageSizes: typeof _.imageSizes == "string" ? _.imageSizes : void 0, media: typeof _.media == "string" ? _.media : void 0 });
    }
  }, gt.preloadModule = function(z, _) {
    if (typeof z == "string") if (_) {
      var U = C(_.as, _.crossOrigin);
      o.d.m(z, { as: typeof _.as == "string" && _.as !== "script" ? _.as : void 0, crossOrigin: U, integrity: typeof _.integrity == "string" ? _.integrity : void 0 });
    } else o.d.m(z);
  }, gt.requestFormReset = function(z) {
    o.d.r(z);
  }, gt.unstable_batchedUpdates = function(z, _) {
    return z(_);
  }, gt.useFormState = function(z, _, U) {
    return M.H.useFormState(z, _, U);
...
function vh() {
  ...
  return r(), Mo.exports = yh(), Mo.exports;
}
var qf;
function _h() {
  if (qf) return Ri;
  ...
  function z(e) {
    if (v(e) !== e) throw Error(o(188));
  }
  function _(e) {
    var t = e.alternate;
    if (!t) {
      if (t = v(e), t === null) throw Error(o(188));
      return t !== e ? null : e;
    }
    for (var a = e, l = t; ; ) {
      var n = a.return;
  ...
  function yl(e) {
    P.current === e && (R(L), R(P)), ce.current === e && (R(ce), Ei._currentValue = Q);
  }
  var On, Cn;
  function ya(e) {
    if (On === void 0) try {
    ...
    try {
      var l = { DetermineComponentFrameRoot: function() {
        try {
          ...
          if (A && N && typeof A.stack == "string") return [A.stack, N.stack];
        }
        return [null, null];
      } };
...
` + l.stack;
  ...
  var vl = Object.prototype.hasOwnProperty, Un = r.unstable_scheduleCallback, Za = r.unstable_cancelCallback, _l = r.unstable_shouldYield, Li = r.unstable_requestPaint, bt = r.unstable_now, Hn = r.unstable_getCurrentPriorityLevel, va = r.unstable_ImmediatePriority, $l = r.unstable_UserBlockingPriority, Rt = r.unstable_NormalPriority, Bn = r.unstable_LowPriority, Gi = r.unstable_IdlePriority, qi = r.log, Wl = r.unstable_setDisableYieldValue, Gt = null, nt = null;
  function rt(e) {
  ...
  function yc(e, t, a, l, n, i) {
    ...
    for (a = c & ~a; 0 < a; ) {
      ...
      u[E] = 0, d[E] = -1;
      var N = y[E];
      if (N !== null) for (y[E] = null, E = 0; E < N.length; E++) {
        var A = N[E];
  ...
  var wt = Math.random().toString(36).slice(2), Oe = "__reactFiber$" + wt, dt = "__reactProps$" + wt, fa = "__reactContainer$" + wt, Il = "__reactEvents$" + wt, Vi = "__reactListeners$" + wt, ft = "__reactHandles$" + wt, Ji = "__reactResources$" + wt, $a = "__reactMarker$" + wt;
  function Fl(e) {
    delete e[Oe], delete e[dt], delete e[Il], delete e[Vi], delete e[ft];
  }
  function qt(e) {
    var t = e[Oe];
    if (t) return t;
  ...
  var Ki = /* @__PURE__ */ new Set(), jl = {};
  function aa(e, t) {
    la(e, t), la(e + "Capture", t);
  }
  function la(e, t) {
    for (jl[e] = t, e = 0; e < t.length; e++) Ki.add(t[e]);
  }
  var $i = RegExp("^[:A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD][:A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD\\-.0-9\\u00B7\\u0300-\\u036F\\u203F-\\u2040]*$"), Wi = {}, Ii = {};
  function vc(e) {
    return vl.call(Ii, e) ? true : vl.call(Wi, e) ? false : $i.test(e) ? Ii[e] = true : (Wi[e] = true, false);
  }
  function Pl(e, t, a) {
  ...
  function O(e) {
    ...
    if (!t) return true;
    var a = t.getValue(), l = "";
    return e && (l = Fi(e) ? e.checked ? "true" : "false" : e.value), e = l, e !== a ? (t.setValue(e), true) : false;
  }
  function D(e) {
  ...
  function Be(e, t, a, l, n, i, c, u) {
    e.name = "", c != null && typeof c != "function" && typeof c != "symbol" && typeof c != "boolean" ? e.type = c : e.removeAttribute("type"), t != null ? c === "number" ? (t === 0 && e.value === "" || e.value != t) && (e.value = "" + At(t)) : e.value !== "" + At(t) && (e.value = "" + At(t)) : c !== "submit" && c !== "reset" || e.removeAttribute("value"), t != null ? ct(e, c, At(t)) : a != null ? ct(e, c, At(a)) : l != null && e.removeAttribute("value"), n == null && i != null && (e.defaultChecked = !!i), n != null && (e.checked = n && typeof n != "function" && typeof n != "symbol"), u != null && typeof u != "function" && typeof u != "symbol" && typeof u != "boolean" ? e.name = "" + At(u) : e.removeAttribute("name");
  }
  function et(e, t, a, l, n, i, c, u) {
    if (i != null && typeof i != "function" && typeof i != "symbol" && typeof i != "boolean" && (e.type = i), t != null || a != null) {
      ...
      a = a != null ? "" + At(a) : "", t = t != null ? "" + At(t) : a, u || t === e.value || (e.value = t), e.defaultValue = t;
    }
  ...
  function Ce(e, t, a, l) {
    if (e = e.options, t) {
      ...
      for (a = "" + At(a), t = null, n = 0; n < e.length; n++) {
        if (e[n].value === a) {
  ...
  function Xn(e, t, a, l) {
    ...
    a = At(t), e.defaultValue = a, l = e.textContent, l === a && l !== "" && l !== null && (e.value = l), qn(e);
  }
  function Xt(e, t) {
    if (t) {
      var a = e.firstChild;
      ...
      e: switch (e = t.stateNode, t.type) {
        case "input":
          if (Be(e, a.value, a.defaultValue, a.defaultValue, a.checked, a.defaultChecked, a.type, a.name), t = a.name, a.type === "radio" && t != null) {
            ...
            for (a = a.querySelectorAll('input[name="' + F("" + t) + '"][type="radio"]'), t = 0; t < a.length; t++) {
              var l = a[t];
  ...
  var _t = !(typeof window > "u" || typeof window.document > "u" || typeof window.document.createElement > "u"), ja = false;
  if (_t) try {
    var Ea = {};
  ...
  }, defaultPrevented: 0, isTrusted: 0 }, as = jt(kl), Vn = j({}, kl, { view: 0, detail: 0 }), dm = jt(Vn), wc, Ac, Jn, ls = j({}, Vn, { screenX: 0, screenY: 0, clientX: 0, clientY: 0, pageX: 0, pageY: 0, ctrlKey: 0, shiftKey: 0, altKey: 0, metaKey: 0, getModifierState: Ec, button: 0, buttons: 0, relatedTarget: function(e) {
    return e.relatedTarget === void 0 ? e.fromElement === e.srcElement ? e.toElement : e.fromElement : e.relatedTarget;
  }, movementX: function(e) {
    return "movementX" in e ? e.movementX : (e !== Jn && (Jn && e.type === "mousemove" ? (wc = e.screenX - Jn.screenX, Ac = e.screenY - Jn.screenY) : Ac = wc = 0, Jn = e), wc);
  }, movementY: function(e) {
    return "movementY" in e ? e.movementY : Ac;
  } }), ir = jt(ls), fm = j({}, ls, { dataTransfer: 0 }), mm = jt(fm), hm = j({}, Vn, { relatedTarget: 0 }), jc = jt(hm), pm = j({}, kl, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }), xm = jt(pm), gm = j({}, kl, { clipboardData: function(e) {
    return "clipboardData" in e ? e.clipboardData : window.clipboardData;
  } }), bm = jt(gm), ym = j({}, kl, { data: 0 }), sr = jt(ym), vm = { Esc: "Escape", Spacebar: " ", Left: "ArrowLeft", Up: "ArrowUp", Right: "ArrowRight", Down: "ArrowDown", Del: "Delete", Win: "OS", Menu: "ContextMenu", Apps: "ContextMenu", Scroll: "ScrollLock", MozPrintableKey: "Unidentified" }, _m = { 8: "Backspace", 9: "Tab", 12: "Clear", 13: "Enter", 16: "Shift", 17: "Control", 18: "Alt", 19: "Pause", 20: "CapsLock", 27: "Escape", 32: " ", 33: "PageUp", 34: "PageDown", 35: "End", 36: "Home", 37: "ArrowLeft", 38: "ArrowUp", 39: "ArrowRight", 40: "ArrowDown", 45: "Insert", 46: "Delete", 112: "F1", 113: "F2", 114: "F3", 115: "F4", 116: "F5", 117: "F6", 118: "F7", 119: "F8", 120: "F9", 121: "F10", 122: "F11", 123: "F12", 144: "NumLock", 145: "ScrollLock", 224: "Meta" }, Nm = { Alt: "altKey", Control: "ctrlKey", Meta: "metaKey", Shift: "shiftKey" };
  function Sm(e) {
  ...
  } }), Am = jt(wm), jm = j({}, ls, { pointerId: 0, width: 0, height: 0, pressure: 0, tangentialPressure: 0, tiltX: 0, tiltY: 0, twist: 0, pointerType: 0, isPrimary: 0 }), cr = jt(jm), Em = j({}, Vn, { touches: 0, targetTouches: 0, changedTouches: 0, altKey: 0, metaKey: 0, ctrlKey: 0, shiftKey: 0, getModifierState: Ec }), Mm = jt(Em), Tm = j({}, kl, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }), zm = jt(Tm), km = j({}, ls, { deltaX: function(e) {
    return "deltaX" in e ? e.deltaX : "wheelDeltaX" in e ? -e.wheelDeltaX : 0;
  }, deltaY: function(e) {
    return "deltaY" in e ? e.deltaY : "wheelDeltaY" in e ? -e.wheelDeltaY : "wheelDelta" in e ? -e.wheelDelta : 0;
  }, deltaZ: 0, deltaMode: 0 }), Rm = jt(km), Om = j({}, kl, { newState: 0, oldState: 0 }), Cm = jt(Om), Dm = [9, 13, 27, 32], Mc = _t && "CompositionEvent" in window, Kn = null;
  ...
  var Vm = _t && "documentMode" in document && 11 >= document.documentMode, an = null, Rc = null, Fn = null, Oc = false;
  function wr(e, t, a) {
    var l = a.window === a ? a.document : a.nodeType === 9 ? a : a.ownerDocument;
    Oc || an == null || an !== D(l) || (l = an, "selectionStart" in l && kc(l) ? l = { start: l.selectionStart, end: l.selectionEnd } : (l = (l.ownerDocument && l.ownerDocument.defaultView || window).getSelection(), l = { anchorNode: l.anchorNode, anchorOffset: l.anchorOffset, focusNode: l.focusNode, focusOffset: l.focusOffset }), Fn && In(Fn, l) || (Fn = l, l = Vs(Rc, "onSelect"), 0 < l.length && (t = new as("onSelect", "select", null, t, a), e.push({ event: t, listeners: l }), t.target = an)));
  }
  function Rl(e, t) {
    var a = {};
  ...
  _t && (Ar = document.createElement("div").style, "AnimationEvent" in window || (delete ln.animationend.animation, delete ln.animationiteration.animation, delete ln.animationstart.animation), "TransitionEvent" in window || delete ln.transitionend.transition);
  function Ol(e) {
    if (Cc[e]) return Cc[e];
    if (!ln[e]) return e;
    var t = ln[e], a;
    for (a in t) if (t.hasOwnProperty(a) && a in Ar) return Cc[e] = t[a];
    return e;
  }
  var jr = Ol("animationend"), Er = Ol("animationiteration"), Mr = Ol("animationstart"), Jm = Ol("transitionrun"), Km = Ol("transitionstart"), $m = Ol("transitioncancel"), Tr = Ol("transitionend"), zr = /* @__PURE__ */ new Map(), Dc = "abort auxClick beforeToggle cancel canPlay canPlayThrough click close contextMenu copy cut drag dragEnd dragEnter dragExit dragLeave dragOver dragStart drop durationChange emptied encrypted ended error gotPointerCapture input invalid keyDown keyPress keyUp load loadedData loadedMetadata loadStart lostPointerCapture mouseDown mouseMove mouseOut mouseOver mouseUp paste pause play playing pointerCancel pointerDown pointerMove pointerOut pointerOver pointerUp progress rateChange reset resize seeked seeking stalled submit suspend timeUpdate touchCancel touchEnd touchStart volumeChange scroll toggle touchMove waiting wheel".split(" ");
  Dc.push("scrollEnd");
  function sa(e, t) {
    zr.set(e, t), aa(t, [e]);
  }
  ...
  function us(e) {
    if (50 < vi) throw vi = 0, Vu = null, Error(o(185));
  ...
  function os(e, t, a, l, n, i) {
    ...
    if (l = e, typeof e == "function") Bc(e) && (c = 1);
      ...
      default:
        ...
        c = 29, a = Error(o(130, e === null ? "null" : typeof e, "")), l = null;
    }
  ...
  var mt = null, Ue = null, me = false, Ia = null, Kt = false, Xc = Error(o(519));
  function Fa(e) {
  ...
  function Hr(e) {
    ...
    a = l.children, typeof a != "string" && typeof a != "number" && typeof a != "bigint" || t.textContent === "" + a || l.suppressHydrationWarning === true || ef(t.textContent, a) ? (l.popover != null && (oe("beforetoggle", t), oe("toggle", t)), l.onScroll != null && oe("scroll", t), l.onScrollEnd != null && oe("scrollend", t), l.onClick != null && (t.onclick = tt), t = true) : t = false, t || Fa(e, true);
  }
  function Br(e) {
  ...
  function on(e) {
    ...
    var t = e.tag, a;
    if ((a = t !== 3 && t !== 27) && ((a = t === 5) && (a = e.type, a = !(a !== "form" && a !== "button") || co(e.type, e.memoizedProps)), a = !a), a && Ue && Fa(e), Br(e), t === 13) {
  ...
  function Zc() {
    var e = Ia;
    return e !== null && (zt === null ? zt = e : zt.push.apply(zt, e), Ia = null), e;
  }
  function ei(e) {
  ...
  }, Fm = r.unstable_scheduleCallback, Pm = r.unstable_NormalPriority, $e = { $$typeof: xe, Consumer: null, Provider: null, _currentValue: null, _currentValue2: null, _threadCount: 0 };
  function Kc() {
    return { controller: new Im(), data: /* @__PURE__ */ new Map(), refCount: 0 };
  }
  function ti(e) {
    e.refCount--, e.refCount === 0 && Fm(Pm, function() {
      e.controller.abort();
    });
  }
  ...
  function e1(e, t) {
    if (ai === null) {
      var a = ai = [];
      $c = 0, dn = Fu(), fn = { status: "pending", value: void 0, then: function(l) {
        a.push(l);
      } };
    }
  ...
  var mn = Error(o(460)), Ic = Error(o(474)), hs = Error(o(542)), ps = { then: function() {
  } };
  function Xr(e) {
  ...
  function Vr(e) {
    if (e === mn || e === hs) throw Error(o(483));
  }
  var hn = null, li = 0;
  function xs(e) {
    var t = li;
  ...
  function gs(e, t) {
    throw t.$$typeof === $ ? Error(o(525)) : (e = Object.prototype.toString.call(t), Error(o(31, e === "[object Object]" ? "object with keys {" + Object.keys(t).join(", ") + "}" : e)));
  }
  function Jr(e) {
    function t(x, f) {
      if (e) {
    ...
    function u(x, f, b, T) {
      return f === null || f.tag !== 6 ? (f = Yc(b, x.mode, T), f.return = x, f) : (f = n(f, b), f.return = x, f);
    }
    function d(x, f, b, T) {
      var V = b.type;
      return V === ae ? E(x, f, b.props.children, T, b.key) : f !== null && (f.elementType === V || typeof V == "object" && V !== null && V.$$typeof === le && Ll(V) === f.type) ? (f = n(f, b.props), ni(f, b), f.return = x, f) : (f = os(b.type, b.key, b.props, null, x.mode, T), ni(f, b), f.return = x, f);
    }
    function y(x, f, b, T) {
      return f === null || f.tag !== 4 || f.stateNode.containerInfo !== b.containerInfo || f.stateNode.implementation !== b.implementation ? (f = Lc(b, x.mode, T), f.return = x, f) : (f = n(f, b.children || []), f.return = x, f);
    }
    function E(x, f, b, T, V) {
      return f === null || f.tag !== 7 ? (f = Dl(b, x.mode, T, V), f.return = x, f) : (f = n(f, b), f.return = x, f);
    }
    function k(x, f, b) {
      ...
      if (typeof f == "object" && f !== null) {
        switch (f.$$typeof) {
          ...
          case le:
            return f = Ll(f), k(x, f, b);
        }
        if (Se(f) || Ee(f)) return f = Dl(f, x.mode, b, null), f.return = x, f;
        if (typeof f.then == "function") return k(x, xs(f), b);
        if (f.$$typeof === xe) return k(x, fs(x, f), b);
        gs(x, f);
      }
      return null;
    }
    function N(x, f, b, T) {
      ...
      if (typeof b == "string" && b !== "" || typeof b == "number" || typeof b == "bigint") return V !== null ? null : u(x, f, "" + b, T);
      if (typeof b == "object" && b !== null) {
        switch (b.$$typeof) {
          case J:
            return b.key === V ? d(x, f, b, T) : null;
          case Z:
            return b.key === V ? y(x, f, b, T) : null;
          case le:
            return b = Ll(b), N(x, f, b, T);
        }
        if (Se(b) || Ee(b)) return V !== null ? null : E(x, f, b, T, null);
        if (typeof b.then == "function") return N(x, f, xs(b), T);
        if (b.$$typeof === xe) return N(x, f, fs(x, b), T);
        gs(x, b);
      }
      return null;
    }
    function A(x, f, b, T, V) {
      if (typeof T == "string" && T !== "" || typeof T == "number" || typeof T == "bigint") return x = x.get(b) || null, u(f, x, "" + T, V);
      if (typeof T == "object" && T !== null) {
        switch (T.$$typeof) {
          case J:
            return x = x.get(T.key === null ? b : T.key) || null, d(f, x, T, V);
          case Z:
            return x = x.get(T.key === null ? b : T.key) || null, y(f, x, T, V);
          case le:
            return T = Ll(T), A(x, f, b, T, V);
        }
        if (Se(T) || Ee(T)) return x = x.get(b) || null, E(f, x, T, V, null);
        if (typeof T.then == "function") return A(x, f, b, xs(T), V);
        if (T.$$typeof === xe) return A(x, f, b, fs(f, T), V);
        gs(f, T);
      }
      return null;
    }
    function G(x, f, b, T) {
      ...
      if (ie === b.length) return a(x, q), me && Ta(x, ie), V;
      if (q === null) {
        for (; ie < b.length; ie++) q = k(x, b[ie], T), q !== null && (f = i(q, f, ie), ge === null ? V = q : ge.sibling = q, ge = q);
        return me && Ta(x, ie), V;
      }
      for (q = l(q); ie < b.length; ie++) de = A(q, x, ie, b[ie], T), de !== null && (e && de.alternate !== null && q.delete(de.key === null ? ie : de.key), f = i(de, f, ie), ge === null ? V = de : ge.sibling = de, ge = de);
    ...
    function K(x, f, b, T) {
      ...
      if (be.done) return a(x, q), me && Ta(x, ie), V;
      if (q === null) {
        for (; !be.done; ie++, be = b.next()) be = k(x, be.value, T), be !== null && (f = i(be, f, ie), ge === null ? V = be : ge.sibling = be, ge = be);
        return me && Ta(x, ie), V;
      }
      for (q = l(q); !be.done; ie++, be = b.next()) be = A(q, x, ie, be.value, T), be !== null && (e && be.alternate !== null && q.delete(be.key === null ? ie : be.key), f = i(be, f, ie), ge === null ? V = be : ge.sibling = be, ge = be);
            ...
            e: {
              for (var V = b.key; f !== null; ) {
                if (f.key === V) {
                  if (V = b.type, V === ae) {
                    if (f.tag === 7) {
                      a(x, f.sibling), T = n(f, b.props.children), T.return = x, x = T;
                      break e;
                    }
                  } else if (f.elementType === V || typeof V == "object" && V !== null && V.$$typeof === le && Ll(V) === f.type) {
                    a(x, f.sibling), T = n(f, b.props), ni(T, b), T.return = x, x = T;
                    break e;
                  }
                  a(x, f);
                  break;
              ...
              b.type === ae ? (T = Dl(b.props.children, x.mode, T, b.key), T.return = x, x = T) : (T = os(b.type, b.key, b.props, null, x.mode, T), ni(T, b), T.return = x, x = T);
            }
            return c(x);
          case Z:
            e: {
              for (V = b.key; f !== null; ) {
                if (f.key === V) if (f.tag === 4 && f.stateNode.containerInfo === b.containerInfo && f.stateNode.implementation === b.implementation) {
                  a(x, f.sibling), T = n(f, b.children || []), T.return = x, x = T;
                  break e;
                } else {
                  a(x, f);
                  break;
              ...
              T = Lc(b, x.mode, T), T.return = x, x = T;
            }
            return c(x);
          case le:
            return b = Ll(b), ze(x, f, b, T);
        }
        if (Se(b)) return G(x, f, b, T);
        if (Ee(b)) {
          if (V = Ee(b), typeof V != "function") throw Error(o(150));
          return b = V.call(b), K(x, f, b, T);
        }
        if (typeof b.then == "function") return ze(x, f, xs(b), T);
        if (b.$$typeof === xe) return ze(x, f, fs(x, b), T);
        gs(x, b);
      }
      return typeof b == "string" && b !== "" || typeof b == "number" || typeof b == "bigint" ? (b = "" + b, f !== null && f.tag === 6 ? (a(x, f.sibling), T = n(f, b), T.return = x, x = T) : (a(x, f), T = Yc(b, x.mode, T), T.return = x, x = T), c(x)) : a(x, f);
    }
    return function(x, f, b, T) {
      try {
        li = 0;
        var V = ze(x, f, b, T);
        return hn = null, V;
        ...
        return ge.lanes = T, ge.return = x, ge;
      }
    };
  }
  ...
  function al(e, t, a) {
    ...
    if (l = l.shared, (_e & 2) !== 0) {
      var n = l.pending;
      return n === null ? t.next = t : (t.next = n.next, n.next = t), l.pending = t, t = us(e), kr(e, null, a), t;
    }
  ...
  function ci(e, t, a, l) {
    ...
    if (i !== null) {
      ...
      c = 0, E = y = d = null, u = i;
      do {
        var N = u.lane & -536870913, A = N !== u.lane;
        if (A ? (re & N) === N : (l & N) === N) {
          N !== 0 && N === dn && (tu = true), E !== null && (E = E.next = { lane: 0, tag: u.tag, payload: u.payload, callback: null, next: null });
          e: {
            var G = e, K = u;
            N = t;
            var ze = a;
            switch (K.tag) {
              ...
              case 0:
                if (G = K.payload, N = typeof G == "function" ? G.call(ze, k, N) : G, N == null) break e;
                k = j({}, k, N);
                break e;
              case 2:
                el = true;
          ...
          N = u.callback, N !== null && (e.flags |= 64, A && (e.flags |= 8192), A = n.callbacks, A === null ? n.callbacks = [N] : A.push(N));
        } else A = { lane: N, tag: u.tag, payload: u.payload, callback: u.callback, next: null }, E === null ? (y = E = A, d = k) : E = E.next = A, c |= N;
        if (u = u.next, u === null) {
          if (u = n.shared.pending, u === null) break;
          A = u, u = A.next, A.next = null, n.lastBaseUpdate = A, n.shared.pending = null;
        }
      } while (true);
      E === null && (d = k), n.baseState = d, n.firstBaseUpdate = y, n.lastBaseUpdate = E, i === null && (n.shared.lanes = 0), cl |= c, e.lanes = c, e.memoizedState = k;
    }
  }
  function $r(e, t) {
  ...
  function Pr(e) {
    ...
    if (Ra = 0, We = Me = ne = null, vs = false, ui = 0, gn = null, t) throw Error(o(300));
    e === null || Ie || (e = e.dependencies, e !== null && ds(e) && (Ie = true));
  }
  function ed(e, t, a, l) {
    ne = e;
    var n = 0;
    do {
      if (xn && (gn = null), ui = 0, xn = false, 25 <= n) throw Error(o(301));
  ...
  function du(e, t, a) {
    ...
    if (i = e.baseState, n === null) e.memoizedState = i;
      ...
      do {
        ...
        if (k !== y.lane ? (re & k) === k : (Ra & k) === k) {
          var N = y.revertLane;
          if (N === 0) d !== null && (d = d.next = { lane: 0, revertLane: 0, gesture: null, action: y.action, hasEagerState: y.hasEagerState, eagerState: y.eagerState, next: null }), k === dn && (E = true);
          else if ((Ra & N) === N) {
            y = y.next, N === dn && (E = true);
            continue;
          } else k = { lane: 0, revertLane: y.revertLane, gesture: null, action: y.action, hasEagerState: y.hasEagerState, eagerState: y.eagerState, next: null }, d === null ? (u = d = k, c = i) : d = d.next = k, ne.lanes |= N, cl |= N;
          k = y.action, Xl && a(i, k), i = y.hasEagerState ? y.eagerState : a(i, k);
        } else N = { lane: k, revertLane: y.revertLane, gesture: y.gesture, action: y.action, hasEagerState: y.hasEagerState, eagerState: y.eagerState, next: null }, d === null ? (u = d = N, c = i) : d = d.next = N, ne.lanes |= k, cl |= k;
        y = y.next;
      } while (y !== null && y !== t);
      if (d === null ? c = i : d.next = u, !Ot(i, e.memoizedState) && (Ie = true, E && (a = fn, a !== null))) throw a;
  ...
  function fu(e) {
    ...
    if (n !== null) {
      ...
      while (c !== n);
      Ot(i, t.memoizedState) || (Ie = true), t.memoizedState = i, t.baseQueue === null && (t.baseState = i), a.lastRenderedState = i;
    }
    return [i, l];
  }
  function td(e, t, a) {
    ...
    if (c && (n.memoizedState = a, Ie = true), n = n.queue, pu(nd.bind(null, l, n, e), [e]), n.getSnapshot !== t || c || We !== null && We.memoizedState.tag & 1) {
      if (l.flags |= 2048, bn(9, { destroy: void 0 }, ld.bind(null, l, n, a, t), null), Re === null) throw Error(o(349));
      i || (Ra & 127) !== 0 || ad(l, t, a);
    }
    return a;
  }
  ...
  function Sd(e, t, a) {
    a = a != null ? a.concat([e]) : null, js(4, 4, Nd.bind(null, t, e), a);
  }
  function xu() {
  }
  function wd(e, t) {
  ...
  function gu(e, t, a) {
    return a === void 0 || (Ra & 1073741824) !== 0 && (re & 261930) === 0 ? e.memoizedState = t : (e.memoizedState = a, e = j0(), ne.lanes |= e, cl |= e, a);
  }
  function jd(e, t, a, l) {
    return Ot(a, t) ? a : pn.current !== null ? (e = gu(e, a, l), Ot(e, t) || (Ie = true), e) : (Ra & 42) === 0 || (Ra & 1073741824) !== 0 && (re & 261930) === 0 ? (Ie = true, e.memoizedState = a) : (e = j0(), ne.lanes |= e, cl |= e, t);
  }
    ...
    for (var t = e.return; t !== null; ) {
      switch (t.tag) {
        ...
        case 3:
          ...
          e = tl(a);
          var l = al(t, e, a);
          l !== null && (kt(l, t, a), ii(l, t, a)), t = { cache: Kc() }, e.payload = t;
          return;
      }
      t = t.return;
    }
  ...
  function o1(e, t, a) {
    var l = Yt();
    a = { lane: l, revertLane: 0, gesture: null, action: a, hasEagerState: false, eagerState: null, next: null }, Es(e) ? Od(t, a) : (a = Hc(e, t, a, l), a !== null && (kt(a, e, l), Cd(a, t, l)));
  }
  function Rd(e, t, a) {
    var l = Yt();
    ri(e, t, a, l);
  ...
  function ri(e, t, a, l) {
    ...
    if (Es(e)) Od(t, n);
      ...
      if (a = Hc(e, t, n, l), a !== null) return kt(a, e, l), Cd(a, t, l), true;
    }
    return false;
  }
  function vu(e, t, a, l) {
    if (l = { lane: 2, revertLane: Fu(), gesture: null, action: l, hasEagerState: false, eagerState: null, next: null }, Es(e)) {
      if (t) throw Error(o(479));
    } else t = Hc(e, a, l, 2), t !== null && kt(t, e, 2);
  }
  function Es(e) {
    var t = e.alternate;
  ...
  var Dd = { readContext: ht, use: Ss, useCallback: function(e, t) {
    ...
    a = a != null ? a.concat([e]) : null, As(4194308, 4, Nd.bind(null, t, e), a);
  ...
  } }, _u = { readContext: ht, use: Ss, useCallback: wd, useContext: ht, useEffect: pu, useImperativeHandle: Sd, useInsertionEffect: vd, useLayoutEffect: _d, useMemo: Ad, useReducer: ws, useRef: gd, useState: function() {
    return ws(Oa);
  }, useDebugValue: xu, useDeferredValue: function(e, t) {
    var a = Je();
    return jd(a, Me.memoizedState, e, t);
  }, useTransition: function() {
    ...
    var a = Je();
    return cd(a, Me, e, t);
  }, useMemoCache: ru, useCacheRefresh: kd };
  _u.useEffectEvent = yd;
  var Ud = { readContext: ht, use: Ss, useCallback: wd, useContext: ht, useEffect: pu, useImperativeHandle: Sd, useInsertionEffect: vd, useLayoutEffect: _d, useMemo: Ad, useReducer: fu, useRef: gd, useState: function() {
    return fu(Oa);
  }, useDebugValue: xu, useDeferredValue: function(e, t) {
    var a = Je();
    return Me === null ? gu(a, e, t) : jd(a, Me.memoizedState, e, t);
  }, useTransition: function() {
  ...
  var Su = { enqueueSetState: function(e, t, a) {
    e = e._reactInternals;
    var l = Yt(), n = tl(l);
    n.payload = t, a != null && (n.callback = a), t = al(e, n, l), t !== null && (kt(t, e, l), ii(t, e, l));
  }, enqueueReplaceState: function(e, t, a) {
    e = e._reactInternals;
    var l = Yt(), n = tl(l);
    n.tag = 1, n.payload = t, a != null && (n.callback = a), t = al(e, n, l), t !== null && (kt(t, e, l), ii(t, e, l));
  }, enqueueForceUpdate: function(e, t) {
    e = e._reactInternals;
    var a = Yt(), l = tl(a);
    l.tag = 2, t != null && (l.callback = t), t = al(e, l, a), t !== null && (kt(t, e, a), ii(t, e, a));
  } };
  function Hd(e, t, a, l, n, i, c) {
    return e = e.stateNode, typeof e.shouldComponentUpdate == "function" ? e.shouldComponentUpdate(l, i, c) : t.prototype && t.prototype.isPureReactComponent ? !In(a, l) || !In(n, i) : true;
  }
  function Bd(e, t, a, l) {
  ...
  function r1(e, t, a, l, n) {
    ...
    if (me) return t = Dt.current, t !== null ? ((t.flags & 65536) === 0 && (t.flags |= 256), t.flags |= 65536, t.lanes = n, l !== Xc && (e = Error(o(422), { cause: l }), ei(Qt(e, a)))) : (l !== Xc && (t = Error(o(423), { cause: l }), ei(Qt(t, a))), e = e.current.alternate, e.flags |= 65536, n &= -n, e.lanes |= n, l = Qt(l, a), n = wu(e.stateNode, l, n), eu(e, n), qe !== 4 && (qe = 2)), false;
  ...
  function Qd(e, t, a, l, n) {
    ...
    return Bl(t), l = su(e, t, a, c, i, n), u = cu(), e !== null && !Ie ? (uu(e, t, n), Ca(e, t, n)) : (me && u && Gc(t), t.flags |= 1, pt(e, t, l, n), t.child);
  }
  function Vd(e, t, a, l, n) {
    ...
    if (i = e.child, !Ou(e, n)) {
      ...
      if (a = a.compare, a = a !== null ? a : In, a(c, l) && e.ref === t.ref) return Ca(e, t, n);
    }
  ...
  function Jd(e, t, a, l, n) {
    if (e !== null) {
      ...
      if (In(i, l) && e.ref === t.ref) if (Ie = false, t.pendingProps = l = i, Ou(e, n)) (e.flags & 131072) !== 0 && (Ie = true);
  ...
  function Kd(e, t, a, l) {
    ...
    if (e === null && t.stateNode === null && (t.stateNode = { _visibility: 1, _pendingMarkers: null, _retryCache: null, _transitions: null }), l.mode === "hidden") {
      ...
      if ((a & 536870912) !== 0) t.memoizedState = { baseLanes: 0, cachePool: null }, e !== null && ms(t, i !== null ? i.cachePool : null), i !== null ? Ir(t, i) : au(), Fr(t);
      else return l = t.lanes = 536870912, $d(e, t, i !== null ? i.baseLanes | a : a, a, l);
    } else i !== null ? (ms(t, i.cachePool), Ir(t, i), nl(), t.memoizedState = null) : (e !== null && ms(t, null), au(), nl());
  ...
  function $d(e, t, a, l, n) {
    var i = Wc();
    return i = i === null ? null : { parent: $e._currentValue, pool: i }, t.memoizedState = { baseLanes: a, cachePool: i }, e !== null && ms(t, null), au(), Fr(t), e !== null && rn(e, t, l, true), t.childLanes = n, null;
  }
  function Ts(e, t) {
    return t = ks({ mode: t.mode, children: t.children }, e.mode), t.ref = e.ref, e.child = t, t.return = e, t;
  }
  function Wd(e, t, a) {
    return ql(t, e.child, null, a), e = Ts(t, t.pendingProps), e.flags |= 2, Ut(t), t.memoizedState = null, e;
  }
  function d1(e, t, a) {
    var l = t.pendingProps, n = (t.flags & 128) !== 0;
    if (t.flags &= -129, e === null) {
      if (me) {
        if (l.mode === "hidden") return e = Ts(t, l), t.lanes = 536870912, fi(null, e);
        if (nu(t), (e = Ue) ? (e = of(e, Kt), e = e !== null && e.data === "&" ? e : null, e !== null && (t.memoizedState = { dehydrated: e, treeContext: Wa !== null ? { id: pa, overflow: xa } : null, retryLane: 536870912, hydrationErrors: null }, a = Or(e), a.return = t, t.child = a, mt = t, Ue = null)) : e = null, e === null) throw Fa(t);
    ...
    if (i !== null) {
      ...
      else if (Ie || rn(e, t, a, false), n = (a & e.childLanes) !== 0, Ie || n) {
        if (l = Re, l !== null && (c = wl(l, a), c !== 0 && c !== i.retryLane)) throw i.retryLane = c, Cl(e, c), kt(l, e, c), Au;
        Ls(), t = Wd(e, t, a);
      } else e = i.treeContext, Ue = Wt(c.nextSibling), mt = t, me = true, Ia = null, Kt = false, e !== null && Ur(t, e), t = Ts(t, l), t.flags |= 4096;
      return t;
    }
  ...
  function ju(e, t, a, l, n) {
    return Bl(t), a = su(e, t, a, l, void 0, n), l = cu(), e !== null && !Ie ? (uu(e, t, n), Ca(e, t, n)) : (me && l && Gc(t), t.flags |= 1, pt(e, t, a, n), t.child);
  }
  function Id(e, t, a, l, n, i) {
    return Bl(t), t.updateQueue = null, a = ed(t, l, a, n), Pr(e), l = cu(), e !== null && !Ie ? (uu(e, t, i), Ca(e, t, i)) : (me && l && Gc(t), t.flags |= 1, pt(e, t, a, i), t.child);
  }
  function Fd(e, t, a, l, n) {
    if (Bl(t), t.stateNode === null) {
      var i = sn, c = a.contextType;
      typeof c == "object" && c !== null && (i = ht(c)), i = new a(l, i), t.memoizedState = i.state !== null && i.state !== void 0 ? i.state : null, i.updater = Su, t.stateNode = i, i._reactInternals = t, i = t.stateNode, i.props = l, i.state = t.memoizedState, i.refs = {}, Fc(t), c = a.contextType, i.context = typeof c == "object" && c !== null ? ht(c) : sn, i.state = t.memoizedState, c = a.getDerivedStateFromProps, typeof c == "function" && (Nu(t, a, c, l), i.state = t.memoizedState), typeof a.getDerivedStateFromProps == "function" || typeof i.getSnapshotBeforeUpdate == "function" || typeof i.UNSAFE_componentWillMount != "function" && typeof i.componentWillMount != "function" || (c = i.state, typeof i.componentWillMount == "function" && i.componentWillMount(), typeof i.UNSAFE_componentWillMount == "function" && i.UNSAFE_componentWillMount(), c !== i.state && Su.enqueueReplaceState(i, i.state, null), ci(t, l, i, n), si(), i.state = t.memoizedState), typeof i.componentDidMount == "function" && (t.flags |= 4194308), l = true;
    } else if (e === null) {
      i = t.stateNode;
      ...
      E = typeof k == "function" || typeof i.getSnapshotBeforeUpdate == "function", u = t.pendingProps !== u, E || typeof i.UNSAFE_componentWillReceiveProps != "function" && typeof i.componentWillReceiveProps != "function" || (u || y !== c) && Bd(t, i, l, c), el = false;
      var N = t.memoizedState;
      i.state = N, ci(t, l, i, n), si(), y = t.memoizedState, u || N !== y || el ? (typeof k == "function" && (Nu(t, a, k, l), y = t.memoizedState), (d = el || Hd(t, a, d, l, N, y, c)) ? (E || typeof i.UNSAFE_componentWillMount != "function" && typeof i.componentWillMount != "function" || (typeof i.componentWillMount == "function" && i.componentWillMount(), typeof i.UNSAFE_componentWillMount == "function" && i.UNSAFE_componentWillMount()), typeof i.componentDidMount == "function" && (t.flags |= 4194308)) : (typeof i.componentDidMount == "function" && (t.flags |= 4194308), t.memoizedProps = l, t.memoizedState = y), i.props = l, i.state = y, i.context = c, l = d) : (typeof i.componentDidMount == "function" && (t.flags |= 4194308), l = false);
    } else {
      i = t.stateNode, Pc(e, t), c = t.memoizedProps, E = Zl(a, c), i.props = E, k = t.pendingProps, N = i.context, y = a.contextType, d = sn, typeof y == "object" && y !== null && (d = ht(y)), u = a.getDerivedStateFromProps, (y = typeof u == "function" || typeof i.getSnapshotBeforeUpdate == "function") || typeof i.UNSAFE_componentWillReceiveProps != "function" && typeof i.componentWillReceiveProps != "function" || (c !== k || N !== d) && Bd(t, i, l, d), el = false, N = t.memoizedState, i.state = N, ci(t, l, i, n), si();
      var A = t.memoizedState;
      c !== k || N !== A || el || e !== null && e.dependencies !== null && ds(e.dependencies) ? (typeof u == "function" && (Nu(t, a, u, l), A = t.memoizedState), (E = el || Hd(t, a, E, l, N, A, d) || e !== null && e.dependencies !== null && ds(e.dependencies)) ? (y || typeof i.UNSAFE_componentWillUpdate != "function" && typeof i.componentWillUpdate != "function" || (typeof i.componentWillUpdate == "function" && i.componentWillUpdate(l, A, d), typeof i.UNSAFE_componentWillUpdate == "function" && i.UNSAFE_componentWillUpdate(l, A, d)), typeof i.componentDidUpdate == "function" && (t.flags |= 4), typeof i.getSnapshotBeforeUpdate == "function" && (t.flags |= 1024)) : (typeof i.componentDidUpdate != "function" || c === e.memoizedProps && N === e.memoizedState || (t.flags |= 4), typeof i.getSnapshotBeforeUpdate != "function" || c === e.memoizedProps && N === e.memoizedState || (t.flags |= 1024), t.memoizedProps = l, t.memoizedState = A), i.props = l, i.state = A, i.context = d, l = E) : (typeof i.componentDidUpdate != "function" || c === e.memoizedProps && N === e.memoizedState || (t.flags |= 4), typeof i.getSnapshotBeforeUpdate != "function" || c === e.memoizedProps && N === e.memoizedState || (t.flags |= 1024), l = false);
    }
  ...
  function e0(e, t, a) {
    ...
    if ((c = i) || (c = e !== null && e.memoizedState === null ? false : (Ve.current & 2) !== 0), c && (n = true, t.flags &= -129), c = (t.flags & 32) !== 0, t.flags &= -33, e === null) {
      if (me) {
        if (n ? ll(t) : nl(), (e = Ue) ? (e = of(e, Kt), e = e !== null && e.data !== "&" ? e : null, e !== null && (t.memoizedState = { dehydrated: e, treeContext: Wa !== null ? { id: pa, overflow: xa } : null, retryLane: 536870912, hydrationErrors: null }, a = Or(e), a.return = t, t.child = a, mt = t, Ue = null)) : e = null, e === null) throw Fa(t);
        return fo(e) ? t.lanes = 32 : t.lanes = 536870912, null;
      }
      var u = l.children;
      return l = l.fallback, n ? (nl(), n = t.mode, u = ks({ mode: "hidden", children: u }, n), l = Dl(l, n, a, null), u.return = t, l.return = t, u.sibling = l, t.child = u, l = t.child, l.memoizedState = Mu(a), l.childLanes = Tu(e, c, a), t.memoizedState = Eu, fi(null, l)) : (ll(t), zu(t, u));
    }
    var d = e.memoizedState;
    if (d !== null && (u = d.dehydrated, u !== null)) {
      if (i) t.flags & 256 ? (ll(t), t.flags &= -257, t = ku(e, t, a)) : t.memoizedState !== null ? (nl(), t.child = e.child, t.flags |= 128, t = null) : (nl(), u = l.fallback, n = t.mode, l = ks({ mode: "visible", children: l.children }, n), u = Dl(u, n, a, null), u.flags |= 2, l.return = t, u.return = t, l.sibling = u, t.child = l, ql(t, e.child, null, a), l = t.child, l.memoizedState = Mu(a), l.childLanes = Tu(e, c, a), t.memoizedState = Eu, t = fi(null, l));
      else if (ll(t), fo(u)) {
        if (c = u.nextSibling && u.nextSibling.dataset, c) var y = c.dgst;
        c = y, l = Error(o(419)), l.stack = "", l.digest = c, ei({ value: l, source: null, stack: null }), t = ku(e, t, a);
      } else if (Ie || rn(e, t, a, false), c = (a & e.childLanes) !== 0, Ie || c) {
        if (c = Re, c !== null && (l = wl(c, a), l !== 0 && l !== d.retryLane)) throw d.retryLane = l, Cl(e, l), kt(c, e, l), Au;
        ro(u) || Ls(), t = ku(e, t, a);
      } else ro(u) ? (t.flags |= 192, t.child = e.child, t = null) : (e = d.treeContext, Ue = Wt(u.nextSibling), mt = t, me = true, Ia = null, Kt = false, e !== null && Ur(t, e), t = zu(t, l.children), t.flags |= 4096);
      return t;
    }
    return n ? (nl(), u = l.fallback, n = t.mode, d = e.child, y = d.sibling, l = Ma(d, { mode: "hidden", children: l.children }), l.subtreeFlags = d.subtreeFlags & 65011712, y !== null ? u = Ma(y, u) : (u = Dl(u, n, a, null), u.flags |= 2), u.return = t, l.return = t, l.sibling = u, t.child = l, fi(null, l), l = t.child, u = e.child.memoizedState, u === null ? u = Mu(a) : (n = u.cachePool, n !== null ? (d = $e._currentValue, n = n.parent !== d ? { parent: d, pool: d } : n) : n = qr(), u = { baseLanes: u.baseLanes | a, cachePool: n }), l.memoizedState = u, l.childLanes = Tu(e, c, a), t.memoizedState = Eu, fi(e.child, l)) : (ll(t), a = e.child, e = a.sibling, a = Ma(a, { mode: "visible", children: l.children }), a.return = t, a.sibling = null, e !== null && (c = t.deletions, c === null ? (t.deletions = [e], t.flags |= 16) : c.push(e)), t.child = a, t.memoizedState = null, a);
  }
  function zu(e, t) {
    return t = ks({ mode: "visible", children: t }, e.mode), t.return = e, e.child = t;
  }
  function ks(e, t) {
  ...
  function l0(e, t, a) {
    if (e !== null) if (e.memoizedProps !== t.pendingProps) Ie = true;
    else {
      if (!Ou(e, a) && (t.flags & 128) === 0) return Ie = false, f1(e, t, a);
      Ie = (e.flags & 131072) !== 0;
    }
    else Ie = false, me && (t.flags & 1048576) !== 0 && Dr(t, Pn, t.index);
    switch (t.lanes = 0, t.tag) {
      case 16:
        e: {
          var l = t.pendingProps;
          if (e = Ll(t.elementType), t.type = e, typeof e == "function") Bc(e) ? (l = Zl(e, l), t.tag = 1, t = Fd(null, t, e, l, a)) : (t.tag = 0, t = ju(null, t, e, l, a));
          else {
            if (e != null) {
              var n = e.$$typeof;
              if (n === fe) {
      ...
      case 1:
        return l = t.type, n = Zl(l, t.pendingProps), Fd(e, t, l, n, a);
      case 3:
        e: {
          ...
          if (l = c.cache, Pa(t, $e, l), l !== i.cache && Jc(t, [$e], a, true), si(), l = c.element, i.isDehydrated) if (i = { element: l, isDehydrated: false, cache: c.cache }, t.updateQueue.baseState = i, t.memoizedState = i, t.flags & 256) {
            ...
            n = Qt(Error(o(424)), t), ei(n), t = Pd(e, t, l, a);
            break e;
          } else for (e = t.stateNode.containerInfo, e.nodeType === 9 ? e = e.body : e = e.nodeName === "HTML" ? e.ownerDocument.body : e, Ue = Wt(e.firstChild), mt = t, me = true, Ia = null, Kt = true, a = Kr(t, null, l, a), t.child = a; a; ) a.flags = a.flags & -3 | 4096, a = a.sibling;
          else {
            if (Ul(), l === n) {
              t = Ca(e, t, a);
              break e;
      ...
      case 5:
        return e === null && me && ((n = l = Ue) && (l = q1(l, t.type, t.pendingProps, Kt), l !== null ? (t.stateNode = l, mt = t, Ue = Wt(l.firstChild), Kt = false, n = true) : n = false), n || Fa(t)), bl(t), n = t.type, i = t.pendingProps, c = e !== null ? e.memoizedProps : null, l = i.children, co(n, i) ? l = null : c !== null && co(n, c) && (t.flags |= 32), t.memoizedState !== null && (n = su(e, t, l1, null, null, a), Ei._currentValue = n), zs(e, t), pt(e, t, l, a), t.child;
      case 6:
        return e === null && me && ((e = a = Ue) && (a = X1(a, t.pendingProps, Kt), a !== null ? (t.stateNode = a, mt = t, Ue = null, e = true) : e = false), e || Fa(t)), null;
      case 13:
        return e0(e, t, a);
      case 4:
  ...
  function m1(e, t, a) {
    ...
    switch (qc(t), t.tag) {
      ...
      case 1:
        return He(t), null;
      case 3:
        return a = t.stateNode, l = null, e !== null && (l = e.memoizedState.cache), t.memoizedState.cache !== l && (t.flags |= 2048), ka($e), De(), a.pendingContext && (a.context = a.pendingContext, a.pendingContext = null), (e === null || e.child === null) && (on(t) ? Da(t) : e === null || e.memoizedState.isDehydrated && (t.flags & 256) === 0 || (t.flags |= 1024, Zc())), He(t), null;
      case 26:
      ...
      case 6:
        if (e && t.stateNode != null) e.memoizedProps !== l && Da(t);
          ...
          if (e = ee.current, on(t)) {
            ...
            e[Oe] = t, e = !!(e.nodeValue === a || l !== null && l.suppressHydrationWarning === true || ef(e.nodeValue, a)), e || Fa(t, true);
      ...
      case 10:
        return ka(t.type), He(t), null;
      case 19:
        if (R(Ve), l = t.memoizedState, l === null) return He(t), null;
        if (n = (t.flags & 128) !== 0, i = l.rendering, i === null) if (n) mi(l, false);
          ...
          if (qe !== 0 || e !== null && (e.flags & 128) !== 0) for (e = t.child; e !== null; ) {
            if (i = ys(e), i !== null) {
              ...
              return B(Ve, Ve.current & 1 | 2), me && Ta(t, l.treeForkCount), t.child;
            }
            e = e.sibling;
          }
        ...
        return l.tail !== null ? (e = l.tail, l.rendering = e, l.tail = e.sibling, l.renderingStartTime = bt(), e.sibling = null, a = Ve.current, B(Ve, n ? a & 1 | 2 : a & 1), me && Ta(t, l.treeForkCount), e) : (He(t), null);
      case 22:
      case 23:
        return Ut(t), lu(), l = t.memoizedState !== null, e !== null ? e.memoizedState !== null !== l && (t.flags |= 8192) : l && (t.flags |= 8192), l ? (a & 536870912) !== 0 && (t.flags & 128) === 0 && (He(t), t.subtreeFlags & 6 && (t.flags |= 8192)) : He(t), a = t.updateQueue, a !== null && Rs(t, a.retryQueue), a = null, e !== null && e.memoizedState !== null && e.memoizedState.cachePool !== null && (a = e.memoizedState.cachePool.pool), l = null, t.memoizedState !== null && t.memoizedState.cachePool !== null && (l = t.memoizedState.cachePool.pool), l !== a && (t.flags |= 2048), e !== null && R(Yl), null;
      case 24:
        return a = null, e !== null && (a = e.memoizedState.cache), t.memoizedState.cache !== a && (t.flags |= 2048), ka($e), He(t), null;
      case 25:
        return null;
      case 30:
        return null;
  ...
  function h1(e, t) {
    switch (qc(t), t.tag) {
      ...
      case 3:
        return ka($e), De(), e = t.flags, (e & 65536) !== 0 && (e & 128) === 0 ? (t.flags = e & -65537 | 128, t) : null;
      case 26:
      case 27:
      case 5:
        return yl(t), null;
      ...
      case 22:
      case 23:
        return Ut(t), lu(), e !== null && R(Yl), e = t.flags, e & 65536 ? (t.flags = e & -65537 | 128, t) : null;
      case 24:
        return ka($e), null;
      case 25:
        return null;
  ...
  var Ua = false, Fe = false, Bu = false, d0 = typeof WeakSet == "function" ? WeakSet : Set, ut = null;
  function p1(e, t) {
    if (e = e.containerInfo, io = ec, e = Sr(e), kc(e)) {
      if ("selectionStart" in e) var a = { start: e.selectionStart, end: e.selectionEnd };
        ...
        if (l && l.rangeCount !== 0) {
          ...
          var c = 0, u = -1, d = -1, y = 0, E = 0, k = e, N = null;
          t: for (; ; ) {
            for (var A; k !== a || n !== 0 && k.nodeType !== 3 || (u = c + n), k !== i || l !== 0 && k.nodeType !== 3 || (d = c + l), k.nodeType === 3 && (c += k.nodeValue.length), (A = k.firstChild) !== null; ) N = k, k = A;
            for (; ; ) {
              if (k === e) break t;
              if (N === a && ++y === n && (u = c), N === i && ++E === l && (d = c), (A = k.nextSibling) !== null) break;
              k = N, N = k.parentNode;
            }
            k = A;
          }
    ...
    switch (a.tag) {
      ...
      case 22:
        if (l = a.memoizedState !== null || Ua, !l) {
          t = t !== null && t.memoizedState !== null || Fe, n = Ua;
          var i = Fe;
          Ua = l, (Fe = t) && !i ? Ya(e, a, (a.subtreeFlags & 8772) !== 0) : Ba(e, a), Ua = n, Fe = i;
        }
        break;
      case 30:
        break;
  ...
  function m0(e) {
    var t = e.alternate;
    t !== null && (e.alternate = null, m0(t)), e.child = null, e.deletions = null, e.sibling = null, e.tag === 5 && (t = e.stateNode, t !== null && Fl(t)), e.stateNode = null, e.return = null, e.dependencies = null, e.memoizedProps = null, e.memoizedState = null, e.pendingProps = null, e.stateNode = null, e.updateQueue = null;
  }
  ...
  function h0(e, t, a) {
    ...
    switch (a.tag) {
      case 26:
        Fe || ga(a, t), Ha(e, t, a), a.memoizedState ? a.memoizedState.count-- : a.stateNode && (a = a.stateNode, a.parentNode.removeChild(a));
        break;
      case 27:
        Fe || ga(a, t);
        var l = Ye, n = Et;
      ...
      case 14:
      case 15:
        il(2, a, t), Fe || il(4, a, t), Ha(e, t, a);
        break;
      case 1:
        Fe || (ga(a, t), l = a.stateNode, typeof l.componentWillUnmount == "function" && c0(a, t, l)), Ha(e, t, a);
        break;
      case 21:
        Ha(e, t, a);
        break;
      case 22:
        Fe = (l = Fe) || a.memoizedState !== null, Ha(e, t, a), Fe = l;
        break;
      default:
        Ha(e, t, a);
    }
  ...
  function g0(e, t) {
    ...
    switch (e.tag) {
      ...
      case 14:
      case 15:
        Mt(t, e), Tt(e), l & 4 && (il(3, e, e.return), hi(3, e), il(5, e, e.return));
        break;
      case 1:
        Mt(t, e), Tt(e), l & 512 && (Fe || a === null || ga(a, a.return)), l & 64 && Ua && (e = e.updateQueue, e !== null && (l = e.callbacks, l !== null && (a = e.shared.hiddenCallbacks, e.shared.hiddenCallbacks = a === null ? l : a.concat(l))));
        break;
      case 26:
        var n = ca;
        if (Mt(t, e), Tt(e), l & 512 && (Fe || a === null || ga(a, a.return)), l & 4) {
        ...
        break;
      case 27:
        Mt(t, e), Tt(e), l & 512 && (Fe || a === null || ga(a, a.return)), a !== null && l & 4 && Du(e, e.memoizedProps, a.memoizedProps);
        break;
      case 5:
        if (Mt(t, e), Tt(e), l & 512 && (Fe || a === null || ga(a, a.return)), e.flags & 32) {
          n = e.stateNode;
          try {
            Xt(n, "");
          } catch (G) {
      ...
      case 6:
        ...
        break;
      case 3:
        if (Ws = null, n = ca, ca = Ks(t.containerInfo), Mt(t, e), ca = n, Tt(e), l & 4 && a !== null && a.memoizedState.isDehydrated) try {
          zn(t.containerInfo);
        } catch (G) {
          je(e, e.return, G);
        }
        ...
        break;
      case 4:
        l = ca, ca = Ks(e.stateNode.containerInfo), Mt(t, e), Tt(e), ca = l;
        break;
      case 12:
        Mt(t, e), Tt(e);
        break;
      case 31:
        Mt(t, e), Tt(e), l & 4 && (l = e.updateQueue, l !== null && (e.updateQueue = null, Cs(e, l)));
        break;
      case 13:
        Mt(t, e), Tt(e), e.child.flags & 8192 && e.memoizedState !== null != (a !== null && a.memoizedState !== null) && (Us = bt()), l & 4 && (l = e.updateQueue, l !== null && (e.updateQueue = null, Cs(e, l)));
        break;
      case 22:
        n = e.memoizedState !== null;
        var d = a !== null && a.memoizedState !== null, y = Ua, E = Fe;
        if (Ua = y || n, Fe = E || d, Mt(t, e), Fe = E, Ua = y, Tt(e), l & 8192) e: for (t = e.stateNode, t._visibility = n ? t._visibility & -2 : t._visibility | 1, n && (a === null || d || Ua || Fe || Ql(e)), a = null, t = e; ; ) {
          if (t.tag === 5 || t.tag === 26) {
            if (a === null) {
              d = a = t;
              try {
                if (i = d.stateNode, n) c = i.style, typeof c.setProperty == "function" ? c.setProperty("display", "none", "important") : c.display = "none";
                  ...
                  u = d.stateNode;
                  var k = d.memoizedProps.style, N = k != null && k.hasOwnProperty("display") ? k.display : null;
            ...
            if (a === null) {
              ...
              try {
                var A = d.stateNode;
                n ? uf(A, true) : uf(d.stateNode, false);
              } catch (G) {
                je(d, d.return, G);
              }
            }
  ...
  } }, b1 = typeof WeakMap == "function" ? WeakMap : Map, _e = 0, Re = null, ue = null, re = 0, Ae = 0, Ht = null, sl = false, _n = false, Gu = false, La = 0, qe = 0, cl = 0, Vl = 0, qu = 0, Bt = 0, Nn = 0, yi = null, zt = null, Xu = false, Us = 0, w0 = 0, Hs = 1 / 0, Bs = null, ul = null, at = 0, ol = null, Sn = null, Ga = 0, Zu = 0, Qu = null, A0 = null, vi = 0, Vu = null;
  function Yt() {
    return (_e & 2) !== 0 && re !== 0 ? re & -re : S.T !== null ? Fu() : Ka();
  }
  function j0() {
  ...
  function kt(e, t, a) {
    (e === Re && (Ae === 2 || Ae === 9) || e.cancelPendingCommit !== null) && (wn(e, 0), rl(e, re, Bt, false)), Sl(e, a), ((_e & 2) === 0 || e !== Re) && (e === Re && ((_e & 2) === 0 && (Vl |= a), qe === 4 && rl(e, re, Bt, false)), ba(e));
  }
  function E0(e, t, a) {
  ...
  function M0(e, t, a, l, n, i, c, u, d, y, E, k, N, A) {
    if (e.timeoutHandle = -1, k = t.subtreeFlags, k & 8192 || (k & 16785408) === 16785408) {
      k = { stylesheets: null, count: 0, imgCount: 0, imgBytes: 0, suspenseyImages: [], waitingForImages: true, waitingForViewTransition: false, unsuspend: tt }, v0(t, i, k);
      var G = (i & 62914560) === i ? Us - bt() : (i & 4194048) === i ? w0 - bt() : 0;
      if (G = lh(k, G), G !== null) {
        Ga = i, e.cancelPendingCommit = G(U0.bind(null, e, t, i, a, l, n, c, u, d, E, k, null, N, A)), rl(e, i, c, !y);
        return;
      }
    }
  ...
  function wn(e, t) {
    ...
    a !== -1 && (e.timeoutHandle = -1, Y1(a)), a = e.cancelPendingCommit, a !== null && (e.cancelPendingCommit = null, a()), Ga = 0, Ju(), Re = e, ue = a = Ma(e.current, null), re = t, Ae = 0, Ht = null, sl = false, _n = da(e, t), Gu = false, Nn = Bt = qu = Vl = cl = qe = 0, zt = yi = null, Xu = false, (t & 8) !== 0 && (t |= t & 32);
  ...
  function T0(e, t) {
    ne = null, S.H = di, t === mn || t === hs ? (t = Qr(), Ae = 3) : t === Ic ? (t = Qr(), Ae = 4) : Ae = t === Au ? 8 : t !== null && typeof t == "object" && typeof t.then == "function" ? 6 : 1, Ht = t, ue === null && (qe = 1, Ms(e, Qt(t, e.current)));
  }
  function z0() {
    var e = Dt.current;
        ...
        if (Ae !== 0 && ue !== null) {
          ...
          switch (Ae) {
            ...
            case 6:
              ...
              var y = Ae;
              if (Ae = 0, Ht = null, An(e, u, d, y), a && _n) {
                c = 0;
                break e;
              }
              break;
            default:
              y = Ae, Ae = 0, Ht = null, An(e, u, d, y);
          }
        }
        v1(), c = qe;
        break;
        ...
        if (Ae !== 0 && ue !== null) {
          ...
          t: switch (Ae) {
            ...
            case 4:
              ...
              break e;
            case 7:
              Xr(i) ? (Ae = 0, Ht = null, C0(t)) : (Ae = 0, Ht = null, An(e, t, i, 7));
              break;
            case 5:
              var c = null;
              switch (ue.tag) {
              ...
              Ae = 0, Ht = null, An(e, t, i, 5);
              break;
            case 6:
              Ae = 0, Ht = null, An(e, t, i, 6);
              break;
            case 8:
              Ju(), qe = 6;
              break e;
  ...
  function C0(e) {
    ...
    switch (t.tag) {
      case 15:
      case 0:
        t = Id(a, t, t.pendingProps, t.type, void 0, re);
        break;
      case 11:
        t = Id(a, t, t.pendingProps, t.type.render, t.ref, re);
        break;
      case 5:
        ou(t);
      default:
  ...
  function U0(e, t, a, l, n, i, c, u, d) {
    ...
    if (t !== null) {
      ...
      if (i = t.lanes | t.childLanes, i |= Uc, yc(e, a, i, c, u, d), e === Re && (ue = Re = null, re = 0), Sn = t, ol = e, Ga = a, Zu = i, Qu = n, A0 = l, (t.subtreeFlags & 10256) !== 0 || (t.flags & 10256) !== 0 ? (e.callbackNode = null, e.callbackPriority = 0, j1(Rt, function() {
        return G0(), null;
          ...
          if (c !== u && u && u.ownerDocument && Nr(u.ownerDocument.documentElement, u)) {
            if (d !== null && kc(u)) {
              ...
              if (E === void 0 && (E = y), "selectionStart" in u) u.selectionStart = y, u.selectionEnd = Math.min(E, u.value.length);
                ...
                var k = u.ownerDocument || document, N = k && k.defaultView || window;
                if (N.getSelection) {
                  var A = N.getSelection(), G = u.textContent.length, K = Math.min(d.start, G), ze = d.end === void 0 ? K : Math.min(d.end, G);
                  !A.extend && K > ze && (c = ze, ze = K, K = c);
                  var x = _r(u, K), f = _r(u, ze);
                  if (x && f && (A.rangeCount !== 1 || A.anchorNode !== x.node || A.anchorOffset !== x.offset || A.focusNode !== f.node || A.focusOffset !== f.offset)) {
                    var b = k.createRange();
                    b.setStart(x.node, x.offset), A.removeAllRanges(), K > ze ? (A.addRange(b), A.extend(f.node, f.offset)) : (b.setEnd(f.node, f.offset), A.addRange(b));
                  }
                }
              }
            }
            for (k = [], A = u; A = A.parentNode; ) A.nodeType === 1 && k.push({ element: A, left: A.scrollLeft, top: A.scrollTop });
            for (typeof u.focus == "function" && u.focus(), u = 0; u < k.length; u++) {
              var T = k[u];
  ...
  function G0() {
    ...
    try {
      ...
      var i = ol, c = Ga;
      if (at = 0, Sn = ol = null, Ga = 0, (_e & 6) !== 0) throw Error(o(331));
      var u = _e;
  ...
  var Xs = null, jn = null, Wu = false, Zs = false, Iu = false, dl = 0;
  function ba(e) {
    e !== jn && e.next === null && (jn === null ? Xs = jn = e : jn = jn.next = e), Zs = true, Wu || (Wu = true, M1());
  }
  function _i(e, t) {
    if (!Iu && Zs) {
      Iu = true;
  ...
  function Z0() {
    ...
    for (var t = bt(), a = null, l = Xs; l !== null; ) {
      ...
      i === 0 ? (l.next = null, a === null ? Xs = n : a.next = n, n === null && (jn = a)) : (a = l, (e !== 0 || (i & 3) !== 0) && (Zs = true)), l = n;
    }
  ...
  function Q0(e, t) {
    ...
    if (t = Re, a = re, a = ra(e, e === t ? a : 0, e.cancelPendingCommit !== null || e.timeoutHandle !== -1), l = e.callbackNode, a === 0 || e === t && (Ae === 2 || Ae === 9) || e.cancelPendingCommit !== null) return l !== null && l !== null && Za(l), e.callbackNode = null, e.callbackPriority = 0;
    if ((a & 3) === 0 || da(e, a)) {
  ...
  for (var Pu = 0; Pu < Dc.length; Pu++) {
    var eo = Dc[Pu], z1 = eo.toLowerCase(), k1 = eo[0].toUpperCase() + eo.slice(1);
    sa(z1, "on" + k1);
  }
  sa(jr, "onAnimationEnd"), sa(Er, "onAnimationIteration"), sa(Mr, "onAnimationStart"), sa("dblclick", "onDoubleClick"), sa("focusin", "onFocus"), sa("focusout", "onBlur"), sa(Jm, "onTransitionRun"), sa(Km, "onTransitionStart"), sa($m, "onTransitionCancel"), sa(Tr, "onTransitionEnd"), la("onMouseEnter", ["mouseout", "mouseover"]), la("onMouseLeave", ["mouseout", "mouseover"]), la("onPointerEnter", ["pointerout", "pointerover"]), la("onPointerLeave", ["pointerout", "pointerover"]), aa("onChange", "change click focusin focusout input keydown keyup selectionchange".split(" ")), aa("onSelect", "focusout contextmenu dragend focusin keydown keyup mousedown mouseup selectionchange".split(" ")), aa("onBeforeInput", ["compositionend", "keypress", "textInput", "paste"]), aa("onCompositionEnd", "compositionend focusout keydown keypress keyup mousedown".split(" ")), aa("onCompositionStart", "compositionstart focusout keydown keypress keyup mousedown".split(" ")), aa("onCompositionUpdate", "compositionupdate focusout keydown keypress keyup mousedown".split(" "));
  ...
  function oe(e, t) {
    var a = t[Il];
    a === void 0 && (a = t[Il] = /* @__PURE__ */ new Set());
    var l = e + "__bubble";
    a.has(l) || (I0(t, e, 2, false), a.add(l));
  }
  function to(e, t, a) {
    var l = 0;
    t && (l |= 4), I0(a, e, l, t);
  ...
  function I0(e, t, a, l) {
    ...
    a = n.bind(null, t, a, e), n = void 0, !ja || t !== "touchstart" && t !== "touchmove" && t !== "wheel" || (n = true), l ? n !== void 0 ? e.addEventListener(t, a, { capture: true, passive: n }) : e.addEventListener(t, a, true) : n !== void 0 ? e.addEventListener(t, a, { passive: n }) : e.addEventListener(t, a, false);
  }
    ...
    zl(function() {
      ...
      e: {
        ...
        if (N !== void 0) {
          ...
          var K = (t & 4) !== 0, ze = !K && (e === "scroll" || e === "scrollend"), x = K ? N !== null ? N + "Capture" : null : N;
          K = [];
          for (var f = y, b; f !== null; ) {
            var T = f;
            if (b = T.stateNode, T = T.tag, T !== 5 && T !== 26 && T !== 27 || b === null || x === null || (T = Aa(f, x), T != null && K.push(Si(f, T, b))), ze) break;
            f = f.return;
          }
          0 < K.length && (N = new A(N, G, null, a, E), k.push({ event: N, listeners: K }));
        }
      }
      if ((t & 7) === 0) {
        e: {
          if (N = e === "mouseover" || e === "pointerover", A = e === "mouseout" || e === "pointerout", N && a !== vt && (G = a.relatedTarget || a.fromElement) && (qt(G) || G[fa])) break e;
          if ((A || N) && (N = E.window === E ? E : (N = E.ownerDocument) ? N.defaultView || N.parentWindow : window, A ? (G = a.relatedTarget || a.toElement, A = y, G = G ? qt(G) : null, G !== null && (ze = v(G), K = G.tag, G !== ze || K !== 5 && K !== 27 && K !== 6) && (G = null)) : (A = null, G = y), A !== G)) {
            if (K = ir, T = "onMouseLeave", x = "onMouseEnter", f = "mouse", (e === "pointerout" || e === "pointerover") && (K = cr, T = "onPointerLeave", x = "onPointerEnter", f = "pointer"), ze = A == null ? N : ta(A), b = G == null ? N : ta(G), N = new K(T, f + "leave", A, a, E), N.target = ze, N.relatedTarget = b, T = null, qt(E) === y && (K = new K(x, f + "enter", G, a, E), K.target = b, K.relatedTarget = ze, T = K), ze = T, A && G) t: {
              for (K = O1, x = A, f = G, b = 0, T = x; T; T = K(T)) b++;
              T = 0;
              for (var V = f; V; V = K(V)) T++;
              for (; 0 < b - T; ) x = K(x), b--;
              for (; 0 < T - b; ) f = K(f), T--;
              for (; b--; ) {
            ...
            A !== null && F0(k, N, A, K, false), G !== null && ze !== null && F0(k, ze, G, K, true);
          }
        }
        e: {
          if (N = y ? ta(y) : window, A = N.nodeName && N.nodeName.toLowerCase(), A === "select" || A === "input" && N.type === "file") var ge = pr;
          else if (mr(N)) if (xr) ge = Zm;
          else {
            ge = qm;
            var q = Gm;
          }
          else A = N.nodeName, !A || A.toLowerCase() !== "input" || N.type !== "checkbox" && N.type !== "radio" ? y && Zn(y.elementType) && (ge = pr) : ge = Xm;
          if (ge && (ge = ge(e, y))) {
            hr(k, ge, a, E);
            break e;
          }
          q && q(e, N, y), e === "focusout" && y && N.type === "number" && y.memoizedProps.value != null && ct(N, "number", N.value);
        }
        switch (q = y ? ta(y) : window, e) {
          case "focusin":
            (mr(q) || q.contentEditable === "true") && (an = q, Rc = y, Fn = null);
            break;
          case "focusout":
            Fn = Rc = an = null;
            break;
        ...
        de && (ur && a.locale !== "ko" && (tn || de !== "onCompositionStart" ? de === "onCompositionEnd" && tn && (ie = lr()) : (ha = E, Sc = "value" in ha ? ha.value : ha.textContent, tn = true)), q = Vs(y, de), 0 < q.length && (de = new sr(de, e, null, a, E), k.push({ event: de, listeners: q }), ie ? de.data = ie : (ie = fr(a), ie !== null && (de.data = ie)))), (ie = Um ? Hm(e, a) : Bm(e, a)) && (de = Vs(y, "onBeforeInput"), 0 < de.length && (q = new sr("onBeforeInput", "beforeinput", null, a, E), k.push({ event: q, listeners: de }), q.data = ie)), T1(k, e, y, a, E);
      }
      W0(k, t);
    });
  }
  ...
  function Vs(e, t) {
    for (var a = t + "Capture", l = []; e !== null; ) {
      ...
      if (n = n.tag, n !== 5 && n !== 26 && n !== 27 || i === null || (n = Aa(e, a), n != null && l.unshift(Si(e, n, i)), n = Aa(e, t), n != null && l.push(Si(e, n, i))), e.tag === 3) return l;
      e = e.return;
    }
    return [];
  }
  ...
  function F0(e, t, a, l, n) {
    for (var i = t._reactName, c = []; a !== null && a !== l; ) {
      ...
      u !== 5 && u !== 26 && u !== 27 || y === null || (d = y, n ? (y = Aa(a, i), y != null && c.unshift(Si(a, y, d))) : n || (y = Aa(a, i), y != null && c.push(Si(a, y, d)))), a = a.return;
    }
...
`).replace(D1, "");
    ...
    switch (a) {
      ...
      case "formAction":
        if (typeof l == "function") {
          ...
          break;
        } else typeof i == "function" && (a === "formAction" ? (t !== "input" && Te(e, t, "name", n.name, n, null), Te(e, t, "formEncType", n.formEncType, n, null), Te(e, t, "formMethod", n.formMethod, n, null), Te(e, t, "formTarget", n.formTarget, n, null)) : (Te(e, t, "encType", n.encType, n, null), Te(e, t, "method", n.method, n, null), Te(e, t, "target", n.target, n, null)));
  ...
  function xt(e, t, a) {
    switch (t) {
      ...
      case "textarea":
        ...
        return;
      case "option":
        for (d in a) a.hasOwnProperty(d) && (l = a[d], l != null) && (d === "selected" ? e.selected = l && typeof l != "function" && typeof l != "symbol" : Te(e, t, d, l, a, null));
        return;
      case "dialog":
    ...
    for (u in a) a.hasOwnProperty(u) && (l = a[u], l != null && Te(e, t, u, l, a, null));
  }
  function U1(e, t, a, l) {
    switch (t) {
      case "div":
      ...
      case "input":
        ...
        for (A in a) {
          var k = a[A];
          if (a.hasOwnProperty(A) && k != null) switch (A) {
            case "checked":
              break;
            case "value":
              break;
            case "defaultValue":
              d = k;
            default:
              l.hasOwnProperty(A) || Te(e, t, A, null, l, k);
          }
        }
        for (var N in l) {
          var A = l[N];
          if (k = a[N], l.hasOwnProperty(N) && (A != null || k != null)) switch (N) {
            case "type":
              i = A;
              break;
            case "name":
      ...
      case "select":
        ...
        for (i in a) if (d = a[i], a.hasOwnProperty(i) && d != null) switch (i) {
          ...
          case "multiple":
            A = d;
          default:
            l.hasOwnProperty(i) || Te(e, t, i, null, l, d);
        }
        ...
        t = u, a = c, l = A, N != null ? Ce(e, !!a, N, false) : !!l != !!a && (t != null ? Ce(e, !!a, t, true) : Ce(e, !!a, a ? [] : "", false));
        return;
      case "textarea":
        A = N = null;
        ...
        return;
      case "option":
        for (var G in a) N = a[G], a.hasOwnProperty(G) && N != null && !l.hasOwnProperty(G) && (G === "selected" ? e.selected = false : Te(e, t, G, null, l, N));
        for (d in l) N = l[d], A = a[d], l.hasOwnProperty(d) && N !== A && (N != null || A != null) && (d === "selected" ? e.selected = N && typeof N != "function" && typeof N != "symbol" : Te(e, t, d, N, l, A));
        return;
      case "img":
      case "link":
      case "area":
      ...
      case "wbr":
      case "menuitem":
        for (var K in a) N = a[K], a.hasOwnProperty(K) && N != null && !l.hasOwnProperty(K) && Te(e, t, K, null, l, N);
        for (y in l) if (N = l[y], A = a[y], l.hasOwnProperty(y) && N !== A && (N != null || A != null)) switch (y) {
          case "children":
          case "dangerouslySetInnerHTML":
      ...
      default:
        if (Zn(t)) {
          for (var ze in a) N = a[ze], a.hasOwnProperty(ze) && N !== void 0 && !l.hasOwnProperty(ze) && no(e, t, ze, void 0, l, N);
          for (E in l) N = l[E], A = a[E], !l.hasOwnProperty(E) || N === A || N === void 0 && A === void 0 || no(e, t, E, N, l, A);
          return;
        }
    }
    for (var x in a) N = a[x], a.hasOwnProperty(x) && N != null && !l.hasOwnProperty(x) && Te(e, t, x, null, l, N);
    for (k in l) N = l[k], A = a[k], !l.hasOwnProperty(k) || N === A || N == null && A == null || Te(e, t, k, N, l, A);
  }
  function tf(e) {
    switch (e) {
      case "css":
      ...
      for (var e = 0, t = 0, a = performance.getEntriesByType("resource"), l = 0; l < a.length; l++) {
        ...
        if (i && u && tf(c)) {
          for (c = 0, u = n.responseEnd, l += 1; l < a.length; l++) {
            ...
            if (y > u) break;
            var E = d.transferSize, k = d.initiatorType;
            E && tf(k) && (d = d.responseEnd, c += E * (d < u ? 1 : (u - y) / (d - y)));
          }
  ...
  var It = /* @__PURE__ */ new Map(), mf = /* @__PURE__ */ new Set();
  function Ks(e) {
    return typeof e.getRootNode == "function" ? e.getRootNode() : e.nodeType === 9 ? e : e.ownerDocument;
  }
  var qa = H.d;
  H.d = { f: Q1, r: V1, D: J1, C: K1, L: $1, m: W1, X: F1, S: I1, M: P1 };
  function Q1() {
    var e = qa.f(), t = Ys();
    return e || t;
  }
  function V1(e) {
    var t = ea(e);
    t !== null && t.tag === 5 && t.type === "form" ? Td(t) : qa.r(e);
  }
  ...
  function $1(e, t, a) {
    ...
    var l = En;
    if (l && e && t) {
      var n = 'link[rel="preload"][as="' + F(t) + '"]';
      t === "image" && a && a.imageSrcSet ? (n += '[imagesrcset="' + F(a.imageSrcSet) + '"]', typeof a.imageSizes == "string" && (n += '[imagesizes="' + F(a.imageSizes) + '"]')) : n += '[href="' + F(e) + '"]';
      var i = n;
      switch (t) {
        case "style":
          i = Mn(e);
      ...
      It.has(i) || (e = j({ rel: "preload", href: t === "image" && a && a.imageSrcSet ? void 0 : e, as: t }, a), It.set(i, e), l.querySelector(n) !== null || t === "style" && l.querySelector(Ai(i)) || t === "script" && l.querySelector(ji(i)) || (t = l.createElement("link"), xt(t, "link", e), Qe(t), l.head.appendChild(t)));
    }
  }
  function W1(e, t) {
    qa.m(e, t);
    var a = En;
    if (a && e) {
      var l = t && typeof t.as == "string" ? t.as : "script", n = 'link[rel="modulepreload"][as="' + F(l) + '"][href="' + F(e) + '"]', i = n;
      switch (l) {
        case "audioworklet":
        case "paintworklet":
        case "serviceworker":
      ...
      if (!It.has(i) && (e = j({ rel: "modulepreload", href: e }, t), It.set(i, e), a.querySelector(n) === null)) {
        switch (l) {
          case "audioworklet":
          case "paintworklet":
          case "serviceworker":
  ...
  function I1(e, t, a) {
    ...
    var l = En;
    if (l && e) {
      var n = Al(l).hoistableStyles, i = Mn(e);
      t = t || "default";
      var c = n.get(i);
      if (!c) {
        var u = { loading: 0, preload: null };
        if (c = l.querySelector(Ai(i))) u.loading = 5;
        else {
          e = j({ rel: "stylesheet", href: e, "data-precedence": t }, a), (a = It.get(i)) && ho(e, a);
  ...
  function F1(e, t) {
    ...
    var a = En;
    if (a && e) {
      var l = Al(a).hoistableScripts, n = Tn(e), i = l.get(n);
      i || (i = a.querySelector(ji(n)), i || (e = j({ src: e, async: true }, t), (t = It.get(n)) && po(e, t), i = a.createElement("script"), Qe(i), xt(i, "link", e), a.head.appendChild(i)), i = { type: "script", instance: i, count: 1, state: null }, l.set(n, i));
    }
  }
  function P1(e, t) {
    qa.M(e, t);
    ...
    if (a && e) {
      var l = Al(a).hoistableScripts, n = Tn(e), i = l.get(n);
      i || (i = a.querySelector(ji(n)), i || (e = j({ src: e, async: true, type: "module" }, t), (t = It.get(n)) && po(e, t), i = a.createElement("script"), Qe(i), xt(i, "link", e), a.head.appendChild(i)), i = { type: "script", instance: i, count: 1, state: null }, l.set(n, i));
    }
  }
  function pf(e, t, a, l) {
    ...
    switch (e) {
      ...
      case "title":
        return null;
      case "style":
        return typeof a.precedence == "string" && typeof a.href == "string" ? (t = Mn(a.href), a = Al(n).hoistableStyles, l = a.get(t), l || (l = { type: "style", instance: null, count: 0, state: null }, a.set(t, l)), l) : { type: "void", instance: null, count: 0, state: null };
      case "link":
        if (a.rel === "stylesheet" && typeof a.href == "string" && typeof a.precedence == "string") {
          e = Mn(a.href);
          var i = Al(n).hoistableStyles, c = i.get(e);
          if (c || (n = n.ownerDocument || n, c = { type: "stylesheet", instance: null, count: 0, state: { loading: 0, preload: null } }, i.set(e, c), (i = n.querySelector(Ai(e))) && !i._p && (c.instance = i, c.state.loading = 5), It.has(e) || (a = { rel: "preload", as: "style", href: a.href, crossOrigin: a.crossOrigin, integrity: a.integrity, media: a.media, hrefLang: a.hrefLang, referrerPolicy: a.referrerPolicy }, It.set(e, a), i || eh(n, e, a, c.state))), t && l === null) throw Error(o(528, ""));
          return c;
        }
        if (t && l !== null) throw Error(o(529, ""));
        return null;
      case "script":
        return t = a.async, a = a.src, typeof a == "string" && t && typeof t != "function" && typeof t != "symbol" ? (t = Tn(a), a = Al(n).hoistableScripts, l = a.get(t), l || (l = { type: "script", instance: null, count: 0, state: null }, a.set(t, l)), l) : { type: "void", instance: null, count: 0, state: null };
      default:
        throw Error(o(444, e));
    }
  }
  ...
  function gf(e, t, a) {
    if (t.count++, t.instance === null) switch (t.type) {
      case "style":
        var l = e.querySelector('style[data-href~="' + F(a.href) + '"]');
        if (l) return t.instance = l, Qe(l), l;
        var n = j({}, a, { "data-href": a.href, "data-precedence": a.precedence, href: null, precedence: null });
        return l = (e.ownerDocument || e).createElement("style"), Qe(l), xt(l, "style", n), $s(l, a.precedence, e), t.instance = l;
      case "stylesheet":
        n = Mn(a.href);
        var i = e.querySelector(Ai(n));
        if (i) return t.state.loading |= 4, t.instance = i, Qe(i), i;
        l = xf(a), (n = It.get(n)) && ho(l, n), i = (e.ownerDocument || e).createElement("link"), Qe(i);
        var c = i;
        return c._p = new Promise(function(u, d) {
          c.onload = u, c.onerror = d;
        }), xt(i, "link", l), t.state.loading |= 4, $s(i, a.precedence, e), t.instance = i;
      case "script":
        return i = Tn(a.src), (n = e.querySelector(ji(i))) ? (t.instance = n, Qe(n), n) : (l = a, (n = It.get(i)) && (l = j({}, a), po(l, n)), e = e.ownerDocument || e, n = e.createElement("script"), Qe(n), xt(n, "link", l), e.head.appendChild(n), t.instance = n);
      case "void":
        return null;
      default:
  ...
  function ah(e, t, a, l) {
    if (a.type === "stylesheet" && (typeof l.media != "string" || matchMedia(l.media).matches !== false) && (a.state.loading & 4) === 0) {
      if (a.instance === null) {
        var n = Mn(l.href), i = t.querySelector(Ai(n));
        if (i) {
          t = i._p, t !== null && typeof t == "object" && typeof t.then == "function" && (e.count++, e = Is.bind(e), t.then(e, e)), a.state.loading |= 4, a.instance = i, Qe(i);
          return;
        }
        i = t.ownerDocument || t, l = xf(l), (n = It.get(n)) && ho(l, n), i = i.createElement("link"), Qe(i);
        var c = i;
  ...
  var Fs = null;
  function Ps(e, t) {
    e.stylesheets = null, e.unsuspend !== null && (e.count++, Fs = /* @__PURE__ */ new Map(), t.forEach(nh, e), Fs = null, Is.call(e));
  }
  function nh(e, t) {
    if (!(t.state.loading & 4)) {
      ...
      n = t.instance, c = n.getAttribute("data-precedence"), i = a.get(c) || l, i === l && a.set(null, n), a.set(c, n), this.count++, l = Is.bind(this), n.addEventListener("load", l), n.addEventListener("error", l), i ? i.parentNode.insertBefore(n, i.nextSibling) : (e = e.nodeType === 9 ? e.head : e, e.insertBefore(n, e.firstChild)), t.state.loading |= 4;
    }
  }
  ...
  function _f(e, t, a, l, n, i, c, u, d, y, E, k) {
    return e = new ih(e, t, a, c, d, y, E, k, u), t = 1, i === true && (t |= 24), i = Ct(3, null, null, t), e.current = i, i.stateNode = e, t = Kc(), t.refCount++, e.pooledCache = t, t.refCount++, i.memoizedState = { element: l, isDehydrated: a, cache: t }, Fc(i), e;
  }
  function Nf(e) {
    return e ? (e = sn, e) : sn;
  }
  function Sf(e, t, a, l, n, i) {
    n = Nf(n), l.context === null ? l.context = n : l.pendingContext = n, l = tl(t), l.payload = { element: a }, i = i === void 0 ? null : i, i !== null && (l.callback = i), a = al(e, l, t), a !== null && (kt(a, e, t), ii(a, e, t));
  }
  function wf(e, t) {
  ...
  function Af(e) {
    if (e.tag === 13 || e.tag === 31) {
      var t = Cl(e, 67108864);
      t !== null && kt(t, e, 67108864), go(e, 67108864);
    }
  }
  function jf(e) {
    if (e.tag === 13 || e.tag === 31) {
      ...
      if (n === null) lo(e, t, l, tc, a), Mf(e, l);
        ...
        for (; n !== null; ) {
          ...
          if (i !== null) switch (i.tag) {
            ...
            case 31:
            case 13:
              u = Cl(i, 2), u !== null && kt(u, i, 2), Ys(), go(i, 2);
          }
  ...
  var _o = false, ml = null, hl = null, pl = null, Mi = /* @__PURE__ */ new Map(), Ti = /* @__PURE__ */ new Map(), xl = [], uh = "mousedown mouseup touchcancel touchend touchstart auxclick dblclick pointercancel pointerdown pointerup dragend dragstart drop compositionend compositionstart keydown keypress keyup input textInput copy cut paste click change contextmenu reset".split(" ");
  function Mf(e, t) {
    switch (e) {
      case "focusin":
      case "focusout":
  ...
  function zi(e, t, a, l, n, i) {
    return e === null || e.nativeEvent !== i ? (e = { blockedOn: t, domEventName: a, eventSystemFlags: l, nativeEvent: i, targetContainers: [n] }, t !== null && (t = ea(t), t !== null && Af(t)), e) : (e.eventSystemFlags |= l, t = e.targetContainers, n !== null && t.indexOf(n) === -1 && t.push(n), e);
  }
  function oh(e, t, a, l, n) {
    switch (t) {
      ...
      case "gotpointercapture":
        return i = n.pointerId, Ti.set(i, zi(Ti.get(i) || null, e, t, a, l, n)), true;
    }
    return false;
  }
  function Tf(e) {
  ...
  function ac(e) {
    ...
    for (var t = e.targetContainers; 0 < t.length; ) {
      ...
      } else return t = ea(a), t !== null && Af(t), e.blockedOn = a, false;
      t.shift();
    }
    return true;
  }
  ...
  function rh() {
    _o = false, ml !== null && ac(ml) && (ml = null), hl !== null && ac(hl) && (hl = null), pl !== null && ac(pl) && (pl = null), Mi.forEach(zf), Ti.forEach(zf);
  }
  function lc(e, t) {
    e.blockedOn === t && (e.blockedOn = null, _o || (_o = true, r.unstable_scheduleCallback(r.unstable_NormalPriority, rh)));
  }
  var nc = null;
  function kf(e) {
    nc !== e && (nc = e, r.unstable_scheduleCallback(r.unstable_NormalPriority, function() {
      nc === e && (nc = null);
  ...
  function zn(e) {
    ...
    ml !== null && lc(ml, e), hl !== null && lc(hl, e), pl !== null && lc(pl, e), Mi.forEach(t), Ti.forEach(t);
    for (var a = 0; a < xl.length; a++) {
      var l = xl[a];
      l.blockedOn === e && (l.blockedOn = null);
    }
    for (; 0 < xl.length && (a = xl[0], a.blockedOn === null); ) Tf(a), a.blockedOn === null && xl.shift();
    if (a = (e.ownerDocument || e).$$reactFormReplay, a != null) for (l = 0; l < a.length; l += 3) {
      var n = a[l], i = a[l + 1], c = n[dt] || null;
      if (typeof i == "function") c || kf(a);
      else if (c) {
        var u = null;
        ...
        typeof u == "function" ? a[l + 1] = u : (a.splice(l, 3), l -= 3), kf(a);
      }
    }
  }
  function Rf() {
  ...
  ic.prototype.unstable_scheduleHydration = function(e) {
    if (e) {
      ...
      xl.splice(a, 0, e), a === 0 && Tf(e);
    }
  };
  var Of = p.version;
  if (Of !== "19.2.3") throw Error(o(527, Of, "19.2.3"));
  H.findDOMNode = function(e) {
    var t = e._reactInternals;
    if (t === void 0) throw typeof e.render == "function" ? Error(o(188)) : (e = Object.keys(e).join(","), Error(o(268, e)));
    return e = _(t), e = e !== null ? U(e) : null, e = e === null ? null : e.stateNode, e;
  };
...
function Nh() {
  ...
  return r(), Ao.exports = _h(), Ao.exports;
}
var Sh = Nh();
const wh = (r) => r.replace(/([a-z0-9])([A-Z])/g, "$1-$2").toLowerCase(), Ah = (r) => r.replace(/^([A-Z])|[\s-_]+(\w)/g, (p, h, o) => o ? o.toUpperCase() : h.toLowerCase()), Zf = (r) => {
  const p = Ah(r);
  return p.charAt(0).toUpperCase() + p.slice(1);
}, lm = (...r) => r.filter((p, h, o) => !!p && p.trim() !== "" && o.indexOf(p) === h).join(" ").trim(), jh = (r) => {
  for (const p in r) if (p.startsWith("aria-") || p === "role" || p === "title") return true;
};
...
const Mh = w.forwardRef(({ color: r = "currentColor", size: p = 24, strokeWidth: h = 2, absoluteStrokeWidth: o, className: g = "", children: v, iconNode: M, ...C }, z) => w.createElement("svg", { ref: z, ...Eh, width: p, height: p, stroke: r, strokeWidth: o ? Number(h) * 24 / Number(p) : h, className: lm("lucide", g), ...!v && !jh(C) && { "aria-hidden": "true" }, ...C }, [...M.map(([_, U]) => w.createElement(_, U)), ...Array.isArray(v) ? v : [v]]));
const Y = (r, p) => {
  const h = w.forwardRef(({ className: o, ...g }, v) => w.createElement(Mh, { ref: v, iconNode: p, className: lm(`lucide-${wh(Zf(r))}`, `lucide-${r}`, o), ...g }));
  return h.displayName = Zf(r), h;
};
const Th = [["path", { d: "M22 12h-2.48a2 2 0 0 0-1.93 1.46l-2.35 8.36a.25.25 0 0 1-.48 0L9.24 2.18a.25.25 0 0 0-.48 0l-2.35 8.36A2 2 0 0 1 4.49 12H2", key: "169zse" }]], Ro = Y("activity", Th);
const zh = [["path", { d: "M12 5v14", key: "s699le" }], ["path", { d: "m19 12-7 7-7-7", key: "1idqje" }]], kh = Y("arrow-down", zh);
...
const Ih = [["path", { d: "M7 16.3c2.2 0 4-1.83 4-4.05 0-1.16-.57-2.26-1.71-3.19S7.29 6.75 7 5.3c-.29 1.45-1.14 2.84-2.29 3.76S3 11.1 3 12.25c0 2.22 1.8 4.05 4 4.05z", key: "1ptgy4" }], ["path", { d: "M12.56 6.6A10.97 10.97 0 0 0 14 3.02c.5 2.5 2 4.9 4 6.5s3 3.5 3 5.5a6.98 6.98 0 0 1-11.91 4.97", key: "1sl1rz" }]], Yo = Y("droplets", Ih);
const Fh = [["path", { d: "M12 6a2 2 0 0 1 3.414-1.414l6 6a2 2 0 0 1 0 2.828l-6 6A2 2 0 0 1 12 18z", key: "b19h5q" }], ["path", { d: "M2 6a2 2 0 0 1 3.414-1.414l6 6a2 2 0 0 1 0 2.828l-6 6A2 2 0 0 1 2 18z", key: "h7h5ge" }]], Ph = Y("fast-forward", Fh);
...
const Ap = [["path", { d: "m8 3 4 8 5-5 5 15H2L8 3z", key: "otkl63" }]], dc = Y("mountain", Ap);
const jp = [["path", { d: "M20.341 6.484A10 10 0 0 1 10.266 21.85", key: "1enhxb" }], ["path", { d: "M3.659 17.516A10 10 0 0 1 13.74 2.152", key: "1crzgf" }], ["circle", { cx: "12", cy: "12", r: "3", key: "1v7zrd" }], ["circle", { cx: "19", cy: "5", r: "2", key: "mhkx31" }], ["circle", { cx: "5", cy: "19", r: "2", key: "v8kfzx" }]], Vo = Y("orbit", jp);
...
const Tp = [["rect", { width: "18", height: "18", x: "3", y: "3", rx: "2", key: "afitv7" }], ["path", { d: "M3 9h18", key: "1pudct" }], ["path", { d: "M9 21V9", key: "1oto5p" }]], zp = Y("panels-top-left", Tp);
const kp = [["path", { d: "M5 5a2 2 0 0 1 3.008-1.728l11.997 6.998a2 2 0 0 1 .003 3.458l-12 7A2 2 0 0 1 5 19z", key: "10ikf1" }]], Rp = Y("play", kp);
...
const Ip = [["path", { d: "m10 20-1.25-2.5L6 18", key: "18frcb" }], ["path", { d: "M10 4 8.75 6.5 6 6", key: "7mghy3" }], ["path", { d: "m14 20 1.25-2.5L18 18", key: "1chtki" }], ["path", { d: "m14 4 1.25 2.5L18 6", key: "1b4wsy" }], ["path", { d: "m17 21-3-6h-4", key: "15hhxa" }], ["path", { d: "m17 3-3 6 1.5 3", key: "11697g" }], ["path", { d: "M2 12h6.5L10 9", key: "kv9z4n" }], ["path", { d: "m20 10-1.5 2 1.5 2", key: "1swlpi" }], ["path", { d: "M22 12h-6.5L14 15", key: "1mxi28" }], ["path", { d: "m4 10 1.5 2L4 14", key: "k9enpj" }], ["path", { d: "m7 21 3-6-1.5-3", key: "j8hb9u" }], ["path", { d: "m7 3 3 6h4", key: "1otusx" }]], Ko = Y("snowflake", Ip);
const Fp = [["path", { d: "M11.017 2.814a1 1 0 0 1 1.966 0l1.051 5.558a2 2 0 0 0 1.594 1.594l5.558 1.051a1 1 0 0 1 0 1.966l-5.558 1.051a2 2 0 0 0-1.594 1.594l-1.051 5.558a1 1 0 0 1-1.966 0l-1.051-5.558a2 2 0 0 0-1.594-1.594l-5.558-1.051a1 1 0 0 1 0-1.966l5.558-1.051a2 2 0 0 0 1.594-1.594z", key: "1s2grr" }], ["path", { d: "M20 2v4", key: "1rf3ol" }], ["path", { d: "M22 4h-4", key: "gwowj6" }], ["circle", { cx: "4", cy: "20", r: "2", key: "6kqj1y" }]], Lt = Y("sparkles", Fp);
...
const tx = [["path", { d: "M12 2v8", key: "1q4o3n" }], ["path", { d: "m4.93 10.93 1.41 1.41", key: "2a7f42" }], ["path", { d: "M2 18h2", key: "j10viu" }], ["path", { d: "M20 18h2", key: "wocana" }], ["path", { d: "m19.07 10.93-1.41 1.41", key: "15zs5n" }], ["path", { d: "M22 22H2", key: "19qnx5" }], ["path", { d: "m8 6 4-4 4 4", key: "ybng9g" }], ["path", { d: "M16 18a4 4 0 0 0-8 0", key: "1lzouq" }]], Io = Y("sunrise", tx);
...
const rx = [["path", { d: "M14 4v10.54a4 4 0 1 1-4 0V4a2 2 0 0 1 4 0Z", key: "17jzev" }]], Fo = Y("thermometer", rx);
...
\u63A5\u7D9A\u5B8C\u4E86\u3002\u3088\u3046\u3053\u305D\u3001\u65B0\u3057\u3044\u795E\u3088\u3002` };
const uc = (r, p = ["FIRE", "WATER"]) => {
  const h = [], o = ye.attributes.filter((v) => p.includes(v.id)), g = o.length > 0 ? o : [ye.attributes[0]];
  for (let v = 0; v < r; v++) {
    const M = Math.floor(Math.random() * g.length);
    h.push(g[M].id);
  }
  return h;
}, cm = ({ level: r = 1, isAttacking: p = false, dialogue: h = "", isIdle: o = false }) => {
  const [g, v] = w.useState(0), [M, C] = w.useState(""), [z, _] = w.useState(false), [U, j] = w.useState([]);
  w.useEffect(() => {
    const X = setInterval(() => {
      v((pe) => (pe + 1) % 4);
    }, 200);
  ...
  const $ = (X) => X >= 500 ? 8 : X >= 200 ? 7 : X >= 100 ? 6 : X >= 50 ? 5 : X >= 20 ? 4 : X >= 10 ? 3 : X >= 5 ? 2 : 1, J = (X) => {
    if (X && X.stopPropagation(), _(true), setTimeout(() => _(false), 500), X) {
      const ke = X.currentTarget.getBoundingClientRect(), xe = X.clientX - ke.left, fe = X.clientY - ke.top, he = { id: Date.now(), x: xe, y: fe };
      j((se) => [...se, he]), setTimeout(() => j((se) => se.filter((W) => W.id !== he.id)), 1e3);
    }
    const pe = ["\u304D\u3085\u301C\uFF01", "\u3082\u3063\u3068\u64AB\u3067\u3066\uFF01", "\u6211\u304C\u4E3B\u3088...", "\u529B\u304C...\u6E67\u3044\u3066\u304F\u308B...", "\u3093\u3075\u3075..."];
    C(pe[Math.floor(Math.random() * pe.length)]), setTimeout(() => C(""), 1500);
  }, Z = $(r), ae = Z >= 8 ? 80 : 40 + Z * 8;
  return s.jsxs("div", { className: "relative", style: { width: ae, height: ae }, children: [M && s.jsx("div", { className: `absolute -top-16 left-1/2 -translate-x-1/2 w-32 ${Z >= 8 ? "bg-yellow-400 text-black border-white" : "bg-white text-black border-neon-purple"} p-2 rounded-xl text-[10px] font-black italic shadow-2xl border-2 animate-in slide-in-from-bottom-2 fade-in`, children: s.jsxs("div", { className: "relative", children: [M, s.jsx("div", { className: `absolute -bottom-4 left-1/2 -translate-x-1/2 border-8 border-transparent ${Z >= 8 ? "border-t-yellow-400" : "border-t-white"}` })] }) }), s.jsx("div", { className: `
                    absolute inset-0 transition-all duration-200
                    ${p ? "animate-bounce" : ""}
                    ${o ? "animate-sleep-breath opacity-80" : ""}
                    ${z ? "scale-110 rotate-3 filter brightness-125" : ""}
                    cursor-pointer hover:scale-105
                `, onClick: J, style: { transform: `translateY(${Math.sin(g * 0.5) * 2}px)` }, children: Z === 1 ? s.jsxs("svg", { viewBox: "0 0 32 32", className: "w-full h-full", children: [s.jsx("rect", { x: "8", y: "12", width: "16", height: "12", fill: "#3b82f6" }), s.jsx("rect", { x: "20", y: "8", width: "8", height: "8", fill: "#3b82f6" }), o ? s.jsx("rect", { x: "24", y: "11", width: "2", height: "1", fill: "#000", opacity: "0.6" }) : s.jsx("rect", { x: "24", y: "10", width: "2", height: "2", fill: "#FF0000" }), s.jsx("polygon", { points: "8,12 4,8 4,16", fill: "#60a5fa", opacity: "0.8" }), s.jsx("polygon", { points: "24,12 28,8 28,16", fill: "#60a5fa", opacity: "0.8" }), s.jsx("rect", { x: "4", y: "16", width: "4", height: "4", fill: "#3b82f6" }), s.jsx("rect", { x: "2", y: "18", width: "2", height: "2", fill: "#3b82f6" })] }) : s.jsxs("div", { className: "relative w-full h-full group", children: [Z >= 8 && s.jsx("div", { className: "absolute inset-0 bg-yellow-400/40 blur-3xl animate-soul rounded-full" }), s.jsx("img", { src: `/assets/dragon/stage_${Math.min(Z, 8)}.png`, alt: `Dragon Stage ${Z}`, className: `w-full h-full object-contain ${Z >= 8 ? "drop-shadow-[0_0_30px_rgba(255,215,0,0.8)]" : "drop-shadow-2xl"}`, onError: (X) => {
    X.target.onerror = null, X.target.style.display = "none";
  } }), s.jsx("div", { className: `absolute inset-0 bg-gradient-to-t ${Z >= 5 ? "from-yellow-400/20" : "from-neon-purple/20"} to-transparent rounded-2xl pointer-events-none` })] }) }), Z >= 5 && s.jsx("div", { className: "absolute inset-0 rounded-full blur-md animate-pulse pointer-events-none", style: { background: `radial-gradient(circle, ${Z >= 8 ? "rgba(255, 255, 255, 0.4)" : "rgba(255, 215, 0, 0.3)"} 0%, transparent 70%)`, transform: "scale(1.8)" } }), s.jsxs("div", { className: `absolute -bottom-2 -right-2 ${Z >= 8 ? "bg-yellow-500" : "bg-neon-purple"} text-white text-[8px] font-bold px-2 rounded-full border border-white/20 shadow-lg`, children: ["Lv.", r] }), o && s.jsxs("div", { className: "absolute -top-4 -right-2 pointer-events-none", children: [s.jsx("div", { className: "animate-zzz text-white/40 font-black text-xs absolute", style: { animationDelay: "0s" }, children: "Z" }), s.jsx("div", { className: "animate-zzz text-white/30 font-black text-[10px] absolute", style: { animationDelay: "1.5s", right: "-10px", top: "5px" }, children: "Z" })] }), U.map((X) => s.jsx("div", { className: "absolute text-neon-pink text-xs animate-float-up font-bold pointer-events-none", style: { left: X.x, top: X.y }, children: "\u2665" }, X.id))] });
}, Nx = () => {
  const [r, p] = w.useState(false), [h, o] = w.useState("medium"), g = w.useCallback((M = "medium") => {
    o(M), p(true), setTimeout(() => p(false), M === "high" ? 500 : 200);
  }, []);
  return { shakeClass: r ? h === "high" ? "animate-shake-hard" : h === "medium" ? "animate-shake" : "animate-shake-soft" : "", triggerShake: g };
}, If = { FIRE: Di, WATER: Yo, THUNDER: oa, WIND: tr, LIGHT: Wo, DARK: rc, ICE: Ko, EARTH: dc, TOXIC: gc, GRAVITY: Vo, SOUL: hc, METAL: Hi, BLOOD: qo, TIME: Xo, SPACE: Jo, NATURE: Qo, STORM: Do, STAR: $o, HOLY: Lt, CHAOS: Bo, MAGMA: Di, STEAM: Uo, PLASMA: oa, QUAKE: dc, ZERO: Fo, AURA: er, MIRROR: Zo, ECHO: bc, ABYSS: rc, ZENITH: Io, PULSE: Ro, DRAGON: Ho, FEATHER: Lo, PETAL: Go, BONE: Oo, GEAR: xc, NEON: Po, PIXEL: Co, VIRUS: mc, CORE: Jl }, Ff = (r) => {
  if (r < 1e3) return Math.floor(r).toString();
  const p = ["", "k", "M", "B", "T", "P", "E"], h = Math.floor(("" + Math.floor(r)).length / 3);
  let o = parseFloat((h !== 0 ? r / Math.pow(1e3, h) : r).toPrecision(3));
  return o % 1 != 0 && (o = o.toFixed(1)), o + p[h];
}, Sx = ({ currentSpell: r, currentProgress: p, monsterHealth: h = 0, monsterMaxHealth: o = 100, combo: g, isFever: v, dragonLevel: M = 1, chantBreakGauge: C = 0, isSpellComplete: z = false, monsterElement: _ = "FIRE", bossName: U = null, stageData: j = {}, stageIndex: $ = 1, lastDamage: J = 0, familiarDialogue: Z = "", isVictorious: ae = false, keyMapping: X = [], equippedElements: pe = [] }) => {
  var _a;
  const [ke, xe] = Ci.useState(false), [fe, he] = Ci.useState([]), { shakeClass: se, triggerShake: W } = Nx();
  Ci.useEffect(() => {
    if (J > 0) {
      xe(true), W(J > o * 0.1 ? "high" : "medium"), setTimeout(() => xe(false), 150);
  ...
  const le = w.useMemo(() => j.image || "/assets/glitch_phantom.jpg", [j]), Le = w.useMemo(() => o > 0 ? h / o * 100 : 0, [h, o]), ot = w.useMemo(() => s.jsxs("div", { className: `
            relative 
            ${j.isBoss ? "w-48 h-48 md:w-56 md:h-56" : "w-32 h-32 md:w-40 md:h-40"} 
            ${z ? "animate-shake" : "animate-bounce"}
            ${ke ? "animate-hit-flash brightness-[4] scale-95" : ""}
            ${ae ? "opacity-0 scale-150 transition-all duration-1000" : ""}
            transition-all duration-150
        `, children: [s.jsx("img", { src: le, alt: "Monster", className: `w-full h-full object-cover rounded-full border-4 ${j.isBoss ? "border-red-600 shadow-[0_0_50px_rgba(255,0,0,0.8)]" : "border-neon-purple shadow-[0_0_30px_rgba(168,85,247,0.6)]"}` }), j.isBoss && s.jsx("div", { className: "absolute -top-4 -right-4 bg-red-600 text-white font-black px-2 py-1 rounded text-xs animate-pulse", children: "WARNING" }), s.jsx("div", { className: "absolute inset-0 rounded-full bg-gradient-to-t from-black/40 to-transparent pointer-events-none" }), fe.map((Ne) => s.jsx("div", { className: "absolute inset-0 flex items-center justify-center pointer-events-none", style: { transform: `translate(${Ne.x}px, ${Ne.y}px)` }, children: s.jsx("span", { className: "text-4xl font-black text-white italic drop-shadow-[0_0_10px_rgba(255,255,255,0.8)] animate-float-up", children: Math.floor(Ne.damage) }) }, Ne.id))] }), [le, j.isBoss, fe, z, ke, ae]);
  return s.jsxs("div", { className: `
      relative w-full h-full flex flex-col items-center justify-between p-4 overflow-hidden
      ${v ? "animate-fever-bg" : ""}
      ${se}
      transition-colors duration-500
    `, children: [s.jsx("div", { className: "absolute inset-0 z-0 opacity-40 mix-blend-overlay bg-center bg-cover pointer-events-none transition-all duration-1000", style: { backgroundImage: `url(${j.bg || "/assets/deep_web_arena_bg.png"})` } }), s.jsx("div", { className: "absolute inset-0 z-0 bg-gradient-to-t from-black via-transparent to-black pointer-events-none" }), s.jsxs("div", { className: "flex-1 flex flex-col items-center justify-center relative z-10 w-full", children: [s.jsx("div", { className: "absolute top-4 w-full flex items-center justify-between px-6", children: s.jsxs("div", { className: "flex flex-col", children: [s.jsxs("span", { className: "text-[8px] md:text-[10px] font-black text-neon-cyan tracking-widest uppercase", children: ["STAGE : ", String($).padStart(2, "0")] }), s.jsx("div", { className: "flex items-center gap-2", children: s.jsx("span", { className: "text-xl md:text-2xl font-black text-white italic tracking-tighter drop-shadow-lg", children: U || j.name || "\u6DF1\u6DF5\u306E\u30C7\u30B8\u30BF\u30EB\u30B0\u30EA\u30C3\u30C1" }) })] }) }), s.jsx("div", { className: "absolute bottom-1/4 left-10 transform scale-150", children: s.jsx(cm, { level: M, isAttacking: z, dialogue: Z }) }), s.jsxs("div", { className: `
                  relative p-4 transform transition-transform duration-300
                  ${v ? "animate-pulse" : ""}
                  ${z ? "scale-90" : "scale-100"}
                `, children: [ot, s.jsx("div", { className: "absolute -bottom-10 left-1/2 -translate-x-1/2 w-48 max-w-md space-y-2", children: s.jsxs("div", { className: "h-6 w-full bg-black/40 rounded-full border border-white/10 overflow-hidden relative shadow-inner", children: [s.jsx("div", { className: "h-full bg-gradient-to-r from-red-600 to-red-400 transition-all duration-300 relative", style: { width: `${Le}%` }, children: s.jsx("div", { className: "absolute inset-0 bg-white/20 animate-pulse" }) }), s.jsx("div", { className: "absolute inset-0 flex items-center justify-center pointer-events-none", children: s.jsxs("span", { className: "text-[10px] font-black text-white drop-shadow-[0_1px_2px_rgba(0,0,0,0.8)] tracking-widest uppercase", children: [Ff(h), " / ", Ff(o), " HP"] }) })] }) }), s.jsxs("div", { className: "absolute top-0 right-0 z-20 transform translate-x-1/2 -translate-y-1/2 flex flex-col items-center gap-1 group", children: [s.jsx("div", { className: `
                            w-14 h-14 rounded-full border-4 border-white shadow-xl flex items-center justify-center
                            bg-gradient-to-br ${((_a = ye.attributes.find((Ne) => Ne.id === _)) == null ? void 0 : _a.color) || "from-gray-500 to-gray-700"}
                            animate-bounce
                        `, children: (() => {
    const Ne = ye.attributes.find((Pe) => Pe.id === _), Ee = If[Ne == null ? void 0 : Ne.id] || Di;
    return s.jsx(Ee, { size: 28, className: "text-white drop-shadow-md" });
  })() }), s.jsxs("div", { className: "opacity-0 group-hover:opacity-100 transition-opacity bg-black/80 backdrop-blur-md px-2 py-1 rounded border border-white/20 text-[8px] font-bold text-white whitespace-nowrap", children: ["Weak to: ", _ === "FIRE" ? "WATER" : _ === "WATER" ? "THUNDER" : _ === "THUNDER" ? "EARTH" : _ === "EARTH" ? "WIND" : _ === "WIND" ? "FIRE" : "???"] })] })] }), g > 0 && s.jsxs("div", { className: `
    ...
    return s.jsxs("div", { className: "flex flex-col items-center gap-2", children: [s.jsxs("div", { className: `
                                ...
                                `, children: S || "?" })] }, Ee);
  }) })] }), ae && s.jsx("div", { className: "absolute inset-0 z-[200] flex items-center justify-center bg-black/40 backdrop-blur-sm animate-in fade-in duration-500", children: s.jsxs("div", { className: "flex flex-col items-center gap-4", children: [s.jsx("div", { className: "text-5xl md:text-7xl font-black text-white italic tracking-tighter animate-stage-clear drop-shadow-[0_0_30px_rgba(255,255,255,0.8)]", children: "STAGE CLEAR!" }), s.jsx("div", { className: "px-6 py-2 bg-neon-cyan/80 text-black font-black uppercase tracking-widest rounded-full animate-bounce", children: "\u3054\u307B\u3046\u3073 \u30B2\u30C3\u30C8\uFF01" })] }) }), v && s.jsx("div", { className: "absolute inset-0 pointer-events-none flex items-center justify-center z-[100]", children: s.jsx("div", { className: "text-6xl font-black text-white italic animate-fever-text drop-shadow-[0_0_15px_rgba(255,255,255,0.8)] tracking-tighter", children: "\u30D5\u30A3\u30FC\u30D0\u30FC\uFF01\uFF01" }) })] });
}, wx = { Flame: Di, Droplets: Yo, Zap: oa, Wind: tr, Sun: Wo, Moon: rc, Snowflake: Ko, Mountain: dc, Skull: gc, Orbit: Vo, Ghost: hc, Shield: Hi, HeartPulse: qo, Hourglass: Xo, Rocket: Jo, Leaf: Qo, CloudLightning: Do, Star: $o, Sparkles: Lt, Dna: Bo, Cloud: Uo, Thermometer: Fo, Waves: er, Layers: Zo, Volume2: bc, Sunrise: Io, Activity: Ro, Crown: Ho, Feather: Lo, Flower: Go, Bone: Oo, Settings: xc, Tv: Po, Box: Co, Bug: mc, Target: Jl }, Ax = ({ onInput: r, disabled: p, activeElements: h = [], keyMapping: o = [] }) => {
  const g = w.useCallback((v) => {
    p || r(v);
  }, [r, p]);
  return s.jsx("div", { "data-tutorial-id": "magic-keyboard", className: "grid grid-cols-3 gap-3 w-full max-w-sm mx-auto p-4 select-none pb-12", "data-tutorial-target": "magic-keyboard", children: ye.attributes.map((v) => {
    var _a;
    if (!h.includes(v.id)) return null;
    const M = wx[v.icon];
    return s.jsxs("button", { onClick: () => g(v.id), disabled: p, "data-tutorial-id": "magic-button", "data-tutorial-target": `magic-button-${v.id}`, className: `
                            relative h-24 dragon-glass-card flex items-center gap-4 px-6
                            bg-gradient-to-br ${v.color} border-white/40
                            ...
                            touch-none
                        `, children: [s.jsx("div", { className: "w-12 h-12 rounded-xl bg-black/20 flex items-center justify-center border-2 border-white/20", children: s.jsx(M, { size: 28, strokeWidth: 3 }) }), s.jsxs("div", { className: "flex flex-col items-start translate-y-[-1px]", children: [s.jsxs("span", { className: "font-black text-[10px] uppercase tracking-widest opacity-60", children: ["CAST [", (_a = o[h.indexOf(v.id)]) == null ? void 0 : _a.toUpperCase(), "]"] }), s.jsx("span", { className: "font-black text-xl italic tracking-tighter", children: v.name })] }), s.jsx("div", { className: "absolute bottom-2 right-4 flex gap-1 opacity-40", children: [...Array(Math.floor(v.stats.atk / 2))].map((C, z) => s.jsx("div", { className: "w-1 h-3 bg-white/60 rounded-full" }, z)) }), s.jsx("div", { className: "absolute top-0 right-0 w-8 h-8 bg-white/20 rounded-bl-[100%] pointer-events-none" })] }, v.id);
  }) });
}, jx = ({ money: r, idleIncome: p }) => {
  const h = w.useRef(r), [o, g] = w.useState(false), [v, M] = w.useState(false);
  w.useEffect(() => {
    const z = h.current;
    ye.moneyMilestones.find((j) => z < j && r >= j) && setTimeout(() => {
      g(true), setTimeout(() => g(false), 1e3);
    }, 0), r !== z && setTimeout(() => {
      M(true), setTimeout(() => M(false), 600);
    }, 0), h.current = r;
  }, [r]);
  const C = (z) => z >= 1e6 ? `${(z / 1e6).toFixed(2)}M` : z >= 1e3 ? `${(z / 1e3).toFixed(1)}K` : Math.floor(z).toString();
  return s.jsxs("div", { className: "flex flex-col space-y-1 bg-black/40 backdrop-blur-md px-4 py-2 rounded-2xl border border-white/10 shadow-lg", children: [s.jsxs("div", { className: `flex items-center space-x-2 ${v ? "animate-money-pop" : ""}`, children: [s.jsx("div", { className: "p-1 px-3 bg-white text-black text-xs font-black rounded-lg", children: "\u9B54\u529B (MP)" }), s.jsx("div", { className: "text-3xl font-black text-white italic", children: C(r) })] }), p > 0 && s.jsxs("div", { className: "flex items-center space-x-1 text-emerald-400 font-bold text-xs uppercase tracking-widest pl-1", children: [s.jsx(fx, { size: 12 }), s.jsxs("span", { children: ["+", C(p), "/\u79D2"] })] }), o && s.jsx("div", { className: "fixed inset-0 flex items-center justify-center pointer-events-none z-50", children: s.jsx("div", { className: "animate-bounce p-8 rounded-full bg-white/20 backdrop-blur-xl border border-white/50 shadow-2xl", children: s.jsx(Lt, { size: 100, className: "text-white" }) }) })] });
}, Ex = ({ score: r, maxCombo: p, accuracy: h, onRestart: o }) => {
  const v = h >= 95 ? { name: "\u795E\u901F\u306E\u6253\u9375\u58EB", color: "text-yellow-400" } : h >= 80 ? { name: "\u719F\u7DF4\u306E\u9B54\u5C0E\u5E2B", color: "text-purple-400" } : h >= 60 ? { name: "\u898B\u7FD2\u3044\u4FEE\u884C\u4E2D", color: "text-blue-400" } : { name: "\u30AD\u30FC\u30DC\u30FC\u30C9\u306E\u521D\u5FC3\u8005", color: "text-gray-400" };
  return s.jsx("div", { className: "fixed inset-0 z-50 flex items-center justify-center p-6 bg-black/95 backdrop-blur-xl animate-in fade-in zoom-in duration-300 font-sans", children: s.jsxs("div", { className: "w-full max-w-sm dragon-glass-card bg-[#1a1a1a] border-4 border-white/20 p-8 relative overflow-hidden shadow-2xl", children: [s.jsx("div", { className: "absolute top-0 left-1/2 -translate-x-1/2 w-full h-1/2 bg-yellow-500/5 blur-[100px]" }), s.jsxs("div", { className: "text-center mb-10 relative", children: [s.jsx("div", { className: "text-sm font-black text-yellow-500 tracking-[0.4em] uppercase mb-2", children: "\u4F5C\u6226\u5B8C\u4E86" }), s.jsx("h2", { className: "text-6xl font-black text-white italic tracking-tighter drop-shadow-[0_0_20px_rgba(255,255,255,0.4)]", children: "\u9664\u970A\u6210\u529F!!" }), s.jsx("div", { className: "text-xs font-black mt-4 px-4 py-1 rounded-full bg-white text-black inline-block uppercase tracking-widest", children: v.name })] }), s.jsxs("div", { className: "space-y-3 mb-10 relative", children: [s.jsxs("div", { className: "flex items-center justify-between p-4 bg-black/40 rounded-3xl border-2 border-white/5", children: [s.jsxs("div", { className: "flex items-center gap-2 text-white/40", children: [s.jsx(Ui, { size: 16 }), s.jsx("span", { className: "text-[10px] font-black uppercase tracking-widest", children: "\u7372\u5F97\u9B54\u529B" })] }), s.jsxs("div", { className: "text-2xl font-black text-white italic", children: [r.toLocaleString(), " ", s.jsx("span", { className: "text-xs not-italic opacity-40", children: "MP" })] })] }), s.jsxs("div", { className: "flex items-center justify-between p-4 bg-black/40 rounded-3xl border-2 border-white/5", children: [s.jsxs("div", { className: "flex items-center gap-2 text-white/40", children: [s.jsx(oa, { size: 16 }), s.jsx("span", { className: "text-[10px] font-black uppercase tracking-widest", children: "\u6700\u9AD8\u30B3\u30F3\u30DC" })] }), s.jsx("div", { className: "text-2xl font-black text-white italic", children: p })] }), s.jsxs("div", { className: "flex items-center justify-between p-4 bg-black/40 rounded-3xl border-2 border-white/5", children: [s.jsxs("div", { className: "flex items-center gap-2 text-white/40", children: [s.jsx(Jl, { size: 16 }), s.jsx("span", { className: "text-[10px] font-black uppercase tracking-widest", children: "\u7684\u4E2D\u7387" })] }), s.jsxs("div", { className: "text-2xl font-black text-white italic", children: [h, "%"] })] })] }), s.jsxs("div", { className: "grid grid-cols-2 gap-4 relative", children: [s.jsxs("button", { onClick: o, className: "stage-select-btn flex flex-col items-center justify-center p-4 bg-white text-black font-black italic active:translate-y-1 shadow-[0_6px_0_#ccc] active:shadow-none transition-all", children: [s.jsx(Cp, { size: 24, className: "mb-1" }), s.jsx("span", { className: "text-xs", children: "\u518D\u6311\u6226" })] }), s.jsxs("button", { className: "stage-select-btn flex flex-col items-center justify-center p-4 bg-neon-cyan text-black font-black italic active:translate-y-1 shadow-[0_6px_0_#06b6d4] active:shadow-none transition-all", onClick: () => alert("\u7D50\u679C\u3092\u30B7\u30A7\u30A2\u3057\u307E\u3057\u305F\uFF01"), children: [s.jsx(qp, { size: 24, className: "mb-1" }), s.jsx("span", { className: "text-xs", children: "\u30B7\u30A7\u30A2" })] })] }), s.jsx("div", { className: "text-center mt-8 text-white/20 text-[10px] font-bold tracking-widest uppercase", children: "\u30C7\u30B8\u30BF\u30EB\u9664\u970A\u5C40\u6240\u5C5E - \u7B2C12\u652F\u90E8" })] }) });
};
class Mx {
  constructor() {
  ...
  init() {
    ...
    for (const [h, o] of Object.entries(p)) this.sounds[h] = new Audio(o), this.sounds[h].preload = "auto";
    this.bgmList = { home: "/assets/sounds/bgm_home.mp3", battle: "/assets/sounds/bgm_battle.mp3" }, this.initialized = true;
  }
  setEnabled(p) {
    this.enabled = p, !p && this.bgm ? this.bgm.pause() : p && this.bgm && this.bgm.play().catch(() => console.log("BGM play interrupted"));
  }
  setVolume(p) {
  ...
  playSFX(p, h = 1) {
    ...
    const o = this.sounds[p].cloneNode();
    o.volume = this.volume * h, o.play().catch(() => {
    });
  }
  playBGM(p) {
    this.currentBgmKey !== p && (this.bgm && (this.bgm.pause(), this.bgm = null), this.currentBgmKey = p, this.bgmList[p] && (this.bgm = new Audio(this.bgmList[p]), this.bgm.loop = true, this.bgm.volume = this.volume, this.enabled && this.bgm.play().catch(() => {
      console.log("BGM autoplay prevented, will play on next interaction");
    })));
  }
}
const lt = new Mx(), Tx = ({ onComplete: r }) => {
  const [p, h] = w.useState(false), [o, g] = w.useState(false), [v] = w.useState(() => !!localStorage.getItem("magic_idle_money"));
  w.useEffect(() => {
    const C = setTimeout(() => {
      g(true);
    }, 1500);
  ...
  return s.jsxs("div", { className: `
            ...
            `, children: [s.jsx("div", { className: "absolute inset-0 cyber-grid opacity-20" }), s.jsx("div", { className: "absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-neon-purple/20 blur-[120px] rounded-full animate-pulse" }), s.jsxs("div", { className: "relative mb-12 group", children: [s.jsx("div", { className: "absolute inset-0 bg-neon-purple/40 blur-3xl rounded-full animate-pulse-glow" }), s.jsxs("div", { className: "relative w-64 h-64 md:w-80 md:h-80 rounded-[2.5rem] overflow-hidden border-4 border-white/20 shadow-2xl transition-transform duration-500 group-hover:scale-110", children: [s.jsx("img", { src: "/assets/splash_kv.png", alt: "MAGITYPE: ORBITAL Key Visual", className: "w-full h-full object-cover" }), s.jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-black/60 to-transparent" })] })] }), s.jsxs("div", { className: "text-center relative z-10 mb-12", children: [s.jsx("h1", { className: "text-6xl md:text-7xl font-black text-white italic tracking-tighter mb-4 drop-shadow-[0_0_30px_rgba(168,85,247,0.8)]", children: "MAGITYPE" }), s.jsxs("div", { className: "flex items-center justify-center gap-3", children: [s.jsx("div", { className: "h-[2px] w-8 bg-neon-purple-light" }), s.jsx("span", { className: "text-sm text-neon-purple-light font-bold uppercase tracking-[0.4em]", children: "\u9B54\u5C0E\u30D0\u30C8\u30EB\u7248" }), s.jsx("div", { className: "h-[2px] w-8 bg-neon-purple-light" })] })] }), s.jsx("div", { className: "relative z-10 w-full max-w-sm px-6", children: o ? s.jsxs("div", { className: "flex flex-col gap-4 animate-in fade-in zoom-in duration-500", children: [v && s.jsxs("button", { onClick: () => M("continue"), className: "group relative flex items-center justify-center gap-4 py-5 rounded-2xl bg-white text-black font-black text-xl hover:bg-neon-purple hover:text-white transition-all duration-300 shadow-[0_0_40px_rgba(255,255,255,0.2)] hover:shadow-neon-purple/50 active:scale-95", children: [s.jsx(Rp, { size: 24, fill: "currentColor" }), "\u524D\u306E\u307E\u307E\u3067\u904A\u3076", s.jsx("div", { className: "absolute inset-0 rounded-2xl bg-white/20 -translate-x-full group-hover:translate-x-full transition-transform duration-700", style: { clipPath: "polygon(20% 0, 100% 0, 80% 100%, 0 100%)" } })] }), s.jsxs("button", { onClick: () => M("new"), className: `
                                ...
                                ${v ? "bg-white/5 text-white/60 border border-white/10 hover:bg-red-500/20 hover:text-red-400 hover:border-red-500/50" : "bg-white text-black text-xl font-black hover:bg-neon-purple hover:text-white shadow-[0_0_40px_rgba(255,255,255,0.2)]"}
                            `, children: [s.jsx(sm, { size: 20, className: v ? "group-hover:rotate-180 transition-transform duration-500" : "" }), "\u65B0\u3057\u304F\u4F5C\u308A\u76F4\u3059"] }), s.jsxs("div", { className: "mt-4 flex items-center justify-center gap-2 text-white/20 text-[10px] uppercase font-bold tracking-[0.2em]", children: [s.jsx(Ph, { size: 12 }), "\u7269\u8A9E\u3092\u9078\u629E\u3057\u3066\u304F\u3060\u3055\u3044"] })] }) : s.jsx("div", { className: "flex justify-center gap-2 h-24 items-center", children: [0, 1, 2].map((C) => s.jsx("div", { className: "w-3 h-3 rounded-full bg-neon-purple-light animate-bounce", style: { animationDelay: `${C * 0.15}s` } }, C)) }) }), s.jsxs("div", { className: "absolute bottom-10 text-white/40 text-[10px] uppercase font-bold tracking-widest flex items-center gap-4", children: [s.jsx("span", { children: "\xA9 2026 MAGITYPE ORBITAL" }), s.jsx("span", { className: "w-1 h-1 bg-white/20 rounded-full" }), s.jsx("span", { children: "\u7121\u65AD\u8EE2\u8F09\u7981\u6B62" })] })] });
}, zx = ({ isActive: r, onComplete: p }) => {
  const [h, o] = w.useState(0);
  return w.useEffect(() => {
    if (!r) return;
    const g = setInterval(() => {
      o((M) => Math.min(M + 0.1, 1));
    }, 50), v = setTimeout(() => {
      p();
    }, 3e3);
    return () => {
      clearInterval(g), clearTimeout(v), o(0);
    };
  }, [r, p]), r ? s.jsxs("div", { className: "fixed inset-0 z-50 pointer-events-none overflow-hidden", children: [s.jsx("div", { className: "absolute inset-0 bg-black opacity-30 animate-noise-anim", style: { backgroundImage: `url("data:image/svg+xml,%3Csvg viewBox='0 0 400 400' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='noiseFilter'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='2.5' numOctaves='6' stitchTiles='stitch'/%3E%3C/filter%3E%3Crect width='100%25' height='100%25' filter='url(%23noiseFilter)' opacity='0.8'/%3E%3C/svg%3E")`, opacity: h * 0.5 } }), s.jsx("div", { className: "absolute inset-0", children: [...Array(20)].map((g, v) => s.jsx("div", { className: "absolute left-0 right-0 h-1 bg-gradient-to-r from-transparent via-yellow-400 to-transparent", style: { top: `${(v * 5 + h * 100) % 100}%`, opacity: h * 0.6, animation: `scanline-run ${0.5 + v * 0.1}s linear infinite` } }, v)) }), s.jsx("div", { className: "absolute inset-0 bg-[#ffd700]/10 mix-blend-overlay animate-pulse" }), s.jsxs("div", { className: `absolute inset-0 flex flex-col items-center justify-center ${h > 0.5 ? "animate-shake" : ""}`, children: [s.jsx("div", { className: "text-6xl md:text-8xl font-black italic tracking-tighter text-transparent bg-clip-text bg-gradient-to-b from-white via-yellow-200 to-yellow-500 animate-in zoom-in-150 duration-500", style: { textShadow: `0 0 ${20 * h}px rgba(255,215,0,0.8), 0 0 ${40 * h}px rgba(255,215,0,0.4)` }, children: "MANUAL BURST" }), s.jsxs("div", { className: "relative mt-8", children: [s.jsx("div", { className: "text-xl md:text-3xl font-black text-white animate-ping absolute inset-0 opacity-40", children: "\u9023\u6253\u30BB\u30E8\uFF01 MASH!!" }), s.jsx("div", { className: "text-xl md:text-3xl font-black text-white relative z-10 drop-shadow-[0_0_15px_rgba(255,255,255,0.8)]", children: "\u9023\u6253\u30BB\u30E8\uFF01 MASH!!" })] }), s.jsx("div", { className: "mt-8 text-xs md:text-sm font-bold text-neon-cyan bg-black/80 px-8 py-2 rounded-full border-2 border-neon-cyan/50 shadow-[0_0_20px_rgba(0,255,255,0.3)] animate-bounce", children: "\u8A60\u5531\u7834\u68C4\uFF1A\u9AD8\u5BC6\u5EA6\u9B54\u529B\u89E3\u653E\u4E2D\uFF01" })] }), s.jsx("div", { className: "absolute inset-0 bg-yellow-400", style: { opacity: Math.sin(h * Math.PI * 4) * 0.3 * h } }), s.jsx("div", { className: "absolute inset-0", children: [...Array(30)].map((g, v) => {
    const M = v / 30 * Math.PI * 2, C = h * 500;
    return s.jsx("div", { className: "absolute w-2 h-2 bg-yellow-400 rounded-full", style: { left: "50%", top: "50%", transform: `translate(${Math.cos(M) * C}px, ${Math.sin(M) * C}px)`, opacity: 1 - h, boxShadow: "0 0 10px rgba(255, 215, 0, 0.8)" } }, v);
  }) })] }) : null;
...
\u8EE2\u751F\uFF08\u30EA\u30D0\u30FC\u30B9\u30C8\uFF09\u3067\u5F97\u308B\u300C\u9B42\u306E\u6B20\u7247\u300D\u3067\u3001\u3053\u308C\u3092\u9855\u73FE\u3055\u305B\u3088\u3002`, target: "artifact-btn", position: "center", action: "auto" }] }, kx = ({ type: r = "INTRO", onComplete: p, onSkip: h, currentSpell: o, currentProgress: g }) => {
  const [v, M] = w.useState(r === "INTRO"), [C, z] = w.useState(0), [_, U] = w.useState(false), j = w.useMemo(() => Pf[r] || Pf.INTRO, [r]), $ = w.useMemo(() => {
    if (!o || o.length === 0 || g >= o.length) return null;
    const he = o[g], se = ye.attributes.find((W) => W.id === he);
    return se ? { id: he, name: se.name } : null;
  }, [o, g]), J = j[C], Z = C === j.length - 1, ae = Ci.useCallback(() => {
    Z ? p() : z((he) => he + 1);
  }, [Z, p]);
  w.useEffect(() => {
  ...
  if (v) return s.jsxs("div", { className: "fixed inset-0 z-[1000] flex items-center justify-center p-4 font-sans", children: [s.jsx("div", { className: "absolute inset-0 bg-black/90 backdrop-blur-md" }), s.jsxs("div", { className: "relative w-full max-w-md dragon-glass-card bg-[#1a1a1a] border-4 border-white/20 p-8 rounded-3xl shadow-2xl text-center", children: [s.jsx("div", { className: "mb-6 inline-flex p-4 bg-neon-cyan/20 rounded-2xl animate-bounce", children: s.jsx(Lt, { className: "text-neon-cyan", size: 48 }) }), s.jsx("div", { className: "text-[10px] text-neon-purple font-black tracking-[0.4em] uppercase mb-2", children: "\u901A\u9054" }), s.jsx("h2", { className: "text-3xl font-black text-white mb-6 tracking-tighter italic", children: r === "INTRO" ? "\u65B0\u4EBA\u9664\u970A\u5E2B\u7814\u4FEE" : "\u65B0\u3057\u3044\u6A5F\u80FD\u30AC\u30A4\u30C9" }), s.jsx("p", { className: "text-white/80 mb-8 leading-relaxed text-sm font-bold", children: r === "INTRO" ? `\u30C7\u30B8\u30BF\u30EB\u9664\u970A\u5C40\u3078\u3088\u3046\u3053\u305D\u3002
...
\u79C1\u304C\u5C0E\u3044\u3066\u3084\u308D\u3046\u3001\u6E96\u5099\u306F\u3088\u3044\u304B\uFF1F` }), s.jsxs("div", { className: "space-y-3", children: [s.jsx("button", { onClick: X, className: "w-full py-4 rounded-xl font-black text-xl italic bg-white text-black hover:scale-[1.02] active:scale-95 transition-all shadow-[0_4px_0_#ccc]", children: "\u30AC\u30A4\u30C9\u3092\u898B\u308B" }), s.jsx("button", { onClick: pe, className: "w-full py-3 rounded-xl font-bold text-xs text-white/30 hover:text-white transition-colors", children: "\u9589\u3058\u308B" })] })] })] });
  ...
  return s.jsxs("div", { className: "fixed inset-0 z-[1000] pointer-events-none font-sans", children: [s.jsx("div", { className: "absolute inset-0 bg-black/60 pointer-events-none" }), fe && s.jsx("style", { children: `
                ...
                ` }), (J.action === "tap-magic-button" || J.action === "tap-fight-button") && s.jsx("div", { className: `absolute left-1/2 -translate-x-1/2 z-[1260] pointer-events-none ${J.position === "top" ? "top-[40%]" : "bottom-[25%]"}`, children: s.jsx(kh, { size: 64, className: "text-neon-cyan animate-bounce drop-shadow-[0_0_10px_rgba(6,182,212,0.8)]" }) }), s.jsx("div", { className: `absolute ${ke()} w-[90%] max-w-lg z-[1300] pointer-events-none transition-all duration-500 ease-out`, children: s.jsxs("div", { className: "bg-[#1a1a1a] border-2 border-white/20 p-6 rounded-3xl shadow-[0_20px_60px_rgba(0,0,0,0.8)] pointer-events-auto relative overflow-hidden", children: [s.jsx("div", { className: "absolute top-0 right-0 w-32 h-32 bg-neon-cyan/5 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2" }), s.jsxs("div", { className: "flex items-start justify-between mb-4 relative z-10", children: [s.jsxs("div", { className: "flex items-center gap-3", children: [s.jsx("div", { className: "p-1.5 bg-neon-cyan/20 rounded-lg", children: s.jsx(Lt, { className: "text-neon-cyan", size: 16 }) }), s.jsx("h3", { className: "text-lg font-black text-white italic tracking-tight", children: J.title })] }), s.jsx("button", { onClick: h, className: "text-white/30 hover:text-white transition-colors", children: s.jsx(Xa, { size: 20 }) })] }), s.jsx("p", { className: "text-white/90 text-sm font-bold leading-relaxed mb-6 whitespace-pre-line relative z-10", children: xe }), s.jsxs("div", { className: "flex items-center justify-between relative z-10", children: [s.jsx("div", { className: "flex gap-1.5", children: j.map((he, se) => s.jsx("div", { className: `h-1.5 rounded-full transition-all duration-300 ${se === C ? "w-8 bg-neon-cyan shadow-[0_0_10px_rgba(6,182,212,0.5)]" : "w-2 bg-white/10"}` }, se)) }), _ ? s.jsx("div", { className: "text-neon-cyan font-black text-[10px] uppercase tracking-widest animate-pulse border border-neon-cyan/30 px-3 py-1 rounded-full bg-neon-cyan/10", children: "\u5F85\u6A5F\u4E2D..." }) : s.jsx("button", { onClick: ae, className: "py-2 px-6 rounded-xl font-black italic bg-white text-black hover:bg-gray-200 shadow-lg active:scale-95 transition-all", children: Z ? "\u5B8C\u4E86" : "\u6B21\u3078" })] })] }) })] });
}, Rx = (r, p) => {
  w.useEffect(() => {
    if (r <= 0) return;
    const h = setInterval(() => {
  ...
  return s.jsxs("div", { className: "w-full max-w-md mx-auto space-y-4 relative", children: [s.jsxs("div", { className: "text-center mb-6", children: [s.jsx("h2", { className: "text-2xl font-black text-white italic tracking-tighter", children: "\u9B54\u5C0E\u8CFC\u8CB7\u90E8" }), s.jsx("div", { className: "text-[10px] text-white/40 uppercase tracking-widest", children: "\u9664\u970A\u3092\u52B9\u7387\u5316\u3059\u308B\u30C4\u30FC\u30EB\u3084\u4F7F\u3044\u9B54\u306E\u5951\u7D04" })] }), s.jsx("div", { className: "grid grid-cols-1 gap-4 pb-24", children: p.map((j) => {
    const $ = Jf(j, j.level), J = r >= $, Z = Hx[j.icon] || Lt, ae = o === j.id;
    return s.jsxs("div", { className: `
                            ...
                            `, children: [s.jsxs("div", { className: "absolute top-0 right-0 bg-neon-purple text-white px-4 py-1 rounded-bl-2xl text-[10px] font-black italic shadow-lg z-10", children: ["LV.", j.level] }), s.jsxs("div", { className: "flex items-center gap-5 relative z-10", children: [s.jsx("div", { className: `
                                ...
                                `, children: j.image ? s.jsx("img", { src: j.image, alt: j.name, className: "w-full h-full object-cover" }) : s.jsx(Z, { size: 32 }) }), s.jsxs("div", { className: "flex-1 min-w-0", children: [s.jsx("h3", { className: "text-lg font-black text-white italic tracking-tighter truncate", children: j.name }), s.jsx("p", { className: "text-[10px] text-white/50 leading-tight line-clamp-2 mt-1 mb-2", children: j.lore }), s.jsx("div", { className: "flex items-center gap-2", children: s.jsxs("div", { className: "text-[10px] bg-emerald-500/20 text-emerald-400 px-2 py-0.5 rounded-full font-bold", children: ["+", (j.baseIncome * j.level).toLocaleString(), " MP/\u79D2"] }) })] }), s.jsxs("button", { ref: (X) => C.current[j.id] = X, onClick: () => _(j.id), disabled: !J, className: `
                                    ...
                                    `, children: [s.jsx("span", { className: "text-[10px] uppercase opacity-60", children: "Level Up" }), s.jsx("div", { className: "text-xs", children: J ? `${U($)}` : s.jsx(pc, { size: 14, className: "mx-auto" }) })] })] })] }, j.id);
  }) }), v.map((j) => s.jsx("div", { className: "purchase-particle", style: { position: "fixed", left: `${j.x}px`, top: `${j.y}px`, "--tx": `${j.tx}px`, "--ty": `${j.ty}px`, zIndex: 100 } }, j.id))] });
});
um.displayName = "Shop";
const Yx = [{ id: "crit_master", name: "\u4F1A\u5FC3\u306E\u4E00\u6483", description: "10%\u306E\u78BA\u7387\u3067\u30C0\u30E1\u30FC\u30B8\u304C3\u500D\u306B\u306A\u308B\u3002", icon: Jl, cost: 5e3, color: "from-orange-500 to-red-600" }, { id: "combo_shield", name: "\u30B3\u30F3\u30DC\u7DAD\u6301", description: "\u30DF\u30B9\u3057\u3066\u3082\u4E00\u5EA6\u3060\u3051\u30B3\u30F3\u30DC\u304C\u30EA\u30BB\u30C3\u30C8\u3055\u308C\u306A\u3044\u3002", icon: Hi, cost: 15e3, color: "from-blue-500 to-cyan-600" }, { id: "time_bend", name: "\u6642\u7A7A\u306E\u6B6A\u307F", description: "\u30B3\u30F3\u30DC\u53D7\u4ED8\u6642\u9593\u304C\u3055\u3089\u306B1\u79D2\u5EF6\u9577\u3055\u308C\u308B\u3002", icon: nm, cost: 3e4, color: "from-purple-500 to-indigo-600" }, { id: "mana_surge", name: "\u9B54\u529B\u5954\u6D41", description: "\u8A60\u5531\u7834\u68C4\u30B2\u30FC\u30B8\u306E\u30C1\u30E3\u30FC\u30B8\u901F\u5EA6\u304C2\u500D\u306B\u306A\u308B\u3002", icon: oa, cost: 1e5, color: "from-yellow-400 to-orange-500" }], om = ({ money: r, unlockedSkills: p = [], onUnlock: h, onClose: o }) => s.jsx("div", { className: "absolute inset-0 z-[100] flex items-center justify-center bg-black/80 backdrop-blur-md animate-in fade-in zoom-in duration-300", children: s.jsxs("div", { className: "bg-[#1a1a1a] w-full max-w-lg h-[80vh] rounded-[2.5rem] border-2 border-neon-cyan/30 shadow-[0_0_50px_rgba(0,255,255,0.2)] overflow-hidden flex flex-col", children: [s.jsxs("div", { className: "p-8 border-b border-white/10 flex items-center justify-between", children: [s.jsxs("div", { children: [s.jsxs("h2", { className: "text-3xl font-black text-white italic tracking-tighter flex items-center gap-3", children: [s.jsx(Lt, { className: "text-neon-cyan animate-pulse" }), "\u30B9\u30AD\u30EB\u89E3\u653E"] }), s.jsx("p", { className: "text-white/40 text-[8px] font-black uppercase tracking-[0.3em] mt-1", children: "Ancient Magic Upgrade Tree" })] }), s.jsx("button", { onClick: o, className: "w-12 h-12 rounded-2xl bg-white/5 hover:bg-white/10 flex items-center justify-center transition-all active:scale-95", children: s.jsx(Xa, { size: 24, className: "text-white/60" }) })] }), s.jsxs("div", { className: "px-8 py-4 bg-white/3 text-center", children: [s.jsx("span", { className: "text-xs font-bold text-white/40 uppercase tracking-widest", children: "\u6240\u6301\u9B54\u529B : " }), s.jsxs("span", { className: "text-xl font-black text-neon-cyan tracking-tight", children: [Math.floor(r).toLocaleString(), " MP"] })] }), s.jsx("div", { className: "flex-1 overflow-y-auto p-6 space-y-4", children: Yx.map((g) => {
  const v = g.icon, M = p.includes(g.id), C = r >= g.cost;
  return s.jsxs("div", { className: `
                  relative p-5 rounded-3xl border-2 transition-all duration-300
                  ${M ? "bg-gradient-to-br from-white/10 to-transparent border-neon-cyan/50 shadow-[0_10px_30px_rgba(0,255,255,0.1)]" : "bg-white/5 border-white/5 opacity-80"}
                `, children: [s.jsxs("div", { className: "flex items-center gap-5", children: [s.jsx("div", { className: `
                    w-16 h-16 rounded-2xl flex items-center justify-center shadow-lg
                    bg-gradient-to-br ${g.color}
                    ${M ? "animate-pulse" : "grayscale"}
                  `, children: s.jsx(v, { size: 32, className: "text-white" }) }), s.jsxs("div", { className: "flex-1", children: [s.jsxs("div", { className: "flex items-center justify-between mb-1", children: [s.jsx("h3", { className: "text-lg font-black text-white italic", children: g.name }), M ? s.jsx("span", { className: "text-[10px] font-black text-neon-cyan bg-neon-cyan/10 px-2 py-1 rounded-full uppercase tracking-tighter", children: "\u89E3\u653E\u6E08\u307F" }) : s.jsxs("span", { className: "text-xs font-black text-white/60", children: [g.cost.toLocaleString(), " MP"] })] }), s.jsx("p", { className: "text-xs text-white/40 font-medium leading-relaxed", children: g.description })] })] }), !M && s.jsx("button", { disabled: !C, onClick: () => h(g.id, g.cost), className: `
...
}) }), s.jsx("div", { className: "p-6 text-center text-[10px] text-white/20 font-bold uppercase tracking-[0.2em] border-t border-white/5", children: "\u53E4\u306E\u9B54\u9053\u3002\u305D\u306E\u5230\u9054\u8005\u3002" })] }) }), kn = { UR: 0.05, SR: 0.15, R: 0.3 }, zo = 500, Lx = { cost: zo }, Gx = (r) => {
  if (r < zo) return { success: false, error: "MP\u304C\u8DB3\u308A\u307E\u305B\u3093\uFF01" };
  const p = Math.random();
  let h = "N";
  p < kn.UR ? h = "UR" : p < kn.UR + kn.SR ? h = "SR" : p < kn.UR + kn.SR + kn.R && (h = "R");
  const o = fc.filter((v) => v.rarity === h);
  return { success: true, unit: o[Math.floor(Math.random() * o.length)], cost: zo };
}, qx = ({ money: r, onPullGacha: p, onSpentMoney: h }) => {
  const [o, g] = w.useState(false), [v, M] = w.useState(null), [C, z] = w.useState(null), _ = () => {
    if (o) return;
    z(null), M(null);
    const j = Gx(r);
    if (!j.success) {
    ...
    h(j.cost), g(true), setTimeout(() => {
      M(j.unit), p(j.unit), g(false);
    }, 2e3);
  }, U = (j) => {
    switch (j) {
      case "UR":
  ...
  return s.jsxs("div", { className: "flex-1 flex flex-col items-center justify-center p-6 relative overflow-hidden", children: [s.jsx("div", { className: "absolute inset-0 bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-indigo-900/40 via-black to-black z-0" }), s.jsxs("div", { className: "relative z-10 w-full max-w-md flex flex-col items-center", children: [s.jsxs("div", { className: "w-64 h-64 bg-white/5 rounded-full border-4 border-white/10 flex items-center justify-center mb-8 relative group shadow-[0_0_50px_rgba(168,85,247,0.2)]", children: [o ? s.jsx("div", { className: "absolute inset-0 rounded-full bg-gradient-to-tr from-neon-purple via-neon-cyan to-yellow-400 animate-spin blur-xl opacity-50" }) : s.jsx("div", { className: "absolute inset-0 rounded-full bg-neon-purple/5 opacity-0 group-hover:opacity-100 transition-opacity blur-xl" }), s.jsx(Mp, { size: 120, className: `text-white/20 transition-all duration-500 ${o ? "animate-bounce scale-110 text-white" : "group-hover:text-white/40"}` }), v && !o && s.jsxs("div", { className: "absolute inset-0 z-50 flex flex-col items-center justify-center bg-black/90 rounded-full animate-in zoom-in duration-300 border-4 border-neon-cyan/50 shadow-[0_0_50px_rgba(6,182,212,0.5)]", children: [s.jsxs("div", { className: `text-4xl font-black italic mb-2 ${U(v.rarity)} animate-bounce`, children: [v.rarity, "!!"] }), s.jsx("img", { src: v.image, alt: v.name, className: "w-32 h-32 object-contain mb-2 drop-shadow-2xl" }), s.jsx("div", { className: "text-sm font-black text-white text-center px-4 leading-tight", children: v.name }), s.jsx("button", { onClick: () => M(null), className: "mt-4 px-6 py-2 bg-white text-black rounded-full font-bold text-xs hover:bg-neon-cyan transition-colors", children: "\u9589\u3058\u308B" })] })] }), C && s.jsx("div", { className: "absolute top-0 text-red-400 font-bold bg-red-400/10 px-4 py-2 rounded-full border border-red-400/20 animate-bounce", children: C }), s.jsxs("div", { className: "w-full space-y-4", children: [s.jsxs("div", { className: "text-center", children: [s.jsx("div", { className: "text-[10px] text-white/40 font-black uppercase tracking-widest mb-1", children: "RARE GACHA" }), s.jsx("h2", { className: "text-2xl font-black text-white italic", children: "\u6975\u9650\u306E\u9B54\u5C0E\u53EC\u559A" })] }), s.jsxs("button", { onClick: _, disabled: o || !!v, className: `
                            w-full py-6 rounded-2xl font-black text-xl italic tracking-tighter
                            flex items-center justify-center gap-3 relative overflow-hidden group
                            transition-all duration-200
                            ${o || v ? "bg-gray-800 text-gray-500 cursor-not-allowed" : "bg-gradient-to-r from-neon-purple to-indigo-600 text-white shadow-[0_6px_0_#4c1d95] active:translate-y-1 active:shadow-none hover:brightness-110"}
                        `, children: [s.jsx("div", { className: "absolute inset-0 bg-white/20 -translate-x-full group-hover:translate-x-full transition-transform duration-700 pointer-events-none" }), s.jsx(Lt, { size: 24, className: o ? "animate-spin" : "" }), s.jsx("span", { children: "1\u56DE\u53EC\u559A" }), s.jsx("div", { className: "px-3 py-1 bg-black/40 rounded-lg text-sm font-bold flex items-center gap-1", children: s.jsxs("span", { className: "text-neon-cyan", children: [Lx.cost, " MP"] }) })] }), s.jsxs("div", { className: "flex justify-center gap-4 text-[10px] font-bold text-white/30", children: [s.jsx("span", { children: "UR: 5%" }), s.jsx("span", { children: "SR: 15%" }), s.jsx("span", { children: "R: 30%" }), s.jsx("span", { children: "N: 50%" })] })] })] })] });
}, Xx = ({ collectedUnits: r = [], onClose: p }) => {
  const [h, o] = w.useState(null), g = (v) => {
    switch (v) {
      case "UR":
  ...
  return s.jsx("div", { className: "fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/95 backdrop-blur-xl animate-in fade-in zoom-in duration-300", children: s.jsxs("div", { className: "w-full max-w-4xl h-[85vh] dragon-glass-card bg-black/95 backdrop-blur-xl border-4 border-white/20 rounded-[40px] overflow-hidden relative shadow-2xl flex flex-col", children: [s.jsxs("div", { className: "p-6 border-b-2 border-white/10 flex justify-between items-center bg-black/40", children: [s.jsxs("div", { children: [s.jsx("h2", { className: "text-3xl font-black text-white italic tracking-tighter", children: "\u30E6\u30CB\u30C3\u30C8\u56F3\u9451" }), s.jsxs("div", { className: "text-[10px] text-neon-cyan font-bold tracking-widest uppercase", children: ["\u53CE\u96C6\u72B6\u6CC1: ", r.length, " / ", fc.length] })] }), s.jsx("button", { onClick: p, className: "p-2 hover:bg-white/10 rounded-full transition-colors", children: s.jsx(Xa, { size: 32, className: "text-white" }) })] }), s.jsxs("div", { className: "flex-1 overflow-hidden flex", children: [s.jsx("div", { className: "flex-1 overflow-y-auto p-6 custom-scrollbar", children: s.jsx("div", { className: "grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 gap-4", children: fc.map((v) => {
    const M = r.includes(v.id);
    return s.jsx("button", { onClick: () => M && o(v), disabled: !M, className: `
                                            aspect-square rounded-xl border-2 relative overflow-hidden transition-all group
                                            ${M ? "bg-white/5 border-white/20 hover:border-neon-cyan hover:scale-105 active:scale-95 cursor-pointer" : "bg-black/40 border-white/5 opacity-50 cursor-not-allowed grayscale"}
                                            ${(h == null ? void 0 : h.id) === v.id ? "ring-4 ring-neon-cyan border-transparent" : ""}
                                        `, children: M ? s.jsxs(s.Fragment, { children: [s.jsx("div", { className: "absolute inset-0 p-2", children: s.jsx("img", { src: v.image, alt: v.name, className: "w-full h-full object-contain drop-shadow-xl" }) }), s.jsx("div", { className: `absolute top-1 left-1 px-1.5 py-0.5 rounded text-[8px] font-black ${g(v.rarity)} border`, children: v.rarity })] }) : s.jsx("div", { className: "absolute inset-0 flex items-center justify-center", children: s.jsx(Qf, { size: 24, className: "text-white/20" }) }) }, v.id);
...
}, Zx = ({ deckStats: r, artifactStats: p, magicStats: h }) => s.jsxs("div", { className: "w-full max-w-md bg-black/40 backdrop-blur-md rounded-[2.5rem] border border-white/10 p-6 space-y-4", children: [s.jsxs("div", { className: "flex items-center justify-between mb-2 px-2", children: [s.jsx("span", { className: "text-[10px] font-black text-white/40 uppercase tracking-[0.2em]", children: "Active Passives" }), s.jsx("span", { className: "text-[10px] font-black text-neon-cyan animate-pulse", children: "STATUS: OPTIMIZED" })] }), s.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [s.jsxs("div", { className: "bg-white/5 rounded-2xl p-4 border border-white/5 flex flex-col gap-1", children: [s.jsxs("div", { className: "flex items-center gap-2 text-neon-purple", children: [s.jsx(lx, { size: 14 }), s.jsx("span", { className: "text-[8px] font-black uppercase", children: "Battle Power" })] }), s.jsxs("div", { className: "text-xl font-black text-white", children: ["x", (r.attack * p.damageMult).toFixed(1)] })] }), s.jsxs("div", { className: "bg-white/5 rounded-2xl p-4 border border-white/5 flex flex-col gap-1", children: [s.jsxs("div", { className: "flex items-center gap-2 text-neon-cyan", children: [s.jsx(Lt, { size: 14 }), s.jsx("span", { className: "text-[8px] font-black uppercase", children: "Magic Income" })] }), s.jsxs("div", { className: "text-xl font-black text-white", children: ["x", p.incomeMult.toFixed(1)] })] }), s.jsxs("div", { className: "bg-white/5 rounded-2xl p-4 border border-white/5 flex flex-col gap-1", children: [s.jsxs("div", { className: "flex items-center gap-2 text-yellow-400", children: [s.jsx(Jl, { size: 14 }), s.jsx("span", { className: "text-[8px] font-black uppercase", children: "Crit Chance" })] }), s.jsxs("div", { className: "text-xl font-black text-white", children: [Math.floor(h.crit), "%"] })] }), s.jsxs("div", { className: "bg-white/5 rounded-2xl p-4 border border-white/5 flex flex-col gap-1", children: [s.jsxs("div", { className: "flex items-center gap-2 text-emerald-400", children: [s.jsx(oa, { size: 14 }), s.jsx("span", { className: "text-[8px] font-black uppercase", children: "Combo Shield" })] }), s.jsxs("div", { className: "text-xl font-black text-white", children: [p.comboTime / 1e3, "s"] })] })] })] }), Qx = ({ money: r, totalEarned: p, dragonLevel: h, maxCombo: o, onStartBattle: g, upgrades: v, onPurchase: M, unlockedSkills: C, onUnlock: z, onOpenSettings: _, onOpenLore: U, onOpenArtifacts: j, onOpenMagicSelection: $, onOpenWorldSelection: J, currentWorldId: Z, collectedUnits: ae, onPullGacha: X, onSpentMoney: pe, recommendedActionId: ke, unlockedAchievements: xe, onOpenAchievements: fe, deckStats: he, artifactStats: se, magicStats: W }) => {
  ...
  }, "data-tutorial-id": "shop-tab", className: `flex flex-col items-center gap-1 transition-all ${le === "shop" ? "scale-110 text-white" : "opacity-40 text-white/50 hover:opacity-100"} ${ke === "shop-tab" ? "animate-recommend" : ""}`, children: [s.jsx("div", { className: `p-3 rounded-2xl ${le === "shop" ? "bg-neon-purple/20 shadow-lg" : ""}`, children: s.jsx(Jp, { size: 24, className: "tab-icon-glow text-neon-purple" }) }), s.jsx("span", { className: "text-[10px] font-black uppercase tracking-widest text-neon-purple", children: "\u5E97" })] }), s.jsxs("button", { onClick: () => {
...
}, Jx = { matrix: [...Array(20)].map(() => ({ left: Math.random() * 100, delay: Math.random() * 2, duration: 1 + Math.random() * 2, chars: [String.fromCharCode(12448 + Math.random() * 96), String.fromCharCode(12448 + Math.random() * 96), String.fromCharCode(12448 + Math.random() * 96)] })), petals: [...Array(15)].map(() => ({ left: Math.random() * 100, delay: Math.random() * 5, duration: 5 + Math.random() * 5 })), stars: [...Array(30)].map(() => ({ left: Math.random() * 100, top: Math.random() * 100, delay: Math.random() * 3 })) }, Kx = ({ combo: r, worldId: p = "GENESIS" }) => {
  const h = () => r >= 25 ? "combo-extreme" : r >= 15 ? "combo-high" : r >= 5 ? "combo-medium" : "combo-low", o = Jx, g = w.useMemo(() => {
    switch (p) {
      case "CYBERIA":
        return s.jsx("div", { className: "absolute inset-0 overflow-hidden opacity-30", children: o.matrix.map((v, M) => s.jsxs("div", { className: "absolute text-matrix-green font-mono text-xs animate-digital-rain", style: { left: `${v.left}%`, animationDelay: `${v.delay}s`, animationDuration: `${v.duration}s` }, children: [v.chars[0], s.jsx("br", {}), v.chars[1], s.jsx("br", {}), v.chars[2]] }, M)) });
      case "GENESIS":
        return s.jsx("div", { className: "absolute inset-0 overflow-hidden opacity-40", children: o.petals.map((v, M) => s.jsx("div", { className: "absolute w-4 h-4 bg-pink-300/60 rounded-full animate-petal blur-[1px]", style: { left: `${v.left}%`, top: "-5%", animationDelay: `${v.delay}s`, animationDuration: `${v.duration}s` } }, M)) });
      case "ETERNITY":
        return s.jsxs("div", { className: "absolute inset-0 overflow-hidden", children: [s.jsx("div", { className: "absolute inset-0 bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-indigo-900/40 via-transparent to-transparent animate-pulse" }), o.stars.map((v, M) => s.jsx("div", { className: "absolute w-1 h-1 bg-white rounded-full animate-pulse shadow-[0_0_10px_white]", style: { left: `${v.left}%`, top: `${v.top}%`, animationDelay: `${v.delay}s` } }, M))] });
      case "LEGEND":
        return s.jsxs("div", { className: "absolute inset-0 overflow-hidden", children: [s.jsx("div", { className: "absolute inset-0 bg-gradient-to-br from-yellow-500/10 via-transparent to-orange-500/10" }), [...Array(5)].map((v, M) => s.jsx("div", { className: "absolute w-[200%] h-32 bg-gradient-to-r from-transparent via-yellow-200/5 to-transparent -rotate-45 animate-scan", style: { top: `${M * 25}%`, animationDelay: `${M * 0.5}s` } }, M))] });
      default:
        return null;
    }
  }, [p, o.matrix, o.petals, o.stars]);
  return s.jsxs("div", { className: "fixed inset-0 pointer-events-none z-0 overflow-hidden bg-slate-950", children: [s.jsx("div", { className: "absolute inset-0 bg-[linear-gradient(to_right,#0f172a_1px,transparent_1px),linear-gradient(to_bottom,#0f172a_1px,transparent_1px)] bg-[size:4rem_4rem] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_0%,#000_70%,transparent_100%)] opacity-20" }), g, s.jsx("div", { className: "absolute inset-0 bg-gradient-to-b from-transparent via-blue-500/10 to-transparent h-[200%] animate-scan pointer-events-none" }), s.jsx("div", { className: "noise-overlay opacity-30" }), r > 0 && s.jsx("div", { className: `neon-edge-glow ${h()}` }), s.jsx("div", { className: "absolute bottom-0 left-0 right-0 h-32 bg-gradient-to-t from-blue-900/20 to-transparent" })] });
}, oc = [{ id: "first_hack", name: "\u521D\u30CF\u30C3\u30AF", description: "\u30E2\u30F3\u30B9\u30BF\u30FC\u30921\u4F53\u5012\u3059\u3002", condition: (r) => r.stageIndex >= 1, reward: "\u5168\u30C0\u30E1\u30FC\u30B8 +5%", icon: "\u2694\uFE0F" }, { id: "combo_novice", name: "\u30B3\u30F3\u30DC\u306E\u4F7F\u3044\u624B", description: "10\u30B3\u30F3\u30DC\u3092\u9054\u6210\u3059\u308B\u3002", condition: (r) => r.maxCombo >= 10, reward: "MP\u7372\u5F97\u91CF +10%", icon: "\u26A1" }, { id: "collector", name: "\u30B3\u30EC\u30AF\u30BF\u30FC", description: "\u30E6\u30CB\u30C3\u30C8\u309210\u7A2E\u985E\u96C6\u3081\u308B\u3002", condition: (r) => r.collectedUnits.length >= 10, reward: "\u30AC\u30C1\u30E3\u904B +5%", icon: "\u{1F3B4}" }, { id: "rich_hacker", name: "\u5BCC\u8C6A\u30CF\u30C3\u30AB\u30FC", description: "\u7D2F\u8A08\u9B54\u529B(MP) 100\u4E07\u3092\u7A81\u7834\u3002", condition: (r) => r.totalEarned >= 1e6, reward: "\u5168\u30C0\u30E1\u30FC\u30B8 +15%", icon: "\u{1F4B0}" }, { id: "dragon_master", name: "\u7ADC\u306E\u5C0E\u304D\u624B", description: "\u30C9\u30E9\u30B4\u30F3\u306E\u9032\u5316\u6BB5\u968E\u304C4\u4EE5\u4E0A\u306B\u5230\u9054\u3002", condition: (r) => r.dragonLevel >= 150, reward: "\u30B3\u30F3\u30DC\u53D7\u4ED8\u6642\u9593 +0.5s", icon: "\u{1F409}" }, { id: "world_traveler", name: "\u4E16\u754C\u3092\u8D85\u3048\u3057\u8005", description: "2\u3064\u76EE\u306E\u4E16\u754C\uFF08CYBERIA\uFF09\u306B\u5230\u9054\u3059\u308B\u3002", condition: (r) => r.worldProgress.GENESIS >= 50, reward: "\u5168\u53CE\u76CA +20%", icon: "\u{1F30D}" }, { id: "speed_demon", name: "\u30B9\u30D4\u30FC\u30C9\u72C2", description: "50\u30B3\u30F3\u30DC\u3092\u9054\u6210\u3059\u308B\u3002", condition: (r) => r.maxCombo >= 50, reward: "\u30AF\u30FC\u30EB\u30BF\u30A4\u30E0\u77ED\u7E2E 10%", icon: "\u{1F680}" }, { id: "god_hacker", name: "\u795E\u306E\u6307", description: "\u7D2F\u8A08\u30BF\u30C3\u30D7\u6570\u304C 10,000\u56DE\u3092\u7A81\u7834\u3002", condition: (r) => r.totalTaps >= 1e4, reward: "\u30AF\u30EA\u30C6\u30A3\u30AB\u30EB\u7387 +10%", icon: "\u{1F590}\uFE0F" }, { id: "ultimate_evolution", name: "\u4E0D\u6EC5\u306E\u795E\u9F8D", description: "\u30C9\u30E9\u30B4\u30F3\u306E\u6700\u7D42\u5F62\u614B\u300C\u8D85\u8D8A\u795E\u9F8D\u300D\u306B\u5230\u9054\u3002", condition: (r) => r.dragonLevel >= 500, reward: "\u5168\u30C0\u30E1\u30FC\u30B8 +50%", icon: "\u{1F451}" }], $x = ({ achievement: r, onComplete: p }) => {
  const [h, o] = w.useState(false);
  return w.useEffect(() => {
    setTimeout(() => o(true), 0);
    const g = setTimeout(() => {
      o(false), setTimeout(p, 600);
    }, 4e3);
    return () => clearTimeout(g);
        ...
        `, children: s.jsx("div", { className: "bg-gradient-to-r from-yellow-500 via-orange-600 to-yellow-500 p-[2px] rounded-2xl shadow-[0_0_30px_rgba(234,179,8,0.4)]", children: s.jsxs("div", { className: "bg-[#1a1a1a] rounded-2xl px-6 py-4 flex items-center gap-4 border border-white/10", children: [s.jsx("div", { className: "w-12 h-12 bg-yellow-500 rounded-full flex items-center justify-center animate-bounce shadow-lg", children: s.jsx(Ui, { size: 28, className: "text-black" }) }), s.jsxs("div", { children: [s.jsx("div", { className: "text-[10px] font-black uppercase tracking-[0.2em] text-yellow-500/80", children: "Achievement Unlocked!" }), s.jsx("h3", { className: "text-lg font-black text-white italic leading-tight", children: r.name }), s.jsxs("p", { className: "text-[10px] font-bold text-white/40 uppercase mt-1", children: ["Reward: ", r.reward] })] })] }) }) });
}, Wx = ({ unlockedAchievements: r = [], onClose: p }) => s.jsx("div", { className: "fixed inset-0 z-[100] flex items-center justify-center p-6 bg-black/80 backdrop-blur-xl animate-in fade-in duration-300", children: s.jsxs("div", { className: "w-full max-w-2xl h-[80vh] bg-[#1a1a1a] border border-white/10 rounded-[2.5rem] overflow-hidden shadow-2xl flex flex-col", children: [s.jsxs("div", { className: "flex items-center justify-between p-8 pb-4", children: [s.jsxs("div", { children: [s.jsxs("h2", { className: "text-3xl font-black text-white italic tracking-tighter flex items-center gap-3", children: [s.jsx(Ui, { className: "text-yellow-500" }), "\u5B9F\u529B\u8A3C\u660E (Achievements)"] }), s.jsx("p", { className: "text-white/40 text-[10px] uppercase font-black tracking-widest mt-1", children: "Proof of your hacking prowess" })] }), s.jsx("button", { onClick: p, className: "p-3 bg-white/5 hover:bg-white/10 rounded-2xl transition-colors", children: s.jsx(Xa, { size: 24, className: "text-white/60" }) })] }), s.jsxs("div", { className: "px-8 py-4 bg-white/3 flex items-center justify-between", children: [s.jsx("span", { className: "text-xs font-bold text-white/40 uppercase tracking-widest", children: "\u9054\u6210\u7387" }), s.jsx("div", { className: "flex-1 mx-4 h-2 bg-white/5 rounded-full overflow-hidden", children: s.jsx("div", { className: "h-full bg-gradient-to-r from-yellow-500 to-orange-500 transition-all duration-1000", style: { width: `${r.length / oc.length * 100}%` } }) }), s.jsxs("span", { className: "text-sm font-black text-yellow-500 italic", children: [r.length, "/", oc.length] })] }), s.jsx("div", { className: "flex-1 overflow-y-auto p-8 space-y-4 custom-scrollbar", children: oc.map((h) => {
  const o = r.includes(h.id);
  return s.jsxs("div", { className: `
                                    p-5 rounded-3xl border-2 transition-all flex items-center gap-6
                                    ${o ? "bg-gradient-to-br from-yellow-500/10 to-transparent border-yellow-500/30" : "bg-white/5 border-white/5 opacity-50 grayscale"}
                                `, children: [s.jsx("div", { className: `
                                    w-16 h-16 rounded-2xl flex items-center justify-center text-3xl
                                    ${o ? "bg-yellow-500 shadow-lg shadow-yellow-500/20" : "bg-white/5"}
                                `, children: o ? h.icon : s.jsx(pc, { size: 24, className: "text-white/20" }) }), s.jsxs("div", { className: "flex-1", children: [s.jsxs("div", { className: "flex items-center gap-2 mb-1", children: [s.jsx("h3", { className: "text-lg font-black text-white italic leading-none", children: h.name }), o && s.jsx(Yh, { size: 14, className: "text-yellow-500" })] }), s.jsx("p", { className: "text-[10px] font-bold text-white/40 uppercase mb-2", children: h.description }), s.jsx("div", { className: "flex items-center gap-2", children: s.jsxs("span", { className: "text-[9px] font-black text-yellow-500 uppercase tracking-widest bg-yellow-500/10 px-2 py-0.5 rounded", children: ["\u5831\u916C: ", h.reward] }) })] })] }, h.id);
}) })] }) }), Ix = ({ onComplete: r }) => (w.useEffect(() => {
  const p = setTimeout(() => {
    r();
  }, 1500);
  return () => clearTimeout(p);
}, [r]), s.jsxs(s.Fragment, { children: [s.jsx("div", { className: "critical-overlay", children: s.jsx("div", { className: "critical-text", children: "CRITICAL HACK!" }) }), s.jsx("div", { className: "critical-scanline" })] }));
let Ft;
function Fx(r, p, h, o, g, v) {
  return Ft.calculate_damage(r, p, h, o, g, v);
}
function tm(r, p) {
  return Ft.calculate_idle_income(r, p);
}
function Oi(r, p, h, o) {
  return Ft.calculate_monster_hp(r, p, h, o);
}
function To(r, p, h) {
  return Ft.calculate_rebirth_orbs(r, p, h);
}
function Px(r, p, h, o) {
  return Ft.calculate_reward(r, p, h, o);
}
function am(r, p, h) {
  return Ft.calculate_upgrade_cost(r, p, h);
}
const e2 = /* @__PURE__ */ new Set(["basic", "cors", "default"]);
async function t2(r, p) {
  if (typeof Response == "function" && r instanceof Response) {
    if (typeof WebAssembly.instantiateStreaming == "function") try {
      return await WebAssembly.instantiateStreaming(r, p);
    } catch (o) {
      if (r.ok && e2.has(r.type) && r.headers.get("Content-Type") !== "application/wasm") console.warn("`WebAssembly.instantiateStreaming` failed because your server does not serve Wasm with `application/wasm` MIME type. Falling back to `WebAssembly.instantiate` which is slower. Original error:\n", o);
      else throw o;
    }
    const h = await r.arrayBuffer();
    return await WebAssembly.instantiate(h, p);
  } else {
    const h = await WebAssembly.instantiate(r, p);
    return h instanceof WebAssembly.Instance ? { instance: h, module: r } : h;
  }
}
function a2() {
  const r = {};
  return r.wbg = {}, r.wbg.__wbindgen_init_externref_table = function() {
    const p = Ft.__wbindgen_externrefs, h = p.grow(4);
    p.set(0, void 0), p.set(h + 0, void 0), p.set(h + 1, null), p.set(h + 2, true), p.set(h + 3, false);
  }, r;
}
function l2(r, p) {
  return Ft = r.exports, rm.__wbindgen_wasm_module = p, Ft.__wbindgen_start(), Ft;
}
async function rm(r) {
  if (Ft !== void 0) return Ft;
  typeof r < "u" && (Object.getPrototypeOf(r) === Object.prototype ? { module_or_path: r } = r : console.warn("using deprecated parameters for the initialization function; pass a single object instead")), typeof r > "u" && (r = new URL("data:application/wasm;base64,", import.meta.url));
  const p = a2();
  (typeof r == "string" || typeof Request == "function" && r instanceof Request || typeof URL == "function" && r instanceof URL) && (r = fetch(r));
  const { instance: h, module: o } = await t2(await r, p);
  return l2(h, o);
}
const n2 = ({ settings: r, onUpdate: p, onClose: h, onRebirth: o, canRebirth: g, nextRebirthOrbs: v, totalMoney: M, version: C = "v2.5.1" }) => {
  const [z, _] = w.useState(0), [U, j] = w.useState(false), [$, J] = w.useState(false), Z = () => {
    const ae = z + 1;
    _(ae), ae >= 7 && (j(true), _(0));
  };
  return s.jsx("div", { className: "fixed inset-0 z-[100] flex items-center justify-center p-6 bg-black/80 backdrop-blur-xl animate-in fade-in duration-300", children: s.jsxs("div", { className: "w-full max-w-md bg-[#1a1a1a] border border-white/10 rounded-[2.5rem] overflow-hidden shadow-2xl animate-in zoom-in-95 duration-300 font-sans", children: [s.jsxs("div", { className: "flex items-center justify-between p-8 pb-4", children: [s.jsx("h2", { className: "text-3xl font-black text-white italic tracking-tighter", children: "\u74B0\u5883\u8A2D\u5B9A" }), s.jsx("button", { onClick: h, className: "p-3 bg-white/5 hover:bg-white/10 rounded-2xl transition-colors", children: s.jsx(Xa, { size: 24, className: "text-white/60" }) })] }), $ && s.jsxs("div", { className: "absolute inset-0 z-50 bg-black/90 flex flex-col items-center justify-center p-8 text-center animate-in fade-in zoom-in duration-300", children: [s.jsx("div", { className: "text-4xl mb-4", children: "\u{1F52E}" }), s.jsx("h3", { className: "text-2xl font-black text-white mb-2", children: "\u8EE2\u751F\u3057\u307E\u3059\u304B\uFF1F" }), s.jsxs("p", { className: "text-sm text-gray-400 mb-6", children: ["\u6240\u6301\u91D1\u30FB\u30B9\u30C6\u30FC\u30B8\u9032\u884C\u30FB\u901A\u5E38\u30A2\u30C3\u30D7\u30B0\u30EC\u30FC\u30C9\u304C\u30EA\u30BB\u30C3\u30C8\u3055\u308C\u307E\u3059\u3002", s.jsx("br", {}), "\u4EE3\u308F\u308A\u306B ", s.jsxs("span", { className: "text-neon-purple font-bold", children: [v, " \u500B\u306E\u9B42\u306E\u30AA\u30FC\u30D6"] }), " \u3092\u7372\u5F97\u3057\u307E\u3059\u3002", s.jsx("br", {}), s.jsx("span", { className: "text-xs text-gray-500 mt-2 block", children: "\u203B\u30AC\u30C1\u30E3\u3067\u96C6\u3081\u305F\u30E6\u30CB\u30C3\u30C8\u3068\u30A2\u30FC\u30C6\u30A3\u30D5\u30A1\u30AF\u30C8\u306F\u5F15\u304D\u7D99\u304C\u308C\u307E\u3059\u3002" })] }), s.jsxs("div", { className: "flex gap-4 w-full", children: [s.jsx("button", { onClick: () => J(false), className: "flex-1 py-3 rounded-xl bg-white/10 text-white font-bold hover:bg-white/20 transition-colors", children: "\u30AD\u30E3\u30F3\u30BB\u30EB" }), s.jsx("button", { onClick: () => {
    o(), J(false), h();
  }, className: "flex-1 py-3 rounded-xl bg-neon-purple text-white font-bold hover:bg-neon-purple/80 transition-colors shadow-[0_0_20px_rgba(168,85,247,0.5)]", children: "\u8EE2\u751F\u3092\u5B9F\u884C" })] })] }), s.jsxs("div", { className: "p-8 pt-4 space-y-6", children: [s.jsxs("div", { className: "space-y-4", children: [s.jsx("label", { className: "text-[10px] font-black uppercase tracking-[0.3em] text-white/30", children: "\u57FA\u672C\u8A2D\u5B9A" }), s.jsxs("div", { className: "space-y-2", children: [s.jsxs("div", { className: "flex items-center justify-between p-5 bg-white/5 rounded-3xl border border-white/5 group hover:border-neon-purple/50 transition-all pb-2", children: [s.jsxs("div", { className: "flex items-center gap-4", children: [s.jsx("div", { className: `p-3 rounded-2xl ${(r == null ? void 0 : r.sound) ? "bg-neon-purple text-white" : "bg-white/5 text-white/20"}`, children: (r == null ? void 0 : r.sound) ? s.jsx(bc, { size: 24 }) : s.jsx(gx, { size: 24 }) }), s.jsxs("div", { children: [s.jsx("div", { className: "font-bold text-white", children: "\u30B5\u30A6\u30F3\u30C9\u8A2D\u5B9A" }), s.jsx("div", { className: "text-xs text-white/40 italic", children: "\u52B9\u679C\u97F3\u3068BGM" })] })] }), s.jsx("button", { onClick: () => p({ sound: !(r == null ? void 0 : r.sound) }), className: `w-16 h-8 rounded-full relative transition-all ${(r == null ? void 0 : r.sound) ? "bg-neon-purple shadow-neon-purple/50 shadow-lg" : "bg-white/10"}`, children: s.jsx("div", { className: `absolute top-1 w-6 h-6 bg-white rounded-full transition-all ${(r == null ? void 0 : r.sound) ? "left-9" : "left-1"}` }) })] }), (r == null ? void 0 : r.sound) && s.jsx("div", { className: "px-5 pb-5 pt-2 animate-in slide-in-from-top-2 duration-300", children: s.jsxs("div", { className: "flex items-center gap-4", children: [s.jsxs("span", { className: "text-[10px] font-bold text-white/30 uppercase w-12 text-right", children: [r.music, "%"] }), s.jsx("input", { type: "range", min: "0", max: "100", value: r.music, onChange: (ae) => p({ music: parseInt(ae.target.value) }), className: "flex-1 accent-neon-purple bg-white/10 h-1 rounded-full appearance-none cursor-pointer" })] }) })] }), s.jsxs("div", { className: "flex items-center justify-between p-5 bg-white/5 rounded-3xl border border-white/5 group hover:border-neon-cyan/50 transition-all", children: [s.jsxs("div", { className: "flex items-center gap-4", children: [s.jsx("div", { className: `p-3 rounded-2xl ${(r == null ? void 0 : r.haptic) ? "bg-neon-cyan text-black" : "bg-white/5 text-white/20"}`, children: s.jsx(Wp, { size: 24 }) }), s.jsxs("div", { children: [s.jsx("div", { className: "font-bold text-white", children: "\u632F\u52D5\u30D5\u30A3\u30FC\u30C9\u30D0\u30C3\u30AF" }), s.jsx("div", { className: "text-xs text-white/40 italic", children: "\u30BF\u30A4\u30D4\u30F3\u30B0\u6642\u306E\u611F\u89E6" })] })] }), s.jsx("button", { onClick: () => p({ haptic: !(r == null ? void 0 : r.haptic) }), className: `w-16 h-8 rounded-full relative transition-all ${(r == null ? void 0 : r.haptic) ? "bg-neon-cyan shadow-neon-cyan/50 shadow-lg" : "bg-white/10"}`, children: s.jsx("div", { className: `absolute top-1 w-6 h-6 bg-white rounded-full transition-all ${(r == null ? void 0 : r.haptic) ? "left-9" : "left-1"}` }) })] })] }), s.jsxs("div", { className: "space-y-4 pt-4 border-t border-white/5", children: [s.jsx("label", { className: "text-[10px] font-black uppercase tracking-[0.3em] text-white/30", children: "\u8EE2\u751F\u30B7\u30B9\u30C6\u30E0" }), s.jsxs("div", { className: `
                        ...
                        `, children: [s.jsxs("button", { onClick: () => g && J(true), disabled: !g, className: "w-full flex items-center justify-between relative z-10 text-left", children: [s.jsxs("div", { className: "flex items-center gap-4", children: [s.jsx("div", { className: "p-3 rounded-2xl bg-black/40 text-neon-purple shadow-lg", children: s.jsx("span", { className: "text-xl", children: "\u{1F52E}" }) }), s.jsxs("div", { children: [s.jsx("div", { className: "font-bold text-white", children: "\u8EE2\u751F (Rebirth)" }), g ? s.jsxs("div", { className: "text-xs text-neon-purple font-bold animate-pulse", children: ["\u7372\u5F97\u53EF\u80FD\u30AA\u30FC\u30D6: ", v, "\u500B"] }) : s.jsxs("div", { className: "text-[10px] text-white/40", children: ["\u5FC5\u8981MP: ", 1e6 - M, " MP"] })] })] }), s.jsx("div", { className: "text-neon-purple", children: "Run >" })] }), g && s.jsx("div", { className: "absolute inset-0 bg-gradient-to-r from-transparent via-neon-purple/20 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-1000 pointer-events-none" })] })] }), U && s.jsxs("div", { className: "space-y-4 pt-4 border-t border-white/5 animate-in slide-in-from-top-4 duration-500", children: [s.jsxs("label", { className: "text-[10px] font-black uppercase tracking-[0.3em] text-neon-purple-light flex items-center gap-2", children: [s.jsx(mc, { size: 12 }), "\u4E0A\u7D1A\u8005\u5411\u3051\u30DE\u30C8\u30EA\u30AF\u30B9\u8A2D\u5B9A"] }), s.jsxs("div", { className: "flex items-center justify-between p-5 bg-neon-purple/10 rounded-3xl border border-neon-purple/20", children: [s.jsxs("div", { className: "flex items-center gap-4", children: [s.jsx(Sp, { size: 20, className: "text-neon-purple-light" }), s.jsxs("div", { children: [s.jsx("div", { className: "font-bold text-white text-sm", children: "\u753B\u9762\u306E\u63FA\u308C\u52B9\u679C" }), s.jsx("div", { className: "text-[10px] text-white/40 italic uppercase", children: "\u8E8D\u52D5\u611F\u306E\u3042\u308B\u6F14\u51FA" })] })] }), s.jsx("button", { onClick: () => p({ shake: !(r == null ? void 0 : r.shake) }), className: `w-12 h-6 rounded-full relative transition-all ${(r == null ? void 0 : r.shake) ? "bg-neon-purple" : "bg-white/10"}`, children: s.jsx("div", { className: `absolute top-1 w-4 h-4 bg-white rounded-full transition-all ${(r == null ? void 0 : r.shake) ? "left-7" : "left-1"}` }) })] }), s.jsxs("div", { className: "flex items-center justify-between p-5 bg-neon-cyan/10 rounded-3xl border border-neon-cyan/20", children: [s.jsxs("div", { className: "flex items-center gap-4", children: [s.jsx(Zp, { size: 20, className: "text-neon-cyan" }), s.jsxs("div", { children: [s.jsx("div", { className: "font-bold text-white text-sm", children: "\u30A8\u30D5\u30A7\u30AF\u30C8\u306E\u8EFD\u91CF\u5316" }), s.jsx("div", { className: "text-[10px] text-white/40 italic uppercase", children: "\u4F4E\u30B9\u30DA\u30C3\u30AF\u7AEF\u672B\u5411\u3051" })] })] }), s.jsx("button", { onClick: () => p({ lowDetail: !(r == null ? void 0 : r.lowDetail) }), className: `w-12 h-6 rounded-full relative transition-all ${(r == null ? void 0 : r.lowDetail) ? "bg-neon-cyan" : "bg-white/10"}`, children: s.jsx("div", { className: `absolute top-1 w-4 h-4 bg-white rounded-full transition-all ${(r == null ? void 0 : r.lowDetail) ? "left-7" : "left-1"}` }) })] })] }), s.jsxs("div", { className: "pt-4 flex flex-col items-center gap-4", children: [s.jsxs("button", { onClick: Z, className: `text-[10px] font-bold tracking-[0.2em] transition-all hover:scale-110 active:scale-95 py-2 px-4 rounded-full ${U ? "text-neon-purple bg-neon-purple/10" : "text-white/20 hover:text-white/40"}`, children: ["\u30D0\u30FC\u30B8\u30E7\u30F3 ", C, " ", U && "(\u30DE\u30C8\u30EA\u30AF\u30B9\u89E3\u653E\u6E08\u307F)"] }), !U && z > 0 && z < 7 && s.jsxs("div", { className: "text-[10px] text-white/20 animate-pulse uppercase tracking-widest", children: ["\u3042\u3068 ", 7 - z, " \u56DE\u30BF\u30C3\u30D7\u3067\u30DE\u30C8\u30EA\u30AF\u30B9\u3092\u89E3\u653E..."] })] })] })] }) });
}, i2 = ({ totalEarned: r, onClose: p }) => {
  const [h, o] = w.useState(null), [g, v] = w.useState("");
  return w.useEffect(() => {
    if (h) {
      v("");
      let M = 0;
      const C = h.content, z = setInterval(() => {
        v(C.slice(0, M + 1)), M++, M >= C.length && clearInterval(z);
      }, 15);
    ...
    const C = r < M.unlockThreshold;
    return s.jsxs("button", { disabled: C, onClick: () => o(M), className: `
                                        ...
                                        ${(h == null ? void 0 : h.id) === M.id ? "bg-neon-cyan/10 border border-neon-cyan/30" : "border border-transparent"}
                                    `, children: [s.jsxs("div", { className: "flex items-center gap-3", children: [C ? s.jsx(pc, { size: 14, className: "text-white/20" }) : s.jsx($h, { size: 14, className: "text-neon-cyan" }), s.jsxs("div", { className: "text-left", children: [s.jsx("div", { className: `text-[10px] font-black uppercase tracking-widest ${(h == null ? void 0 : h.id) === M.id ? "text-neon-cyan" : "text-white/40"}`, children: M.id }), s.jsx("div", { className: "text-xs font-bold text-white/80", children: C ? "\u6A5F\u5BC6\u4E8B\u9805" : M.title })] })] }), !C && s.jsx(Rn, { size: 14, className: "opacity-0 group-hover:opacity-100 transition-opacity" })] }, M.id);
  }) }), s.jsxs("div", { className: "p-6 border-t border-white/5 bg-black/40", children: [s.jsx("div", { className: "text-[10px] font-black text-white/20 uppercase mb-2", children: "\u30A2\u30FC\u30AB\u30A4\u30D6\u540C\u671F\u72B6\u6CC1" }), s.jsx("div", { className: "h-1 w-full bg-white/5 rounded-full overflow-hidden", children: s.jsx("div", { className: "h-full bg-neon-cyan shadow-[0_0_10px_rgba(0,255,255,0.5)] transition-all duration-1000", style: { width: `${Math.min(100, r / 2e4 * 100)}%` } }) })] })] }), s.jsxs("div", { className: "flex-1 flex flex-col relative overflow-hidden z-10", children: [s.jsxs("div", { className: "p-6 border-b border-white/5 flex items-center justify-between bg-black/20", children: [s.jsxs("div", { className: "flex items-center gap-3", children: [s.jsx("div", { className: "w-2 h-2 rounded-full bg-neon-cyan animate-pulse" }), s.jsx("div", { className: "text-[10px] tracking-widest text-white/40 uppercase", children: "\u5C40\u3078\u306E\u63A5\u7D9A: \u5B89\u5B9A" })] }), s.jsx("button", { onClick: p, className: "p-2 hover:bg-white/5 rounded-xl transition-colors text-white/40 hover:text-white", children: s.jsx(Xa, { size: 20 }) })] }), s.jsx("div", { className: "flex-1 p-8 overflow-y-auto custom-scrollbar flex flex-col", children: h ? s.jsxs("div", { className: "animate-in fade-in duration-500", children: [s.jsxs("div", { className: "flex items-center gap-2 mb-8 text-neon-cyan", children: [s.jsx(ap, { size: 16 }), s.jsx("span", { className: "text-xs font-black uppercase tracking-[0.3em]", children: h.title })] }), s.jsxs("div", { className: "text-white/80 leading-relaxed text-sm whitespace-pre-wrap font-mono", children: [g, s.jsx("span", { className: "inline-block w-2 h-4 bg-neon-cyan ml-1 animate-pulse" })] })] }) : s.jsxs("div", { className: "h-full flex flex-col items-center justify-center text-center opacity-20", children: [s.jsx(Vf, { size: 64, className: "mb-6 rotate-12" }), s.jsx("div", { className: "text-xs font-black uppercase tracking-[0.4em] mb-2", children: "\u30A2\u30FC\u30AB\u30A4\u30D6\u306B\u30A2\u30AF\u30BB\u30B9" }), s.jsx("div", { className: "text-[10px] tracking-widest", children: "\u8A18\u9332\u3092\u9078\u629E\u3057\u3066\u5FA9\u53F7\u3092\u958B\u59CB\u3057\u3066\u304F\u3060\u3055\u3044..." })] }) }), s.jsx("div", { className: "absolute inset-0 pointer-events-none opacity-[0.03] bg-[linear-gradient(rgba(18,16,16,0)_50%,rgba(0,0,0,0.25)_50%),linear-gradient(90deg,rgba(255,0,0,0.06),rgba(0,255,0,0.02),rgba(0,0,255,0.06))] bg-[size:100%_2px,3px_100%]" })] })] }) });
}, s2 = [{ id: "gold_keyboard", name: "\u9EC4\u91D1\u306E\u30AD\u30FC\u30DC\u30FC\u30C9", description: "\u30BF\u30C3\u30D7\u653B\u6483\u529B\u304C\u6C38\u7D9A\u7684\u306B\u4E0A\u6607\u3059\u308B", effectDescription: "\u653B\u6483\u529B +50% / Lv", baseCost: 1, costMultiplier: 1.5, maxLevel: 50, effectType: "damage_multiplier", effectValue: 0.5, icon: oa, color: "text-yellow-400" }, { id: "time_stopper", name: "\u6642\u9593\u505C\u6B62\u306E\u7802\u6642\u8A08", description: "\u30B3\u30F3\u30DC\u306E\u53D7\u4ED8\u6642\u9593\u304C\u5EF6\u9577\u3055\u308C\u308B", effectDescription: "\u53D7\u4ED8\u6642\u9593 +0.5\u79D2 / Lv", baseCost: 3, costMultiplier: 2, maxLevel: 10, effectType: "combo_duration", effectValue: 500, icon: nm, color: "text-blue-400" }, { id: "greed_wallet", name: "\u5F37\u6B32\u306E\u30AC\u30DE\u53E3", description: "\u30B3\u30A4\u30F3\u7372\u5F97\u91CF\u304C\u6C38\u7D9A\u7684\u306B\u4E0A\u6607\u3059\u308B", effectDescription: "\u7372\u5F97\u91CF +20% / Lv", baseCost: 2, costMultiplier: 1.4, maxLevel: 100, effectType: "income_multiplier", effectValue: 0.2, icon: Vh, color: "text-green-400" }, { id: "gacha_coupon", name: "\u30AC\u30C1\u30E3\u512A\u5F85\u5238", description: "\u30AC\u30C1\u30E3\u306E\u30B3\u30B9\u30C8\u304C\u6E1B\u5C11\u3059\u308B", effectDescription: "\u30B3\u30B9\u30C8 -5% / Lv", baseCost: 5, costMultiplier: 2.5, maxLevel: 10, effectType: "gacha_discount", effectValue: 0.05, icon: cx, color: "text-pink-400" }, { id: "ancient_shield", name: "\u53E4\u306E\u30D7\u30ED\u30C6\u30AF\u30BF\u30FC", description: "\u30C1\u30E3\u30F3\u30C8\u30D6\u30EC\u30A4\u30AF\u306E\u30B2\u30FC\u30B8\u4E0A\u6607\u91CF\u30A2\u30C3\u30D7", effectDescription: "\u4E0A\u6607\u91CF +10% / Lv", baseCost: 4, costMultiplier: 1.8, maxLevel: 20, effectType: "break_bonus", effectValue: 0.1, icon: Hi, color: "text-purple-400" }], c2 = ({ spiritOrbs: r, artifacts: p, onBuyArtifact: h, onClose: o }) => s.jsx("div", { className: "fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/95 backdrop-blur-xl animate-in fade-in zoom-in duration-300", children: s.jsxs("div", { className: "w-full max-w-4xl h-[80vh] flex flex-col dragon-glass-card bg-[#1a1a1a] border-4 border-white/20 rounded-3xl overflow-hidden relative shadow-2xl", children: [s.jsxs("div", { className: "p-6 border-b-2 border-white/10 flex justify-between items-center bg-black/40", children: [s.jsxs("div", { className: "flex items-center gap-4", children: [s.jsx("div", { className: "w-12 h-12 rounded-full bg-gradient-to-tr from-purple-600 to-indigo-400 flex items-center justify-center shadow-[0_0_20px_rgba(168,85,247,0.5)] animate-pulse", children: s.jsx("span", { className: "text-2xl", children: "\u{1F52E}" }) }), s.jsxs("div", { children: [s.jsx("h2", { className: "text-3xl font-black text-white italic tracking-tighter", children: "\u53E4\u4EE3\u907A\u7269\u4FDD\u7BA1\u5EAB" }), s.jsxs("div", { className: "text-sm font-bold text-neon-purple tracking-widest uppercase", children: ["\u970A\u73E0: ", r.toLocaleString()] })] })] }), s.jsx("button", { onClick: o, className: "p-2 hover:bg-white/10 rounded-full transition-colors", children: s.jsx(Xa, { size: 32, className: "text-white" }) })] }), s.jsx("div", { className: "flex-1 overflow-y-auto p-6 custom-scrollbar", children: s.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6", children: s2.map((g) => {
  var _a;
  const v = ((_a = p.find((U) => U.id === g.id)) == null ? void 0 : _a.level) || 0, M = Ux(g, v), C = r >= M, z = v >= g.maxLevel, _ = g.icon;
  return s.jsxs("div", { className: `dragon-glass-card p-4 relative group ${z ? "border-yellow-400/50 bg-yellow-400/5" : "border-white/10 bg-white/5"}`, children: [s.jsxs("div", { className: "flex items-start justify-between mb-4", children: [s.jsx("div", { className: `p-3 rounded-xl bg-black/40 border border-white/10 ${g.color}`, children: s.jsx(_, { size: 24 }) }), s.jsxs("div", { className: "flex flex-col items-end", children: [s.jsx("span", { className: "text-[10px] uppercase font-black tracking-widest text-white/40", children: "\u9B54\u5C0E\u30EC\u30D9\u30EB" }), s.jsxs("span", { className: `text-2xl font-black ${z ? "text-yellow-400" : "text-white"}`, children: [v, s.jsxs("span", { className: "text-sm text-white/40", children: ["/", g.maxLevel] })] })] })] }), s.jsx("h3", { className: "text-lg font-black text-white italic mb-1", children: g.name }), s.jsx("p", { className: "text-xs font-bold text-white/60 mb-2 min-h-[2.5em]", children: g.description }), s.jsx("div", { className: "text-[10px] font-bold text-neon-cyan mb-4", children: g.effectDescription }), s.jsx("button", { onClick: () => h(g.id, M), disabled: !C || z, className: `
                                            w-full py-3 rounded-xl font-black flex items-center justify-center gap-2
                                            transition-all active:scale-95
                                            ${z ? "bg-white/10 text-white/40 cursor-not-allowed" : C ? "bg-neon-purple text-white shadow-[0_4px_0_#4c1d95] hover:brightness-110" : "bg-gray-800 text-gray-500 cursor-not-allowed"}
                                        `, children: z ? s.jsx("span", { children: "\u9650\u754C\u5230\u9054" }) : s.jsxs(s.Fragment, { children: [s.jsx("span", { children: "\u9B54\u529B\u6CE8\u5165" }), s.jsxs("div", { className: "px-2 py-0.5 bg-black/40 rounded-lg text-xs flex items-center gap-1", children: [s.jsx("span", { children: "\u{1F52E}" }), s.jsx("span", { children: M.toLocaleString() })] })] }) })] }, g.id);
}) }) })] }) }), u2 = { Flame: Di, Droplets: Yo, Zap: oa, Wind: tr, Sun: Wo, Moon: rc, Snowflake: Ko, Mountain: dc, Skull: gc, Orbit: Vo, Ghost: hc, Shield: Hi, HeartPulse: qo, Hourglass: Xo, Rocket: Jo, Leaf: Qo, CloudLightning: Do, Star: $o, Sparkles: Lt, Dna: Bo, Cloud: Uo, Thermometer: Fo, Waves: er, Layers: Zo, Volume2: bc, Sunrise: Io, Activity: Ro, Crown: Ho, Feather: Lo, Flower: Go, Bone: Oo, Settings: xc, Tv: Po, Box: Co, Bug: mc, Target: Jl }, o2 = ({ unlockedElements: r, equippedElements: p, onSave: h, onClose: o }) => {
  const [g, v] = w.useState([...p]), M = (_) => {
    let U;
    g.includes(_) ? g.length > 1 ? U = g.filter((j) => j !== _) : U = g : g.length < 6 ? U = [...g, _] : U = g, v(U);
  }, C = g.length === Math.min(r.length, 6), z = w.useMemo(() => ye.attributes.filter((_) => r.includes(_.id)), [r]);
  return s.jsx("div", { className: "fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-in fade-in duration-300", children: s.jsxs("div", { className: "bg-[#1a1a1a] w-full max-w-2xl rounded-[2.5rem] border border-white/10 shadow-2xl overflow-hidden flex flex-col max-h-[90vh]", children: [s.jsxs("div", { className: "p-8 flex items-center justify-between border-b border-white/5", children: [s.jsxs("div", { children: [s.jsx("h2", { className: "text-3xl font-black italic tracking-tighter text-white uppercase", children: "Magic Equipment" }), s.jsxs("p", { className: "text-white/40 text-sm font-bold tracking-widest uppercase", children: ["Select ", Math.min(r.length, 6), " Elements for Battle (", g.length, "/6)"] })] }), s.jsx("button", { onClick: o, className: "p-3 rounded-2xl bg-white/5 hover:bg-white/10 transition-all", children: s.jsx(Xa, { size: 24, className: "text-white/60" }) })] }), s.jsxs("div", { className: "flex-1 overflow-y-auto p-4 sm:p-8 custom-scrollbar bg-black/40", children: [s.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-5 gap-3", children: z.map((_) => {
    const U = u2[_.icon], j = g.includes(_.id);
    return s.jsxs("button", { onClick: () => M(_.id), className: `
                                        relative group flex flex-col items-center p-3 rounded-[1.5rem] border-2 transition-all duration-300
                                        ${j ? `bg-gradient-to-br ${_.color} border-white/40 shadow-lg scale-[1.02]` : "bg-white/5 border-transparent hover:bg-white/10"}
                                    `, children: [s.jsx("div", { className: `
                                        w-10 h-10 rounded-xl flex items-center justify-center mb-1 transition-transform group-hover:rotate-6
                                        ${j ? "bg-black/20" : "bg-white/5"}
                                    `, children: s.jsx(U, { size: 20, className: j ? "text-white" : "text-white/40" }) }), s.jsx("span", { className: `font-black text-[10px] italic mb-2 truncate w-full text-center ${j ? "text-white" : "text-white/60"}`, children: _.name }), s.jsxs("div", { className: "w-full space-y-[2px] opacity-40 group-hover:opacity-100 transition-opacity", children: [s.jsx("div", { className: "h-[2px] w-full bg-black/20 rounded-full overflow-hidden", children: s.jsx("div", { className: "h-full bg-white/80", style: { width: `${Math.min(100, _.stats.atk * 4)}%` } }) }), s.jsx("div", { className: "h-[2px] w-full bg-black/20 rounded-full overflow-hidden", children: s.jsx("div", { className: "h-full bg-cyan-400/80", style: { width: `${Math.min(100, _.stats.spd * 4)}%` } }) })] }), j && s.jsx("div", { className: "absolute -top-1 -right-1 w-5 h-5 bg-white text-black rounded-full flex items-center justify-center shadow-lg animate-in zoom-in", children: s.jsx(Uh, { size: 12, strokeWidth: 4 }) })] }, _.id);
...
}, r2 = ({ currentWorldId: r, worldProgress: p, onSelect: h, onClose: o }) => s.jsx("div", { className: "fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-in fade-in duration-300", children: s.jsxs("div", { className: "bg-[#1a1a1a] w-full max-w-2xl rounded-[2.5rem] border border-white/10 shadow-2xl overflow-hidden flex flex-col max-h-[90vh]", children: [s.jsxs("div", { className: "p-8 flex items-center justify-between border-b border-white/5", children: [s.jsxs("div", { children: [s.jsx("h2", { className: "text-3xl font-black italic tracking-tighter text-white uppercase", children: "World Selection" }), s.jsx("p", { className: "text-white/40 text-sm font-bold tracking-widest uppercase", children: "Choose your next battlefield" })] }), s.jsx("button", { onClick: o, className: "p-3 rounded-2xl bg-white/5 hover:bg-white/10 transition-all", children: s.jsx(Xa, { size: 24, className: "text-white/60" }) })] }), s.jsx("div", { className: "flex-1 overflow-y-auto p-8 custom-scrollbar space-y-4", children: ye.worlds.map((g, v) => {
  const M = v === 0 || p[ye.worlds[v - 1].id] >= 10, C = r === g.id, z = p[g.id] || 0, _ = Math.min(100, z / 50 * 100), U = { GENESIS: "from-blue-500/20 to-cyan-500/20 shadow-blue-500/20 border-blue-500", CYBERIA: "from-purple-500/20 to-neon-purple/20 shadow-purple-500/20 border-purple-500", ETERNITY: "from-indigo-500/20 to-violet-500/20 shadow-indigo-500/20 border-indigo-500", LEGEND: "from-red-600/20 to-orange-600/20 shadow-red-600/30 border-red-600" };
  return s.jsxs("div", { onClick: () => M && h(g.id), className: `
                                    relative group overflow-hidden rounded-[2rem] border-2 transition-all duration-500
                                    ${M ? "cursor-pointer" : "cursor-not-allowed opacity-50 grayscale"}
                                ...
                                `, children: [s.jsxs("div", { className: "p-6 flex items-center gap-6 relative z-10", children: [s.jsxs("div", { className: `
                                    ...
                                    `, children: [g.id === "GENESIS" && s.jsx(op, { size: 32 }), g.id === "CYBERIA" && s.jsx(oa, { size: 32 }), g.id === "ETERNITY" && s.jsx(pp, { size: 32 }), g.id === "LEGEND" && s.jsx(Swords, { size: 32, className: "text-red-500" })] }), s.jsxs("div", { className: "flex-1", children: [s.jsxs("div", { className: "flex items-center gap-2 mb-1", children: [s.jsx("h3", { className: "text-xl font-black italic text-white uppercase tracking-tighter", children: g.name }), !M && s.jsx(pc, { size: 14, className: "text-white/40" }), g.id === "LEGEND" && s.jsx("span", { className: "bg-red-600 text-[8px] px-1.5 py-0.5 rounded font-black text-white animate-pulse", children: "HARD" })] }), s.jsx("p", { className: "text-xs font-bold text-white/40 uppercase tracking-widest mb-3", children: g.description }), s.jsxs("div", { className: "flex items-center gap-3", children: [s.jsx("div", { className: "flex-1 h-1.5 bg-black/40 rounded-full overflow-hidden", children: s.jsx("div", { className: `h-full transition-all duration-1000 ${C ? "bg-white" : "bg-white/40"}`, style: { width: `${_}%` } }) }), s.jsxs("span", { className: "text-[10px] font-black text-white/60 tracking-widest whitespace-nowrap", children: ["STAGE ", z + 1] })] })] }), s.jsx(Rn, { size: 24, className: `transition-transform group-hover:translate-x-1 ${C ? "text-white" : "text-white/20"}` })] }), s.jsx("div", { className: "absolute top-4 right-8 font-black text-4xl italic opacity-[0.03] select-none pointer-events-none group-hover:opacity-[0.05] transition-opacity", children: g.id })] }, g.id);
}) })] }) });
function d2() {
  var _a2;
  const [r, p] = w.useState(false);
  w.useEffect(() => {
    rm().then(() => p(true)), lt.init();
  }, []);
  const [h, o] = w.useState(0), [g, v] = w.useState(0), [M, C] = w.useState(0), [z, _] = w.useState(0), [U, j] = w.useState("home"), [$, J] = w.useState(ye.upgrades.map((O) => ({ ...O, level: 0 }))), [Z, ae] = w.useState({ haptic: true, particle: true, music: 50, sfx: 50 }), [X, pe] = w.useState(["n_egg"]), [ke, xe] = w.useState({ n_egg: 1 }), [fe, he] = w.useState(0), [se, W] = w.useState([]), [le, Le] = w.useState([]), [ot, Ne] = w.useState(false), [Ee, Pe] = w.useState(false), [Xe, Se] = w.useState(false), [S, H] = w.useState(true), [Q, ve] = w.useState([]), [we, m] = w.useState(null), [R, B] = w.useState(false), [L, P] = w.useState(false);
  w.useEffect(() => {
    lt.setEnabled(Z.sound), lt.setVolume(Z.music / 100);
  }, [Z.sound, Z.music]);
  const [ee, ce] = w.useState(null), [Ze, De] = w.useState([]), [bl, yl] = w.useState(false), [On, Cn] = w.useState(false), [ya, Kl] = w.useState(false), [Dn, Bi] = w.useState(false), [Yi, vl] = w.useState(false), [Un, Za] = w.useState(false), [_l, Li] = w.useState(false), [bt, Hn] = w.useState(0), [va, $l] = w.useState(false), [Rt, Bn] = w.useState(1), [Gi, qi] = w.useState(""), Wl = w.useRef([]), [Gt, nt] = w.useState([]), [rt, Ke] = w.useState(0), [Yn, Qa] = w.useState(100), [Ln, Va] = w.useState("FIRE"), [it, Ja] = w.useState(0), [Pt, ra] = w.useState(100), [da, Gn] = w.useState(0), [Xi, Nl] = w.useState(0), [Sl, yc] = w.useState(null), [Zi, Qi] = w.useState(0), [wl, _a] = w.useState(["FIRE", "WATER"]), [st, Ka] = w.useState(["FIRE", "WATER"]), [St, wt] = w.useState("GENESIS"), [Oe, dt] = w.useState({ GENESIS: 0, CYBERIA: 0, ETERNITY: 0, LEGEND: 0 }), fa = w.useRef(null), [Il, Vi] = w.useState(0), ft = w.useCallback((O) => {
    qi(O), setTimeout(() => qi(""), 3e3);
  }, []), [Ji, $a] = w.useState(false), Fl = w.useRef(Rt);
  w.useEffect(() => {
    Rt > Fl.current && (setTimeout(() => $a(true), 0), lt.playSFX("levelup"), setTimeout(() => ft("\u529B\u304C...\u9032\u5316\u3057\u305F\u305E\uFF01"), 0), setTimeout(() => $a(false), 2e3), Fl.current = Rt);
  }, [Rt, ft]), w.useEffect(() => {
    if (!r) return;
    ...
    setTimeout(() => {
      ...
      const D = O.stageIndex ? parseInt(O.stageIndex) : 0, I = O.currentWorldId === "EARTH" ? "GENESIS" : O.currentWorldId === "FUTURE" ? "CYBERIA" : O.currentWorldId === "COSMOS" ? "ETERNITY" : O.currentWorldId || "GENESIS", F = ye.worlds.find((Ce) => Ce.id === I), Be = Oi(100 * F.hpScale, 1.8, D, D % 10 === 0 && D > 0);
      ra(Be), Qa(Be);
      ...
      if (et && O.money && O.upgrades) {
        ...
        if (El > 60) {
          ...
          yt > 0 && (Vi(yt), o((ia) => ia + yt), v((ia) => ia + yt));
        }
      }
    ...
    ot && (localStorage.setItem("magic_idle_money", h.toString()), localStorage.setItem("magic_idle_total", g.toString()), localStorage.setItem("magic_idle_upgrades", JSON.stringify($)), localStorage.setItem("magic_idle_maxCombo", z.toString()), localStorage.setItem("magic_idle_skills", JSON.stringify(le)), localStorage.setItem("magic_idle_settings", JSON.stringify(Z)), localStorage.setItem("magic_idle_collectedUnits", JSON.stringify(X)), localStorage.setItem("magic_idle_unitLevels", JSON.stringify(ke)), localStorage.setItem("magic_idle_spiritOrbs", fe.toString()), localStorage.setItem("magic_idle_artifacts", JSON.stringify(se)), localStorage.setItem("magic_idle_stageIndex", it.toString()), localStorage.setItem("magic_idle_lastLogin", Date.now().toString()), localStorage.setItem("magic_idle_equippedElements", JSON.stringify(st)), localStorage.setItem("magic_idle_currentWorldId", St), localStorage.setItem("magic_idle_worldProgress", JSON.stringify(Oe)), localStorage.setItem("worldProgress", JSON.stringify(Oe)), localStorage.setItem("magic_idle_completedTutorials", JSON.stringify(Ze)), localStorage.setItem("magic_idle_achievements", JSON.stringify(Q)));
  }, [h, g, $, z, le, Z, X, ke, fe, se, it, ot, wl, st, St, Oe, Ze, Q]), w.useEffect(() => {
    S || (U === "battle" ? lt.playBGM("battle") : lt.playBGM("home"));
  }, [U, S]);
  const qt = w.useMemo(() => {
    const O = ye.attributes.filter((D) => st.includes(D.id));
    return { atk: O.reduce((D, I) => {
      var _a3;
      return D + (((_a3 = I.stats) == null ? void 0 : _a3.atk) || 0);
    }, 0) / 6, spd: O.reduce((D, I) => {
      var _a3;
      return D + (((_a3 = I.stats) == null ? void 0 : _a3.spd) || 0);
    }, 0) / 6, crit: O.reduce((D, I) => {
      var _a3;
      return D + (((_a3 = I.stats) == null ? void 0 : _a3.crit) || 0);
    }, 0) / 6 };
  }, [st]), ea = w.useMemo(() => {
    let O = 0, D = 0;
    return X.forEach((I) => {
      const F = fc.find((et) => et.id === I), Be = ke[I] || 1;
      if (F) {
        const et = 1 + 0.5 * (Be - 1);
        O += F.stats.attack * et, D += F.stats.speed * et;
      }
    }), { attack: O, income: D };
  }, [X, ke]), ta = w.useMemo(() => {
    let O = 1, D = 1, I = 0;
    return se.forEach((F) => {
      F.id === "gold_keyboard" && (O += 0.5 * F.level), F.id === "greed_wallet" && (D += 0.2 * F.level), F.id === "time_stopper" && (I += 500 * F.level);
    }), { damageMult: O, incomeMult: D, comboTime: I };
  }, [se]), Qe = ((r ? $.reduce((O, D) => O + tm(D.baseIncome, D.level), 0) : 0) + ea.income) * ta.incomeMult, Ki = w.useCallback((O) => {
    o((D) => D + O), v((D) => D + O);
  }, []);
  Rx(Qe, Ki);
  const jl = w.useMemo(() => {
    ...
    if (To(g, 1e6, 1e6) >= 10 && U === "home") return { text: "\u79D8\u3081\u305F\u308B\u9B42\u3092\u89E3\u653E\u3057\u3001\u65B0\u305F\u306A\u9AD8\u307F\u3078\u8EE2\u751F\u305B\u3088\u3002", type: "REBIRTH", actionId: "rebirth-button" };
    const D = $.find((I) => h >= am(I.baseCost, I.costMultiplier, I.level));
    return D && U === "home" ? { text: "\u9B54\u5C0E\u5177\u3092\u5F37\u5316\u3057\u3001\u529B\u3092\u84C4\u3048\u308B\u306E\u3060\u3002", type: "UPGRADE", actionId: "shop-tab" } : D && U === "battle" ? { text: "\u4E00\u5EA6\u9000\u304D\u3001\u6226\u529B\u3092\u7ACB\u3066\u76F4\u3059\u3079\u304D\u3060\u308D\u3046\u3002", type: "UPGRADE", actionId: "back-to-home" } : U === "battle" ? Yn / Pt > 0.8 && M < 10 ? { text: "\u8A60\u5531\u3092\u6025\u3052\uFF01\u5149\u3092\u523B\u307F\u8FBC\u3080\u306E\u3060\u3002", type: "FIGHT", actionId: "magic-keyboard" } : { text: "\u305D\u306E\u8ABF\u5B50\u3060\u3002\u30B0\u30EA\u30C3\u30C1\u306E\u30B3\u30A2\u3092\u8CAB\u3051\uFF01", type: "FIGHT", actionId: null } : { text: "\u6DF1\u6DF5\u306E\u8ABF\u67FB\u3092\u518D\u958B\u3059\u308B\u305E\u3002", type: "FIGHT", actionId: "fight-button" };
  }, [h, g, it, U, $, S, Yn, Pt, M]), aa = w.useCallback((O) => {
    Gn((ct) => ct + 1);
    const D = Date.now();
    ...
    if (Math.random() < 0.02 && !L && (P(true), ft("\u30EA\u30DF\u30C3\u30C8\u30D6\u30EC\u30A4\u30AB\u30FC\u59CB\u52D5...\u30AF\u30EA\u30C6\u30A3\u30AB\u30EB\u30FB\u30CF\u30C3\u30AF\uFF01")), O === Gt[rt]) {
      ...
      if (va || Hn((Xt) => {
        ...
        let yt = M >= ye.feverTriggerCombo ? ye.feverMultiplier : 1;
        va && (yt *= 3), Be && (yt *= 1.5), yt *= 1 + qt.atk / 10;
        const Zn = (le.includes("crit_master") ? 0.2 : 0.05) + qt.crit / 100;
        Math.random() < Zn && (yt *= 2, ft("\u4F1A\u5FC3\u306E\u4E00\u6483\u3060\uFF01"));
        const Nc = ye.worlds.find((tt) => tt.id === St), Ml = Px(ye.baseTypingReward * Nc.rewardScale, M, ye.comboMultiplier, yt);
        o((tt) => tt + Ml), v((tt) => {
          const vt = tt + Ml;
          return Bn(Math.floor(vt / 1e3) + 1), vt;
        }), C((tt) => {
          const vt = tt + 1;
          return vt > z && _(vt), vt % 10 === 0 && ft(`${vt} \u30B3\u30F3\u30DC\uFF01\u5B9F\u306B\u898B\u4E8B\u3060\u3002`), vt;
        }), Qa((tt) => {
          const vt = Fx(20, ea.attack, et, Be, ta.damageMult, yt);
          Qi(vt), lt.playSFX("hit");
          let Tl = vt;
          St === "ETERNITY" && (Tl *= 0.5), St === "LEGEND" && (Tl *= 0.3);
          const Sa = tt - Tl;
          return Sa <= 0 && !_l ? (Li(true), lt.playSFX("defeat"), setTimeout(() => {
            ...
            let zl, Aa = null;
            if (Qn) {
              const _t = Math.min(4, Math.floor(ma / 50) + 1), ja = em.raidBosses.filter((ha) => ha.tier === _t), Ea = ja.length > 0 ? ja[ma % ja.length] : em.raidBosses[0];
              zl = Ea.health * (1 + ma * 0.1), Aa = Ea.name, ft(`\u8B66\u544A: ${Ea.name} \u304C\u51FA\u73FE\uFF01`);
            } else {
              const _t = ye.worlds.find((ja) => ja.id === St);
              zl = Oi(100 * _t.hpScale, 1.8, ma, false), Aa = null;
            }
            yc(Aa), ra(zl), Qa(zl), Li(false);
          }, 1200), 0) : Sa;
        }), nt(uc(Math.min(8, 3 + Math.floor(M / 10)), st)), Ke(0);
      } else Ke(ct);
      fa.current && clearTimeout(fa.current);
      const El = le.includes("time_bend"), Xn = 4e3 + ta.comboTime + (El ? 1e3 : 0);
      fa.current = setTimeout(() => {
        C(0), M > 10 && ft("\u96C6\u4E2D\u529B\u304C\u5207\u308C\u305F\u304B...");
      }, Xn);
  ...
  }, [Gt, rt, M, z, va, ea, ta, Ln, Z.haptic, le, ft, it, st, qt, St, _l, L]), la = w.useMemo(() => ["q", "w", "e", "r", "t", "y"], []);
  w.useEffect(() => {
    const O = (D) => {
      if (U !== "battle" || va || _l) return;
      const I = D.key.toLowerCase(), F = la.indexOf(I);
      F !== -1 && F < st.length && aa(st[F]);
    };
    ...
    [{ s: 3, id: "THUNDER" }, { s: 10, id: "WIND" }, { s: 20, id: "LIGHT" }, { s: 30, id: "DARK" }, { s: 40, id: "ICE" }, { s: 50, id: "EARTH" }, { s: 60, id: "TOXIC" }, { s: 70, id: "GRAVITY" }, { s: 80, id: "SOUL" }, { s: 90, id: "METAL" }, { s: 100, id: "BLOOD" }, { s: 120, id: "TIME" }, { s: 140, id: "SPACE" }, { s: 160, id: "NATURE" }, { s: 180, id: "STORM" }, { s: 200, id: "STAR" }, { s: 220, id: "HOLY" }, { s: 250, id: "CHAOS" }, { s: 270, id: "MAGMA" }, { s: 290, id: "STEAM" }, { s: 310, id: "PLASMA" }, { s: 330, id: "QUAKE" }, { s: 350, id: "ZERO" }, { s: 370, id: "AURA" }, { s: 390, id: "MIRROR" }, { s: 410, id: "ECHO" }, { s: 430, id: "ABYSS" }, { s: 450, id: "ZENITH" }, { s: 470, id: "PULSE" }, { s: 490, id: "DRAGON" }, { s: 510, id: "FEATHER" }, { s: 530, id: "PETAL" }, { s: 550, id: "BONE" }, { s: 570, id: "GEAR" }, { s: 590, id: "NEON" }, { s: 610, id: "PIXEL" }, { s: 630, id: "VIRUS" }, { s: 650, id: "CORE" }].forEach((D) => {
      if (it >= D.s - 1 && !wl.includes(D.id)) {
        _a((F) => [...F, D.id]);
        const I = ye.attributes.find((F) => F.id === D.id);
        ft(`\u65B0\u3057\u3044\u5C5E\u6027\u3010${I.name}\u3011\u306E\u7406\u3092\u7406\u89E3\u3057\u305F\u3088\u3046\u3060\u306A\u3002`);
      }
    });
  ...
  const $i = w.useCallback((O, D) => {
    h >= D && (o((I) => I - D), Le((I) => [...I, O]));
  }, [h]), Wi = w.useCallback((O) => {
    J((D) => {
      const I = D.findIndex((et) => et.id === O), F = D[I], Be = am(F.baseCost, F.costMultiplier, F.level);
      if (h >= Be) {
        o((ct) => ct - Be), lt.playSFX("levelup");
        const et = [...D];
        return et[I] = { ...et[I], level: et[I].level + 1 }, et;
      }
      return D;
    });
  }, [h]), Ii = w.useCallback((O) => {
    pe((D) => D.includes(O.id) ? D : [...D, O.id]), xe((D) => ({ ...D, [O.id]: (D[O.id] || 0) + 1 }));
  }, []), vc = w.useCallback((O) => o((D) => Math.max(0, D - O)), []);
  w.useEffect(() => {
    if (!ot) return;
    const O = { stageIndex: it, maxCombo: z, totalEarned: g, collectedUnits: X, dragonLevel: Rt, worldProgress: Oe, totalTaps: da };
    oc.forEach((D) => {
      !Q.includes(D.id) && D.condition(O) && (ve((I) => [...I, D.id]), m(D), lt.playSFX("gacha"));
    });
  }, [it, z, g, X, Rt, Oe, da, Q, ot]);
  const Pl = w.useCallback(() => {
    const O = To(g, 1e6, 1e6);
    if (O > 0) {
      he((I) => I + O), o(0), v(0), C(0), _(0), Le([]), Bn(1);
      const D = Oi(100, 1.8, 0, false);
      ra(D), Qa(D), Va("FIRE"), Gn(0), Nl(0), _a(["FIRE", "WATER"]), Ka(["FIRE", "WATER"]), J(ye.upgrades.map((I) => ({ ...I, level: 0 }))), j("home");
    }
  }, [g]), en = w.useCallback((O, D) => {
    fe >= D && (he((I) => I - D), W((I) => {
      const F = I.findIndex((Be) => Be.id === O);
      if (F >= 0) {
        const Be = [...I];
        return Be[F] = { ...Be[F], level: Be[F].level + 1 }, Be;
      }
      return [...I, { id: O, level: 1 }];
    }));
  }, [fe]), na = w.useCallback((O) => {
    const D = Oe[O] || 0;
    wt(O), Ja(D);
    const I = ye.worlds.find((Be) => Be.id === O), F = Oi(100 * I.hpScale, 1.8, D, D % 10 === 0);
    ra(F), Qa(F), nt(uc(4, st)), Ke(0), Za(false), ft(`${I.name} \u3078\u8EE2\u79FB\u3057\u305F\u3002`);
  }, [Oe, st, ft]), At = w.useCallback(() => {
    De((D) => D.includes(ee) ? D : [...D, ee]);
    const O = ee;
    ce(null), O === "INTRO" && (localStorage.setItem("magic_idle_tutorial_completed", "true"), j("battle"));
  }, [ee]), Fi = w.useCallback((O) => {
    if (O === "new") {
      localStorage.clear(), o(0), v(0), C(0), _(0), Le([]), pe(["n_egg"]), xe({ n_egg: 1 }), Bn(1);
      const D = Oi(100, 1.8, 0, false);
      ra(D), Qa(D), Va("FIRE"), Gn(0), Nl(0), _a(["FIRE", "WATER"]), Ka(["FIRE", "WATER"]), J(ye.upgrades.map((I) => ({ ...I, level: 0 }))), ce("INTRO");
    } else localStorage.getItem("magic_idle_tutorial_completed") && j("home");
    H(false);
  }, []);
  w.useEffect(() => {
    S || !ot || (U === "home" && !Ze.includes("HUB") ? setTimeout(() => ce("HUB"), 0) : U === "battle" && !Ze.includes("BATTLE") && setTimeout(() => ce("BATTLE"), 0));
  }, [U, S, ot, Ze]);
  const _c = M >= ye.feverTriggerCombo, qn = da > 0 ? Math.round(Xi / da * 100) : 100;
  return S ? s.jsx(Tx, { onComplete: Fi }) : s.jsxs("div", { className: `fixed inset-0 bg-[#0a0a0a] text-white overflow-hidden flex flex-col ${Ee ? "haptic-vibrate" : ""} `, children: [s.jsx(Kx, { combo: M, worldId: St }), U === "home" ? s.jsx(Qx, { money: h, totalEarned: g, dragonLevel: Rt, maxCombo: z, unlockedAchievements: Q, onOpenAchievements: () => B(true), onStartBattle: () => j("battle"), upgrades: $, onPurchase: Wi, unlockedSkills: le, onUnlock: $i, onOpenSettings: () => yl(true), onOpenLore: () => Cn(true), onOpenArtifacts: () => Kl(true), onOpenSkills: () => Bi(true), onOpenMagicSelection: () => vl(true), onOpenWorldSelection: () => Za(true), currentWorldId: St, collectedUnits: X, onPullGacha: Ii, onSpentMoney: vc, recommendedActionId: jl == null ? void 0 : jl.actionId, deckStats: ea, artifactStats: ta, magicStats: qt }) : s.jsxs(s.Fragment, { children: [s.jsxs("div", { className: "flex-[45] relative", children: [s.jsx(Sx, { currentSpell: Gt, monsterHealth: Yn, monsterMaxHealth: Pt, bossName: Sl, stageData: ((_a2 = ye.stages) == null ? void 0 : _a2[it]) || {}, combo: M, isFever: _c, dragonLevel: Rt, chantBreakGauge: bt, isSpellComplete: rt === 0 && Gt.length > 0, monsterElement: Ln, stageIndex: it + 1, lastDamage: Zi, familiarDialogue: Gi, isVictorious: _l, currentProgress: rt, keyMapping: la, equippedElements: st, recommendedActionId: jl == null ? void 0 : jl.actionId }), s.jsx("div", { className: "absolute top-4 left-4 z-20", children: s.jsx(jx, { money: h, idleIncome: Qe }) }), s.jsx("button", { onClick: () => ce(U === "home" ? "HUB" : "BATTLE"), className: "absolute top-4 right-4 z-20 w-12 h-12 rounded-full bg-neon-purple/80 hover:bg-neon-purple flex items-center justify-center shadow-lg border-2 border-white/20 transition-all hover:scale-110", children: s.jsx(Gh, { size: 24, className: "text-white" }) }), s.jsx("button", { onClick: () => Za(true), className: "absolute top-4 right-20 z-20 w-12 h-12 rounded-full bg-neon-blue/80 hover:bg-neon-blue flex items-center justify-center shadow-lg border-2 border-white/20 transition-all hover:scale-110", children: s.jsx(im, { size: 24, className: "text-white" }) })] }), s.jsxs("div", { className: "flex-[55] bg-[#1a1a1a] rounded-t-[3rem] shadow-[0_-20px_50px_rgba(0,0,0,0.5)] z-10 flex flex-col p-6", children: [s.jsx("div", { className: "flex-[1] flex flex-col items-center justify-center relative", children: s.jsx(Ax, { onInput: aa, activeElements: st, keyMapping: la }) }), s.jsx("div", { className: "flex justify-center mt-4", children: s.jsxs("button", { onClick: () => {
    j("home"), C(0);
  }, className: `flex items-center gap-2 px-8 py-4 rounded-2xl bg-white/5 text-white/60 hover:bg-white/10 hover:text-white transition-all active:scale-95 border border-white/10 ${(jl == null ? void 0 : jl.actionId) === "back-to-home" ? "animate-recommend border-neon-purple text-white bg-neon-purple/20" : ""}`, children: [s.jsx(sm, { size: 18 }), s.jsx("span", { className: "text-xs font-black uppercase tracking-widest", children: "\u62E0\u70B9\u3078\u623B\u308B" })] }) })] })] }), s.jsx(Vx, { objective: jl }), Dn && s.jsx(om, { money: h, unlockedSkills: le, onUnlock: $i, onClose: () => Bi(false) }), ee && s.jsx(kx, { type: ee, onComplete: At, onSkip: () => ce(null), currentSpell: Gt, currentProgress: rt }), Il > 0 && s.jsx("div", { className: "absolute inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm animate-in fade-in", children: s.jsxs("div", { className: "bg-[#1a1a1a] p-8 rounded-3xl border border-neon-cyan/50 text-center max-w-sm shadow-[0_0_50px_rgba(0,255,255,0.2)]", children: [s.jsx("div", { className: "text-4xl mb-4", children: "\u{1F4A4}" }), s.jsx("h3", { className: "text-2xl font-black text-white italic mb-2", children: "\u304A\u304B\u3048\u308A\u306A\u3055\u3044\uFF01" }), s.jsxs("p", { className: "text-3xl font-black text-neon-cyan mb-8", children: ["+", Math.floor(Il).toLocaleString(), " MP"] }), s.jsx("button", { onClick: () => Vi(0), className: "w-full py-4 bg-neon-cyan text-black font-black uppercase tracking-widest rounded-xl", children: "\u56DE\u53CE\u3059\u308B" })] }) }), Xe && s.jsx(Ex, { score: g, maxCombo: z, accuracy: qn, onRestart: () => Se(false) }), s.jsx(zx, { isActive: va, onComplete: () => {
    $l(false), Hn(0);
  } }), Yi && s.jsx(o2, { unlockedElements: wl, equippedElements: st, onClose: () => vl(false), onSave: (O) => {
    Ka(O), vl(false), nt(uc(4, O)), Ke(0);
  } }), Un && s.jsx(r2, { currentWorldId: St, worldProgress: Oe, onSelect: na, onClose: () => Za(false) }), bl && s.jsx(n2, { settings: Z, onUpdate: (O) => ae((D) => ({ ...D, ...O })), onClose: () => yl(false), canRebirth: Dx(g), nextRebirthOrbs: To(g, 1e6, 1e6), totalMoney: g, onRebirth: Pl }), On && s.jsx(i2, { totalEarned: g, onClose: () => Cn(false), stageIndex: it + 1 }), ya && s.jsx(c2, { spiritOrbs: fe, artifacts: se, onBuyArtifact: en, onClose: () => Kl(false) }), we && s.jsx($x, { achievement: we, onComplete: () => m(null) }), R && s.jsx(Wx, { unlockedAchievements: Q, onClose: () => B(false) }), L && s.jsx(Ix, { onComplete: () => P(false) }), Ji && s.jsx("div", { className: "fixed inset-0 z-[300] pointer-events-none flex items-center justify-center bg-white/10 backdrop-blur-sm animate-in fade-in duration-500", children: s.jsx("div", { className: "text-6xl font-black text-yellow-400 italic animate-bounce scale-150 drop-shadow-[0_0_30px_white]", children: "DRAGON EVOLUTION!" }) })] });
}
class f2 extends Ci.Component {
  constructor(p) {
...
Sh.createRoot(document.getElementById("root")).render(s.jsx(w.StrictMode, { children: s.jsx(f2, { children: s.jsx(d2, {}) }) }));
